...
* @descripcion  
***********************************************************************************/
// require_once($_SERVER['DOCUMENT_ROOT'].'/modelo/sss/sigesp_dao_sss_registroeventos.php');
// require_once($_SERVER['DOCUMENT_ROOT'].'/modelo/sss/sigesp_dao_sss_registrofallas.php');
// require_once($_SERVER['DOCUMENT_ROOT'].'/modelo/sss/sigesp_dao_sss_sistema.php');
// require_once($_SERVER['DOCUMENT_ROOT'].'/modelo/sss/sigesp_dao_sss_sistemaventana.php');
// require_once($_SERVER['DOCUMENT_ROOT'].'/modelo/cfg/sigesp_dao_cfg_configuracion.php');
// require_once($_SERVER['DOCUMENT_ROOT'].'/modelo/sno/sigesp_dao_sno_nomina.php');
// require_once($_SERVER['DOCUMENT_ROOT'].'/base/librerias/php/general/sigesp_lib_conexion.php');
// require_once($_SERVER['DOCUMENT_ROOT'].'/base/librerias/php/general/sigesp_lib_funciones.php');
require_once('../../modelo/sss/sigesp_dao_sss_registroeventos.php');
require_once('../../modelo/sss/sigesp_dao_sss_registrofallas.php');
require_once('../../modelo/sss/sigesp_dao_sss_sistema.php');
require_once('../../modelo/sss/sigesp_dao_sss_sistemaventana.php');
require_once('../../modelo/cfg/sigesp_dao_cfg_configuracion.php');
require_once('../../modelo/sno/sigesp_dao_sno_nomina.php');
