<?php
   ...
   //----------------------------------------------------------------------------------------------------------------------------
   function uf_imprimirresultados($as_numsol,$as_disponibilidad,$ls_fechaconta)
   {
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			while(!$rs_data->EOF)
			{
				...
				//$_SESSION["fechacomprobante"]=$ld_fecha;//validar el detalle presupuestario con la fecha de registro de la sep
...
<?php
	...
	uf_imprimirresultados($ls_numsol,$ls_disponibilidad,$ls_fechaconta);
?>
</div>
</form>
</body>
