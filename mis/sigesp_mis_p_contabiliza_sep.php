...
function uf_verdetalle(numsol)
{
	...
	Ypos=((screen.height/2)-(400/2));//mar
	f=document.form1;
	li_leer=f.txtfecha.value; //alert(li_leer);
	window.open("sigesp_mis_pdt_sep.php?numsol="+numsol+"&disponibilidad=1&fechaconta="+li_leer,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,left="+Xpos+",top="+Ypos+",location=no,resizable=no");
}
