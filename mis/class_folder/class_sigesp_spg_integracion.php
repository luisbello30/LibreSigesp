...
class class_sigesp_spg_integracion
{
													  ...
													  $aa_seguridad)
	{
		...
		//	  Description: Funcion que procesa la contabilizaci�n de las modificaciones presupuestarias de gasto
		...
		if($lb_valido)
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="PROCESS";
			$ls_descripcion="Aprob� las Modificaciones Presupuestarias de Gasto Comprobante <b>".$ls_comprobante."</b>, ".
											...
											$li_estcon)
	{
		...
		//				   li_estcon  // Esattus de Contabilizaci�n
		//				   aa_seguridad  // Arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto la contabilizaci�n correctamente
		//	  Description: Funcion que procesa la contabilizaci�n de las modificaciones presupuestarias de gasto
		//	   Creado Por: Ing. Nelson Barraez
		...
		if($li_row===false)
		{
            $this->io_msg->message("CLASE->Integraci�n SPG M�TODO->uf_update_estatus_modificacion ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			$lb_valido=false;
		}
		return $lb_valido;
	...
	function uf_procesar_detalles_gasto($as_codemp,$as_procede,$as_comprobante,$ad_fecha,$as_descripcion,$as_tipo_destino,$as_codigo_destino)
	{
		...
		//				   as_codigo_destino  // C�digo del Proveedor � Beneficiario
		//				   aa_seguridad  // Arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto la contabilizaci�n correctamente
		//	  Description: M�todo que genera los asientos presupuestarios a partir 
		//                  de los movmientos de notas de creditos o d�bitos
		//	   Creado Por: Ing. Nelson Barraez
		// Modificado Por: Ing. Yesenia Moreno									Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////


            //echo $as_comprobante.'<br>';
	    $lb_valido=true;		
		...
		if($rs_data===false)
		{   
            $this->io_msg->message("CLASE->Integraci�n SPG M�TODO->uf_procesar_detalles_gasto ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			$lb_valido=false;
		}
		else
		{  
			...
			if ($li_diferencia<>0)
			{
				$this->io_msg->message("El total del Aumento difiere con el total de la Disminuci�n.");
				$lb_valido=false;
			}
		}
		return $lb_valido;
	...
	function uf_procesar_detalles_contable($ls_codemp,$ls_procede,$ls_comprobante,$ad_fecha,$ls_descripcion,$ls_tipo_destino,$ls_codigo_destino)
	{
		...
		//				   ls_comprobante  // C�digo de Comprobante
		//				   ad_fecha  // Fecha de contabilizaci�n
		//				   ls_descripcion  // Descripci�n del Documento
		//				   ls_tipo_destino  // Tipo Destino
		//				   ls_codigo_destino  // C�digo del Destino Proveedor � Beneficiario
		//				   aa_seguridad  // Arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto la contabilizaci�n correctamente
		//	  Description: M�todo que genera los asientos contables a partir 
		//                  de los movmientos de notas de creditos o d�bitos
		//	   Creado Por: Ing. Nelson Barraez
		// Modificado Por: Ing. Yesenia Moreno									Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{   
            $this->io_msg->message("CLASE->Integraci�n SPG M�TODO->uf_procesar_detalles_contable ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			$lb_valido=false;
		}
		else
		{           
    ...
    function uf_reversar_contabilizacion_modpre($as_comprobante,$ad_fecha,$as_procede,$as_descripcion,$ad_fechaconta,$aa_seguridad)	
	{
		...
		if($lb_valido)
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="PROCESS";
			$ls_descripcion="Revers� las Modificaciones Presupuestarias de Gasto Comprobante <b>".$ls_comprobante."</b>, ".
	...
	function uf_update_fecha_contabilizado_spg($as_codemp,$ad_fecha,$as_comprobante,$as_procede,$ad_fechaconta,$ad_fechaanula)
	{
		...
		if($li_row===false)
		{
            $this->io_msg->message("CLASE->Integraci�n SPI M�TODO->uf_update_fecha_contabilizado_spg ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			$lb_valido=false;
		}
		return $lb_valido;
