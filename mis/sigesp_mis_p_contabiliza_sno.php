...
function uf_verdetalle(codcom)
{
	...
	f=document.form1;
	li_leer=f.txtfecha.value; //fecha de contabilizacion
	window.open("sigesp_mis_pdt_sno.php?codcom="+codcom+"&disponibilidad=1&fechaconta="+li_leer,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,left="+Xpos+",top="+Ypos+",location=no,resizable=no");
}
