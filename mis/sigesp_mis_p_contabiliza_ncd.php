...
function uf_verdetalle(numsol)
{
	...
	window.open("sigesp_mis_pdt_ncd.php?numsol="+numsol+"&disponibilidad=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,left="+Xpos+",top="+Ypos+",location=no,resizable=no");
}
