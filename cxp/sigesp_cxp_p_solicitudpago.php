<?php
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_numordpagmin,$ls_codtipfon,$ls_repcajchi,$ls_codprordaux,$ls_codbenrdaux;
   ...
   function uf_load_variables()
   {
		...
		ECHO $ls_codfuefin=$_POST["txtcodfuefin"];
		$ls_numordpagmin=$_POST["txtnumordpagmin"];
		$ls_codtipfon=$_POST["txtcodtipfon"];
		$ls_codprordaux=$_POST["txtcodprordaux"];
		$ls_codbenrdaux=$_POST["txtcodbenrdaux"];
		if($ls_codfuefin=="")
		{
			$ls_codfuefin="--";
		}
	...
	switch($ls_operacion)
	{
		...
		case "GUARDAR":
			...
			$lb_valido=$io_cxp->uf_guardar($ls_existe,&$ls_numsol,$ls_codpro,$ls_cedbene,$ls_codfuefin,$ls_tipodestino,
										   ...
										   $li_totrowrecepciones,$la_seguridad,$la_permisos["administrador"],$ls_numordpagmin,$ls_codtipfon,$ls_repcajchi,$ls_codprordaux,$ls_codbenrdaux);
    ...
    <table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td width="790"  height="136"><p>&nbsp;</p>
            <table width="721" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr>
				...
				<td height="22" colspan="2" style="text-align:left">Reposici&oacute;n Caja Chica
              ...
              <tr>
                ...
                <td height="22" colspan="3" align="left"><input name="txtcodfuefin" type="text" id="txtcodfuefin" style="text-align:center" value="01" value="<?php print $ls_codfuefin; ?>" size="10" readonly>
                ...
                <input name="txtdenfuefin" type="text" class="sin-borde" id="txtdenfuefin" value="Ingresos Ordinarios" value="<?php print $ls_denfuefin; ?>" size="60"></td>
              </tr>
              <tr>
        ...
        <p>
		  ...
		  <input name="txtcodprordaux" type="hidden" id="txtcodprordaux" value="<?php print $ls_codprordaux;?>">
		  <input name="txtcodbenrdaux" type="hidden" id="txtcodbenrdaux" value="<?php print $ls_codbenrdaux;?>">
        </p></td>
      </tr>
    </table>
</form>
