...
<table width="793" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    ...
    <td class="toolbar" width="26"><a href="javascript: ue_gob_dttc();"><img src="../shared/imagebank/tools20/imprimir.gif" alt="gob" width="20" height="20" border="0" title="Formato gobierno distrito capital"></a></div></td>
    <td class="toolbar" width="26"><div align="center"></div></td>
    <td class="toolbar" width="26"><div align="center"></div></td>
    <td class="toolbar" width="26"><div align="center"></div></td>
    <td class="toolbar" width="26"><div align="center"></div></td>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
        <td height="22" align="center"><div align="right">Planillas bancarias</div></td>
      <td width="150" height="22" align="center"  ><div align="left">
              <input name="txtplanilla" type="text" id="txtplanilla" value="" size="20" >
          </div>
      </td>
      <td width="350" height="22" align="left" border="1" ><div align="left">
              (solo para uso del 1X1000 gobierno de distrito capital,<br> deben separar los num de planilla por comas(,))
          </div>
      </td>
    </tr>
    <tr>
...
function ue_gob_dttc()
{
	...
	if(li_imprimir==1)
	{
		...
		ls_mes=f.cmbmes.value;
		ls_anio=f.txtano.value;
                ls_planilla = f.txtplanilla.value;
		totrow=ue_calcular_total_fila_local("txtnumcom");
		f.total.value=totrow;
		for(li_i=1;li_i<=totrow;li_i++)
		{
		...
		{
			tiporeporte=f.cmbbsf.value;
			formato="sigesp_cxp_r_unoxmil_pdf.php";//f.formato.value;
			pagina="reportes/"+formato+"?comprobantes="+ls_comprobantes+"&mes="+ls_mes+"&anio="+ls_anio+"&planilla="+ls_planilla+"&tiporeporte="+tiporeporte;
			window.open(pagina,"reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,left=0,top=0");
		}
		else
		{
