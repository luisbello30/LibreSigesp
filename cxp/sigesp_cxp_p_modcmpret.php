			   ...
			   if($lb_flag)
			    {
				  ...
				  if($lb_flag)
				  {
				    $io_msg->message("El comprobante fue eliminado fisicamente, por ser el �ltimo registro!!");
					$io_sql->commit();
					uf_limpiarvariables();
				  }
				  else
              ...
              <tr>
                ...
                <td height="22" align="right"><div align="left">
				  ...
				  <?php if($ls_modageret=$_SESSION["la_empresa"]["estretiva"]!="B"){?>
                    ...
                    <option value="0000000002" <?php if($ls_codret=="0000000002"){ print "selected";} ?>>I.S.L.R</option>
...
function ue_nuevo()
{
	...
	{
		alert("Los dos comprobantes se manejan por el M�dulo de Caja y Banco");
	}
}
  ...
  switch (ls_tipret)
  {
  	case "0000000001":
	   ...
	   if ((ld_porcar!="0,00") && (ld_porcar!=""))
		  ...
		  {
		    alert("Para que pueda seleccionar un deducci�n el porcentaje debe ser distinto a cero !!!");
		  }
	break;
  	case "0000000003":
	   ld_basimp = eval("f.txtbasimp"+li_row+".value");
	   if ((ld_basimp!="0,00") && (ld_basimp!=""))
		  ...
		  {
		    alert("Para que pueda seleccionar un deducci�n el Monto de la Base Imponible debe ser Mayor a Cero !!!");
		  }
	break;
  	case "0000000004":
	   ld_basimp = eval("f.txtbasimp"+li_row+".value");
