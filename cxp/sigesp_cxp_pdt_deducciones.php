...
function ue_calcular(fila,disabled)
{
	...
	if(disabled=='true')
	{
		...
		alert("Esta Deducci�n viene configurada con el Proveedor � Beneficiario no se puede destildar");
	}
	...
	if(marcado==true)
	{
		...
		/*deducible=ue_formato_calculo(deducible); Funcion comentada debido a los montos en decimales por ejemplo 54.12 los convierte en 5412 presentando problemas en la parte de <<deduccion+"-"+deducible>>*/ 
		//alert(deducible)
...
function ue_search()
{
	...
	tipo=f.tipo.value;
	if (tipo=='CMPRETIVA' || tipo=='CMPRETMUN' || tipo=='CMPRETAPO'|| tipo=='CMPRETMIL')
	   {
	     numrecdoc="";
		 subtotal="";
		 cargos="";
