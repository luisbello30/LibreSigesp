<?php
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_disenb,$ls_provbenedesde,$io_fun_cxp,$ls_provbenehasta,$ls_flag,$ls_hidopctipret,$ls_descmb,$ls_disaposol,$ls_disapomil,$ls_islr;
...
?>
  ...
  <table width="556" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    ...
    <tr>
      <td height="13" colspan="4" align="center"><table width="504" border="0" cellspacing="0" class="formato-blanco">
        <tr class="titulo-celda">
          <td width="504" colspan="5"><div align="center"><strong>Tipo de Retenci&oacute;n </strong></div></td>
         
        </tr>
        <tr>
          <td><div align="left">IVA
            <input type="radio" name="opctipret" value="I"   <?php print $ls_disenb;?>>
          </div></td>
          <td height="22"><div align="center">
			    <div align="left">Impuesto Municipal
			      <input type="radio" name="opctipret" value="M" <?php print $ls_descmb;?>>
		        </div>
          </div></td>
          <td><div align="left">Aporte Social
            <input name="opctipret" type="radio" value="A" <?php print $ls_disaposol;?>>
          </div></td>
          <td><div align="left">1 x 1000
              <input name="opctipret" type="radio" value="1"  <?php print $ls_disapomil;?>>
          </div></td>
          <td>
              <div align="left">I.S.L.R.
              <input name="opctipret" type="radio" value="S"  <?php print $ls_islr; ?>>
          </div>
          </td>
        </tr>
      </table></td>
