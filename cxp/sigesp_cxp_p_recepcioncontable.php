	...
	switch ($ls_operacion) 
	{
		...
		case "GUARDAR":
			...
			$lb_valido=$io_cxp->uf_guardar($ls_existe,$ls_numrecdoc,$ls_tipodestino,$ls_codprovben,$ls_codtipdoc,$ld_fecregdoc,
										   ...
										   $ls_codestpro4,$ls_codestpro5,$ls_estcla,$ls_estact,$ls_numordpagmin,$ls_codtipfon,$ls_repcajchi,$la_seguridad);
				...
				<table width="785" border="0" cellpadding="0" cellspacing="1" class="celdas-blancas">
                  ...
                  <tr>
                    ...
                    <td height="22" colspan="3"><div align="left">
                      <input name="txtcodfuefin" type="text" id="txtcodfuefin" style="text-align:center" value="01" value= "  <?php print $ls_codfuefin;?>" size="5" maxlength="2" readonly>
                      ...
                      <input name="txtdenfuefin" type="text" class="sin-borde" id="txtdenfuefin" value="Ingresos Ordinarios"  value="<?php  print $ls_denfuefin;?>" size="50" readonly>
                    </div></td>
                  </tr>
                  <tr>
				  ...
				  <tr>
					...
					<td height="22"><div align="right">                  Reposici&oacute;n Caja Chica
