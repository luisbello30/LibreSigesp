...
var patron2 = new Array(1,3,3,3,3)
	...
	function ue_openexcel()
	{
			...
			if(li_imprimir==1)
			{
				...
				if((fecemides!="")&&(fecemihas!=""))
				{
					pantalla="reportes/sigesp_cxp_rpp_solicitudes_excel.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecemides="+fecemides+"&fecemihas="+fecemihas+"&tiporeporte="+tiporeporte+"";
					window.open(pantalla,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				}
				else
				{
