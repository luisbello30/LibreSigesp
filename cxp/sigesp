...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addText(485,740,9,"No. ".$as_numsol); // Agregar el tï¿½tulo
		$io_pdf->addText(485,710,9,"Fecha ".$ad_fecregsol); // Agregar el tï¿½tulo
		...
		$io_pdf->addText(40,122,7,"ELABORADO POR"); // Agregar el tï¿½tulo
		$io_pdf->addText(42,63,7,"FIRMA / SELLO"); // Agregar el tï¿½tulo
		$io_pdf->addText(210,122,7,"VERIFICADO POR"); // Agregar el tï¿½tulo
		$io_pdf->addText(210,63,7,"DIRECCIÓN DE FINANZAS"); // Agregar el tï¿½tulo
		$io_pdf->addText(400,122,7,"AUTORIZADO POR"); // Agregar el tï¿½tulo
		$io_pdf->addText(370,63,7,"DIRECTOR GENERAL DE ADMINISTRACIÓN Y SERVICIOS"); // Agregar el tï¿½tulo
		//$io_pdf->addText(440,122,7,"CONTRALORIA INTERNA"); // Agregar el tï¿½tulo
		//$io_pdf->addText(445,63,7,"FIRMA / SELLO / FECHA"); // Agregar el tï¿½tulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
							   ...
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime la cabecera 
		//	   Creado Por: Ing. Yesenia Moreno / Ing. Luis Lang
		// Fecha Creaciï¿½n: 17/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>570))); // Justificaciï¿½n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>400), // Justificaciï¿½n y ancho de la columna
						 			   'contenido'=>array('justification'=>'center','width'=>170))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
	...
	function uf_print_detalle_recepcion($la_data,$ai_totsubtot,$ai_tottot,$ai_totcar,$ai_totded,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>130), // Justificaciï¿½n y ancho de la columna
						 			   'fecemisol'=>array('justification'=>'center','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'center','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'center','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'center','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'center','width'=>92))); // Justificaciï¿½n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'center','width'=>130), // Justificaciï¿½n y ancho de la columna
						 			   'fecemisol'=>array('justification'=>'left','width'=>70), // Justificaciï¿½n y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'right','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'right','width'=>92))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('numrecdoc'=>array('justification'=>'right','width'=>200), // Justificaciï¿½n y ancho de la columna
						 			   'subtotdoc'=>array('justification'=>'right','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'moncardoc'=>array('justification'=>'right','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'mondeddoc'=>array('justification'=>'right','width'=>92), // Justificaciï¿½n y ancho de la columna
						 			   'montotdoc'=>array('justification'=>'right','width'=>92))); // Justificaciï¿½n y ancho de la columna
	...
	function uf_print_detalle_spg($aa_data,$ai_totpre,&$io_pdf)
	{
		...
		//		   Access: private 
		//	    Arguments: aa_data // arreglo de informaciï¿½n
		//	    		   ai_totpre // monto total de presupuesto
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el detalle presupuestario
		//	   Creado Por: Ing. Yesenia Moreno / Ing. Luis Lang
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('codestpro'=>array('justification'=>'center','width'=>200), // Justificaciï¿½n y ancho de la columna
						 			   'spg_cuenta'=>array('justification'=>'center','width'=>80), // Justificaciï¿½n y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>200), // Justificaciï¿½n y ancho de la columna
						 			   'monto'=>array('justification'=>'right','width'=>90))); // Justificaciï¿½n y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>480), // Justificaciï¿½n y ancho de la columna
						 			   'totpre'=>array('justification'=>'right','width'=>90))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_datatot,$la_columnas,'',$la_config);
	}// end function uf_print_detalle
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_scg($aa_data,$ai_totdeb,$ai_tothab,&$io_pdf)
	{
		...
		//	    		   io_pdf // Instancia de objeto pdf
		//    Description: funciï¿½n que imprime el detalle contable
		//	   Creado Por: Ing. Yesenia Moreno / Ing. Luis Lang
		// Fecha Creaciï¿½n: 27/05/2007 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-5);
		global $ls_tiporeporte;
		if($ls_tiporeporte==1)
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('sc_cuenta'=>array('justification'=>'center','width'=>190), // Justificaciï¿½n y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>200), // Justificaciï¿½n y ancho de la columna
						 			   'mondeb'=>array('justification'=>'center','width'=>90), // Justificaciï¿½n y ancho de la columna
						 			   'monhab'=>array('justification'=>'center','width'=>90))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('sc_cuenta'=>array('justification'=>'center','width'=>190), // Justificaciï¿½n y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>200), // Justificaciï¿½n y ancho de la columna
						 			   'mondeb'=>array('justification'=>'right','width'=>90), // Justificaciï¿½n y ancho de la columna
						 			   'monhab'=>array('justification'=>'right','width'=>90))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($aa_data,$la_columnas,'',$la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>390), // Justificaciï¿½n y ancho de la columna
						 			   'totdeb'=>array('justification'=>'right','width'=>90), // Justificaciï¿½n y ancho de la columna
						 			   'tothab'=>array('justification'=>'right','width'=>90))); // Justificaciï¿½n y ancho de la columna
		$io_pdf->ezTable($la_datatot,$la_columnas,'',$la_config);
	}// end function uf_print_detalle
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(3.6,5,3,3); // Configuraciï¿½n de los margenes en centï¿½metros
