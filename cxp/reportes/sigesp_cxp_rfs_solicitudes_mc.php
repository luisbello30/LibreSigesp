...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addText(40,122,7,"ELABORADO"); // Agregar el t�tulo
		$io_pdf->addText(30,63,7,"FECHA/FIRMA/SELLO"); // Agregar el t�tulo
		$io_pdf->addText(150,122,7,"ORDEN DE PAGO / TESORERIA"); // Agregar el t�tulo
		$io_pdf->addText(165,63,7,"FECHA/FIRMA/SELLO"); // Agregar el t�tulo
		//$io_pdf->addText(220,122,7,"TESORERIA"); // Agregar el t�tulo
		//$io_pdf->addText(210,63,7,"FECHA/FIRMA/SELLO"); // Agregar el t�tulo
                $io_pdf->addText(320,122,7,"CONTABILIDAD"); // Agregar el t�tulo
		$io_pdf->addText(300,63,7,"FECHA/FIRMA/SELLO"); // Agregar el t�tulo
                $io_pdf->addText(410,122,7,"FINANZAS"); // Agregar el t�tulo
		$io_pdf->addText(400,63,7,"FECHA/FIRMA/SELLO"); // Agregar el t�tulo
                $io_pdf->addText(485,122,7,  utf8_decode(" DIREC. ADMINISTRACIÓN")); // Agregar el t�tulo
		$io_pdf->addText(490,63,7,"FECHA/FIRMA/SELLO"); // Agregar el t�tulo
							   ...
							   $ai_monsol,$as_monto,&$io_pdf)
	{
		...
		$la_data[2]=array('titulo'=>"                            ".$as_nombre." ".$as_codigo);
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$li_monsol=$io_report->DS->data["monsol"][$li_i];
                                $nacprobene=$io_report->DS->data["nacprobene"][$li_i];
				if($ls_estretiva=="B")
				{
				...
				{
					$ls_codigo=$nacprobene.'-'.number_format($ls_cedbene,0,'','.');
				}
