...
class sigesp_cxp_c_solicitudpago
 {
	...
	function uf_insert_solicitud(&$as_numsol,$as_codpro,$as_cedbene,$as_codfuefin,$as_tipproben,$ad_fecemisol,$as_consol,
								 $ai_monsol,$as_obssol,$as_estsol,$ai_totrowrecepciones,$aa_seguridad,$as_numordpagmin,$as_codtipfon,$as_repcajchi,$as_codprordaux,$as_codbenrdaux)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//	    $lb_valido=$this->io_id_process->uf_check_id("cxp_solicitudes","numsol",&$as_numsol);   
		...
		if($lb_valido)
		{
			$ls_sql="INSERT INTO cxp_solicitudes (codemp, numsol, cod_pro, ced_bene, codfuefin, tipproben, fecemisol, consol,".
					"                             estprosol, monsol, obssol, estaprosol,procede,numordpagmin,codtipfon,repcajchi)".
			...
			if($li_row===false)
			{
				...
				if($this->io_sql->errno=='23505' || $this->io_sql->errno=='1062' || $this->io_sql->errno=='-239' || $this->io_sql->errno=='-5'|| $this->io_sql->errno=='-1')
				{
					$lb_valido=$this->uf_insert_solicitud(&$as_numsol,$as_codpro,$as_cedbene,$as_codfuefin,$as_tipproben,
														  ...
														  $ai_totrowrecepciones,$aa_seguridad,$as_numordpagmin,$as_codtipfon,$as_repcajchi,$as_codprordaux,$as_codbenrdaux);
				}
				else
				{
					$lb_valido=false;
			...
			else
			{
				...
				if($lb_valido)
				{	
					$lb_valido=$this->uf_insert_recepciones($as_numsol, $as_cedbene, $as_codpro, $ai_totrowrecepciones, $ad_fecemisol, $as_repcajchi, $as_codprordaux, $as_codbenrdaux, $aa_seguridad);
				}	
				if($lb_valido)
				{	
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_recepciones($as_numsol, $as_cedbene, $as_codpro, $ai_totrowrecepciones, $ad_fecemisol, $as_repcajchi, $as_codprordaux, $as_codbenrdaux, $aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		for($li_i=1;($li_i<$ai_totrowrecepciones)&&($lb_valido);$li_i++)
		{
			...
			if (($as_repcajchi=="1"))
			{
				$lb_valido=$this->uf_comparar_fechas($ls_numrecdoc,$as_codprordaux,$as_codbenrdaux,$ls_codtipdoc,$ad_fecemisol);
			}
			else
			{
			...
			if((!$lb_existe)&&($lb_valido))
			{
				if (($as_repcajchi=="1"))
				{
					$ls_sql="INSERT INTO cxp_dt_solicitudes (codemp, numsol, numrecdoc, codtipdoc, ced_bene, cod_pro, monto)".
							...
							" 			  '".trim($as_codbenrdaux)."','".$as_codprordaux."',".$li_monto.")";
				}
				else
				{
					$ls_sql="INSERT INTO cxp_dt_solicitudes (codemp, numsol, numrecdoc, codtipdoc, ced_bene, cod_pro, monto)".
	...
	function uf_guardar($as_existe,&$as_numsol,$as_codpro,$as_cedbene,$as_codfuefin,$as_tipproben,$ad_fecemisol,$as_consol,
						...
						$as_numordpagmin,$as_codtipfon,$as_repcajchi,$as_codprordaux,$as_codbenrdaux)
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
			...
			case "TRUE":
				if($lb_encontrado)
				{
					$lb_valido=$this->uf_update_solicitud($as_numsol,$as_codpro,$as_cedbene,$as_codfuefin,$as_tipproben,
														  $ad_fecemisol,$as_consol,$ai_monsol,$as_obssol,$as_estsol,
														  $ai_totrowrecepciones,$aa_seguridad,$as_numordpagmin,$as_codtipfon,$as_repcajchi);
				}
				else
				{
	...
	function uf_update_solicitud($as_numsol,$as_codpro,$as_cedbene,$as_codfuefin,$as_tipproben,$ad_fecemisol,$as_consol,
								 $ai_monsol,$as_obssol,$as_estsol,$ai_totrowrecepciones,$aa_seguridad,$as_numordpagmin,$as_codtipfon,$as_repcajchi)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
