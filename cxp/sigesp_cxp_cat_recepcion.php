...
function ue_aceptar(numrecdoc,codtipdoc,cedbene,codpro,codcla,fecemidoc,fecregdoc,fecvendoc,montotdoc,
					...
					codestpro2,codestpro3,codestpro4,codestpro5,estcla,estact,numordpagmin,codtipfon,repcajchi)
{
...
function ue_aceptar_solicitud(numrecdoc,dencondoc,codtipdoc,dentipdoc,montotdoc,cedbene,codpro,codfuefin,denfuefin)
{
	//---------------------------------------------------------------------------------
	// Verificamos que la solicitud no est� en el formulario
	//---------------------------------------------------------------------------------

        //alert(numrecdoc+'/'+dencondoc+'/'+codtipdoc+'/'+dentipdoc+'/'+montotdoc+'/'+cedbene+'/'+codpro+'/'+codfuefin+'/'+denfuefin);
	valido=true;
	...
	opener.document.formulario.txtcodprordaux.value=codpro;
	opener.document.formulario.txtcodbenrdaux.value=cedbene;
        opener.document.formulario.txtcodfuefin.value=codfuefin;
	opener.document.formulario.txtdenfuefin.value=denfuefin;
        //alert(opener.document.formulario.txtdenfuefin.value);
