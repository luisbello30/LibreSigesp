...
<form name="form1" method="post" action="">
  <p align="center">
    ...
    <input name="tipo_rep" type="hidden" id="tipo_rep" value='<?php print $ls_tipo ?>'>
</p>
...
{
	f=document.form1;
	tipo_rep = f.tipo_rep.value;
	if(tipo_rep=="ARB"){
	    opener.document.form1.txtnompersol.readOnly=true;
	    opener.document.form1.txtnompersol.value=nomper+" "+apeper;
...
function ue_search()
{
	...
	if(tipo_rep=="ARB")
	  f.action="sigesp_cat_personal.php?inv=ARB";
	else
