<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numconrec,$ad_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(140,102,7,"ELABORADO POR"); // Agregar el t�tulo
		$io_pdf->addText(150,43,7,"ALMAC�N"); // Agregar el t�tulo
		//$io_pdf->addText(157,102,7,"VERIFICADO POR"); // Agregar el t�tulo
		//$io_pdf->addText(160,43,7,"PRESUPUESTO"); // Agregar el t�tulo
		$io_pdf->addText(400,102,7,"AUTORIZADO POR"); // Agregar el t�tulo
	...
	$ls_titulo="<b>Entrada de Suministros a Almac�n</b>";
	$ls_fecha=$ls_fecrec;
