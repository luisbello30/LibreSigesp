...
<?php 
	...
	//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////
?>
  <table width="550" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="340" height="51" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="116" height="34"><div style='width:116px' align="right">Orden de Compra</div></td>
            <td ><div align="left">
	  ...
	  <tr>
              <td  height="34" align="center"><div style='width:116px' align="right">Personal</div></td>
              <td  height="34" align="center"><div align="left">
                  <input name="txtcedper" type="text" id="txtcedper" style="text-align:center" value="<?php print $ls_codper ?>" readonly="readonly" />
                  <a href="javascript: uf_catalogo('sigesp_cat_personal.php?inv=ARB');"><img src="../shared/imagebank/tools15/buscar.gif" alt="Buscar" width="15" height="15" border="0" /></a>
                  <input name="txtnompersol" type="text" class="sin-borde" id="txtnompersol" value="<?php print $ls_nomper ?>" size="40" readonly="readonly" />
              </div></td>
            </tr>
            <tr>
              <td  height="34" align="center"><div style='width:116px' align="right">Rep. del Proveedor </div></td>
              <td height="34" align="center"><div align="left">
            ...
            <tr>
              <td height="34" align="center"><div style='width:116px' align="right">Fecha Servicio </div></td>
              <td  height="34" align="center"><div align="left">
...
function ue_showouput(ls_reporte)
{
	...
	if(li_imprimir==1)
	{
	   txtnumordcom = f.txtnumordcom.value;
	    txtnompersol = f.txtnompersol.value;
	    txtnomrespro = f.txtnomrespro.value;
	    txtfecordcom = f.txtfecordcom.value;
	   tipoformato=f.cmbbsf.value;
	   pagina="reportes/"+ls_reporte+"?txtnumordcom="+txtnumordcom+"&tipoformato="+tipoformato+"&txtnompersol="+txtnompersol+"&txtnomrespro="+txtnomrespro+"&txtfecordcom="+txtfecordcom;
