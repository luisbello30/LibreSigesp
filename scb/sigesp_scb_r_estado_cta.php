  ...
  if (li_imprimir=='1')
     {
       if ((ld_fecdesde!="")&&(ld_fechasta!="")&&(ls_codban!="")&&(ls_ctaban!=""))
          {
	        pagina="reportes/sigesp_scb_rpp_estado_cuenta_excel.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&orden="+ls_orden+"&tiporeporte="+ls_tiporeporte;
	        window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
          }
       else
          {
