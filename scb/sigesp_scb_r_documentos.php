...
if ($ls_operacion=="BUSCAR")
   {
	 ...
	 if ($lb_valido)
	    {
	      $title[1] = "<input id='todos' type='checkbox' onclick='uf_select_all(document.forms[0])' name='todos'>";
	      ...
	      {
	        $io_msg->message("No se han encontrado Documentos para este Criterio de B�squeda !!!");
		  }
        }
   }    
?>
  ...
  if (li_leer==1)
	 {
	   ...
	   if (ls_codban=="" || ls_ctaban=="")
	      {
		    alert("Debe establecer el Codigo del Banco y N�mero de Cuenta Bancaria para realizar la B�squeda !!!");
		  }
       else
	      {
            f.operacion.value = "BUSCAR";
  ...
  if (li_imprimir=='1')
     {
	   ...
	   if (ls_codban=="" || ls_ctaban=="" || ls_nomban=="")
	      {
		    alert("Debe establecer el C�digo del Banco y N�mero de Cuenta Bancaria para realizar la B�squeda !!!");  
		  }
       else
	      {
