...
class sigesp_scb_c_conciliacion
{
		   ...
		   { 		
			 ...
			 $ls_descripcion="Se creo la conciliacion del banco ".$as_codban." de cuenta ".$as_ctaban." de fecha ".$ls_mesano."";
		  	 if ($li_est_conciliacion == 1)
			      $ls_descripcion+=". La Conciliaci�n esta cerrada";
			 else
			   $ls_descripcion+=". La Conciliaci�n esta abierta";
			   $ls_evento="INSERT";
	  	   }
		else 
		   {
	...
	//	  Description: Funci�n que actualiza los movimientos bancarios relacionados a las conciliaciones bancarias.
	//	   Creado Por: Ing. Nestor Falc�n.
	// Fecha Creaci�n: 30/07/2007 								Fecha �ltima Modificaci�n : 30/07/2007
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//-----------------------HABER---------------------------------------//
	...
	$ldec_tothab=$ldec_tothab-$ldec_tothab_anulado;
            echo $ldec_tothab.'-'.$ldec_tothab_anulado;
	...
	function uf_abrir_conciliacion($as_codban,$as_ctaban,$ad_fecha,$ad_fechasta)	
	{
	  ...
	  $ls_sql="UPDATE scb_conciliacion 
		...
		else
		{
			...
			///////////////////////////////////Parametros de seguridad/////////////////////////////////////////////////
			$ls_evento="UPDATE";
			$ls_descripcion="La conciliaci�n del Banco ".$as_codban." de la cuenta ".$as_ctaban." 
