...
<input name="txtmonto" type="text" id="txtmonto" style="text-align:right" onBlur="javascript:uf_montoobjret(this);javascript:uf_verificar_monto(this);" onKeyPress="return(currencyFormat(this,'.',',',event));" value="<?php print number_format($ldec_montomov,2,",",".");?>" size="24" maxlength="22">	  </div></td>
    ...
    <tr>
	  ...
	  <a href="javascript: uf_agregar_dtcon();">
	    <img src="../shared/imagebank/tools/nuevo.gif" alt="Detalle Contable" width="15" height="15" border="0">Agregar detalle Contable </a>
	  <a href="javascript: uf_agregar_dtret('<?echo $ls_mov_operacion ?>');">
	      <img src="../shared/imagebank/tools/nuevo.gif" alt="Detalle Deducciones" width="15" height="15" border="0">Agregar detalle Retenciones </a> 
      </td>
    </tr>
    <tr>
      <td height="22" colspan="6"><div align="center">
	   ...
	   if (ls_operacion=='CH')
	  {
	      ...
	      else
		  {
			...
			ls_spgcta    = eval("f.txtcuenta1.value");
		      //alert(eval("f.txtcuentaspi.value"));
...
function ue_imprimir(ls_reporte)
{
	...
	ls_status=f.estmov.value;
	ls_numcarord=f.txtnumcarord.value;
        ls_txtprovbene=f.txtprovbene.value;
      
        es_proveedor=0;
        if( f.rb_provbene[1].checked == true )
                   es_proveedor=1;
		...
		if((ls_numdoc!="")&&(ls_codban!="")&&(ls_ctaban!="")&&(ls_codope!=""))
		{
			if(ls_status!="A")
			{
				ls_pagina="reportes/"+ls_reporte+"?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&chevau="+ls_chevau+"&codope="+ls_codope;
                                ls_pagina=ls_pagina+"&es_proveedor="+es_proveedor+"&ls_txtprovbene="+ls_txtprovbene;
				//alert (ls_pagina);
					 ...
					 if (lb_valido)
						{
						  ...
						  ls_pagina = "sigesp_w_regdt_contable.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+"&tipo="+ls_tipo+
									  ...
									  "&anticipo="+ls_anticipo+"&codtipfon="+ls_codtipfon+"&numordpagmin="+ls_numordpagmin+"&estcob="+li_estcob+"&numconint="+ls_numconint+"&reglibro="+ls_reglibro;
