...
//////////////////////////////////////////////  SEGURIDAD   /////////////////////////////////////////////
	...
	if (array_key_exists("operacion",$_POST))
	   {
		 ...
		 $ls_desproben = $_POST["txtdesproben"];
                 $ls_fechainicio = $_POST["txtfechainicio"];
                 $ls_fechafin    = $_POST["txtfechafin"];
	   }
	else
	   {
		 $ls_operacion= "NUEVO" ;		
	...
	$grid2="grid";
	$title[1]="";       $title[2]="Documento";      $title[3]="Descripci�n";   $title[4]="Monto";   $title[5]="Fecha";	   $title[6]="Banco";    $title[7]="Cuenta";      $title[8]="Voucher";     $title[9]="C&eacute;dula/codigo"; $title[10]="Proveedor/Beneficiario"; $title[11]="Tipo destino";
		...
		for($li_i=1;$li_i<=$li_total;$li_i++)
		{
			if(array_key_exists("chksel".$li_i,$_POST))
			{
				...
				$ls_ctaban=$_POST["txtcuenta".$li_i];
                                $ls_cedulacheque=$_POST["txtcedulaentrega".$li_i];
                                $ls_nombrecheque=$_POST["txtnombrentrega".$li_i];
                                $ls_tipodestino = $_POST["txtipobenprov".$li_i];
				...
				$arr_entregacheques["ctaban"][$li_aux]=$ls_ctaban;
                                $arr_entregacheques["cedula"][$li_aux]=$ls_cedulacheque;
                                $arr_entregacheques["nombre"][$li_aux]=$ls_nombrecheque;
                                $arr_entregacheques["tipo_destino"][$li_aux]=$ls_tipodestino;
...
if ($ls_operacion == "CARGAR")
   {
     ...
     $in_classentrega->uf_cargar_cheques($ls_provbene,$ls_tipo,$ls_fechainicio,$ls_fechafin,&$object,&$li_total);
   }	
	if($ls_tipo=='-')
	{
		$rb_n="checked";
  ...
  <table width="722" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22" colspan="3" style="text-align:left"><div align="left">
        <input name="txtprovbene" type="text" id="txtprovbene" style="text-align:center" size="24" readonly>
        ...
        <input name="txtdesproben" type="text" id="txtdesproben" size="42" maxlength="250" class="sin-borde"  readonly>
       </div></td>
    </tr>
   <tr>
      <td height="22"><div align="right">Seleccione fecha:</div></td>
      <td height="22" colspan="2">
        <table width="249" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td width="200" style="text-align:right">Fecha inicio</td>
            <td width="200">
              <input name="txtfechainicio" type="text" id="txtfechainicio"  style="text-align:center"  size="24" maxlength="10" datepicker="true" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);">
            </td>
            <td width="100" height="22">&nbsp;</td>
             <td width="200" style="text-align:right">Fecha fin</td>
            <td width="200">
              <input name="txtfechafin" type="text" id="txtfechafin"  style="text-align:center"  size="24" maxlength="10" datepicker="true" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);">
            </td>
          </tr>
      </table>
      </td>
    ...
    <tr>
     ...
     <tr>
      <td height="22" style="text-align:right">Entrega autorizada</td>
      <td height="22" style="text-align:left"><input name="entautorizada" type="checkbox" checked="true" id="entautorizada" style="text-align:center" onChange="cambiarText()" ></td>
    ...
    <tr>
      ...
      <td height="22" style="text-align:left"><input name="txtcedula" type="text" id="txtcedula" style="text-align:center"  maxlength="10" onKeyPress="return keyRestrict(event,'0123456789'); "></td>
      <td height="22" style="text-align:right">Fecha</td>
      <td height="22" style="text-align:left"><input name="txtfecha" type="text" id="txtfecha"  style="text-align:center"  size="24" maxlength="10" datepicker="true" onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);"></td>
    </tr>
    <tr>
      <td height="22" style="text-align:right">Nombre</td>
      <td height="22" colspan="3" style="text-align:left"><input name="txtnombre" type="text" id="txtnombre"  size="111" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn�opqrstuvwxyz '+',-.;*&?�!�+()[]{}%@/'+'������');"></td>
    </tr>
    <tr>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
...
function ue_guardar()
{
	...
	if (li_cambiar==1) 
	   {
               if (f.entautorizada.checked)
               {
                     if ((f.txtcedula.value!="") && (f.txtnombre.value!="") && (f.txtfecha.value!=""))
                    {
