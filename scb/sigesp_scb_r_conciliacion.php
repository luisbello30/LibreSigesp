...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar">
        ...
        <a href="javascript:ue_imprimirexcel();"><img src="../shared/imagebank/tools20/excel.jpg" alt="Excel" title="Excel" width="20" height="20" border="0"></a>
...
$grid="Grid";
$title[1]="";    $title[2]="Banco";  $title[3]="Banco";    $title[4]="Cuenta"; $title[5]="Mes/A�o";    $title[6]="Saldo Libro"; $title[7]="Saldo Banco";    
...
function uf_cargar_conciliacion($li_row)
{
  ...
  $ls_sql = "SELECT scb_banco.codban,scb_banco.nomban,scb_ctabanco.ctaban,scb_ctabanco.dencta,scb_conciliacion.mesano,
			  ...
			  WHERE scb_conciliacion.estcon=1
				...
				AND scb_ctabanco.ctaban=scb_conciliacion.ctaban order by scb_ctabanco.ctaban, scb_conciliacion.mesano";
		       ...
		       if (f.chksel[i].checked)
				  {
					...
					if (ls_mesano!="")
					   {
						 pagina="reportes/sigesp_scb_rpp_conciliacion_excel.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&mesano="+ls_mesano+"&salseglib="+ldec_salseglib+"&salsegbco="+ldec_salsegbco+"&nomban="+ls_nomban+"&tiporeporte="+ls_tiporeporte;
						 window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
					   }
		          }
	         }
