...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td colspan="5" style="text-align:left"><input name="txtconcepto" type="text" id="txtconcepto" value="<?php print $ls_desmov;?>" size="120" onKeyPress="return keyRestrict(event,'0123456789'+'abcdefghijklmnopqrstuvwxyz� .,*/-()$%&!�������[]{}<>')"></td>
    </tr>
    <tr>
	  ...
	  if (uf_evaluate_cierre('SPG'))
		 {
			...
			if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
			{
				...
				else
				{
					...
					{
						alert("Indique el Monto Objeto de Retenci�n");
						return;
					}
				}
				if (eval("f.chkserext.checked==true"))
