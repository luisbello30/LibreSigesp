  ...
  <div align="center">
    <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <select name="estmov" id="estmov">
              ...
              <option value="EC" <?php print $lb_selO;?>>En custodia</option>
              <option value="E" <?php print $lb_selO;?>>Entregado</option>
          </select>
      ...
      <tr>
        ...
        <td height="22" colspan="2"><div align="left">
          <input name="txtcarta" type="text" id="txtcarta">        
        </div></td>
      </tr>
      <tr>
	...
	print "<td>Cuenta</td>";
	print "<td>Denominaci�n Cuenta</td>";
	print "<td>Estatus</td>";
	print "<td>Carta Orden</td>";
        print "<td>Cheques Entredos</td>";
    print "</tr>";
    
	if ($ls_operacion=="BUSCAR")
       {
		  $condicion_carta_orden='';
		  if($ls_carta!="")
			$condicion_carta_orden="AND scb_movbco.numcarord like '%".$ls_carta."' ";
		 ...
		 $ls_sql = "SELECT scb_movbco.codemp,scb_movbco.codban,scb_movbco.ctaban,scb_movbco.numdoc,scb_movbco.numordpagmin, ".
				   ...
				   "	   scb_ctabanco.dencta,scb_ctabanco.sc_cuenta,scb_cheques.numchequera,scb_movbco.codtipfon,scb_movbco.estmovcob,scb_movbco.numconint,scb_movbco.tranoreglib, ".
		           ...
		           "      (SELECT scb_tipofondo.dentipfon 
							...
							WHERE scb_tipofondo.codemp=scb_movbco.codemp 
							  AND scb_tipofondo.codtipfon=scb_movbco.codtipfon) as dentipfon,emicheproc".
		  ...
		  if((($ls_fecdesde!="")&&($ls_fecdesde!="01/01/1900"))&&(($ls_fechasta!="")&&($ls_fechasta!="01/01/1900")))
			...
			if($ls_estmov!="-")
			{
                            ...
                            if ($ls_estmov == 'EC') // en custodia
				$ls_sql=$ls_sql." AND scb_movbco.estmov='C' AND scb_movbco.emicheproc=0";
                            elseif($ls_estmov == 'E') //entregados
                                $ls_sql=$ls_sql." AND scb_movbco.estmov='C' AND scb_movbco.emicheproc=1";
                            else
				    ...
				    while($row=$SQL_mov->fetch_row($rs_data))
					     {
						   ...
						   print "<td>".$ls_numcarord."</td>";
                                                   if ($ls_emicheproc=='1')
						      {
							    $ls_emicheproc = "Entregado";
                                                             print "<td>".$ls_emicheproc."</td>";
                                                          }else{
                                                            $ls_emicheproc = "Sin Entregar";
                                                            print "<td>".$ls_emicheproc."</td>";
                                                          }
...
<script language="JavaScript">
  ...
  function uf_aceptar(ls_documento,ls_codope,ls_fecha,ls_descripcion,ldec_monto,ldec_monobjret,ldec_monret,ls_tipo_destino,ls_prov,ls_bene,ls_provbene,ls_codban,
					  ...
					  ls_codfuefin,ls_numchequera,ls_numordpagmin,ls_codtipfon,ls_dentipfon,ls_numconint,ls_estreglib,ls_chevau)
  {
