    ...
    <table width="565" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22" colspan="2"><div align="left">
          <input name="txtdocumento" type="text" id="txtdocumento"  value="<?php print $ls_numsolpag ?>" maxlength="15" style="text-align:center">        
        </div></td>
			<?php
...
echo "<td width=90  style=text-align:center>C�dula/C�digo</td>";
