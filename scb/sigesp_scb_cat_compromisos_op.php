...
$ls_fecha1 = $io_funcion->uf_convertirdatetobd($ls_fecha);
$lb_valido = $io_classscb->uf_load_comprobantes_positivos($ls_tipodestino,$ls_codpro,$ls_cedbene,$ls_fecha1);
									   ...
									   if ($ld_disponible>0)
										  {
											$ld_monto_solpago=0;
											$ld_acum_solpago =0;
											$ld_acum_solpago= $io_classscb->uf_load_acumulado_solicitudes($ls_comprobantetemp,$ls_codtipdoc,$ls_codpro,$ls_cedbene,$lb_valido);//Buscamos el acumulado en Solicitudes de Pago para la Recepci�n de Documento.
