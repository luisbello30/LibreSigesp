...
<?php
	...
	if( array_key_exists("operacion",$_POST))
	{
		...
		{
                           //se coloca para el ministerio siempre contabilizable ya que las ordenes de pago solo tendran afectacion presupuestaria
                           //la contable se hace por el sigecof
			$lb_nocontab="checked";
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22" colspan="3"><select name="cmbmodalidad" onChange="javascript:uf_valida_cambio();">
        <option value="PP" <?php print $rb_pp;?>>Pago a Proveedores/Beneficiarios</option>
    ...
    <tr>
      ...
      <td><div align="right">Afectaci�n</div></td>
    ...
    <tr>
      ...
      <td colspan="5"><div align="left">
          <input name="txtconcepto" type="text" id="txtconcepto" value="<?php print $ls_desmov;?>" size="120" onKeyPress="return keyRestrict(event,'0123456789'+'abcdefghijklmnopqrstuvwxyz� .,*/-()$%&!�������[]{}<>')">
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:right"><input name="nocontabili" type="checkbox" class="sin-borde" id="nocontabili" disabled value="checkbox" <?php print $lb_nocontab;?>></td>
