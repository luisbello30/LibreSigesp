...
//
//	Arguments:
//			  -$as_codope=Codigo de la operacion a buscar ( Adicionalmente se maneja T para el caso de mostrar todos lo tipos de operaci�n)
...
/*	if (!empty($as_estmov) && ($as_estmov!='-'))
	...
	function uf_cargar_documentos_transito($as_periodo,$as_codban,$as_ctaban,$as_orden)
	{
		...
		$ls_sql=" SELECT numdoc,codope,codban,ctaban,fecmov,conmov,nomproben,estmov,(monto-monret) as monto, estbpd,estcon,estimpche,monobjret,cod_pro,ced_bene,chevau,feccon,estreglib
		FROM   scb_movbco WHERE  fecmov <= '".$ld_fecultimo."' AND ctaban='".$as_ctaban."' AND codban='".$as_codban."' AND (estmov='C' AND emicheproc=0) AND (feccon='1900-01-01' OR feccon>'".$ld_fecha."')".$ls_aux;
		$rs_documentos=$this->SQL->select($ls_sql);
                if($rs_documentos===false)
		{
			$lb_valido=false;
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creaci�n :    26/09/2006          Fecha �ltima Modificacion :      Hora :
  	 //////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $lb_valido = false;
	  $ls_cadena="";
	  ...
	  if($rs_data===false)
	  {
		   $this->io_msg->message("CLASE->sigesp_scb_class_report;M�TODO->uf_scb_reportes_presupuesto_x_banco;ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
			$lb_valido = false;
	  }
      else
      {
...
function uf_cargar_cheques_caducados ($ad_fecdes,$ad_fechas,$as_codban,$as_ctaban,$ad_feccad,&$ls_dias)
	{
		...
		//	Arguments:
		//			  -$as_fecdes=Fecha de inicio de emisi�n de cheque
		//			  -$as_fechas=Fehca de finalizacion de emisi�n de cheques
		//			  -$as_codban=Codigo del banco
		//			  -$as_ctaban=Cuenta bancaria
		//			  -$ad_feccad=Fecha tope de caducidad
		//  Description: Metodo que se encarga de retornar los cheques caducados seg�n los par�metros
		//Realizado Por: Ing. Mar�a Beatriz Unda
		//        Fecha: 25/08/2008
		///////////////////////////////////////////////////////////////////////////////////////////////
 ...
 function uf_select_dias_caducidad($as_codemp,&$as_dias)
	{
		...
		//  Description: Metodo que se encarga de retornar el m�mero de d�a de caducidad de los cheques de la empresa
		//Realizado Por: Ing. Mar�a Beatriz Unda
		//        Fecha: 25/08/2008
		///////////////////////////////////////////////////////////////////////////////////////////////
		$as_dias=0;
...
function uf_retencionesunoxmil_proveedor($as_mes,$as_anio)
	{
		...
		if($rs_data===false)
		{
			$this->is_msg_error="CLASE->Report M�TODO->uf_retencionesunoxmil_proveedor ERROR->".$this->fun->uf_convertirmsg($this->SQL->message);
			print $this->is_msg_error;
			$lb_valido=false;
		}
		else
