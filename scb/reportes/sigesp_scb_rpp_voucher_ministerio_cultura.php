<?PHP
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($ldec_monto,$ls_nomproben,$ls_monto,$ls_fecha,&$io_pdf,$x,$tipo,$ls_cod_ben,$ls_cod_pro)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($tipo=='B')
		  $text="<b>".$ls_nomproben." C.I.: ".$ls_cod_ben."</b>";
		else
		   $text="<b>".$ls_nomproben;//" R.I.F.: ".$ls_cod_pro."</b>";
		$io_pdf->add_texto($valores[2],$valores[3],9,$text);
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_chevau,$ls_nomproben,$ls_solicitudes,$ls_conmov,$ld_fecha,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>580,
						 'fontSize' => 9,
						 'cols'=>array('lbl'=>array('justification'=>'left','width'=>60),'value'=>array('justification'=>'left','width'=>410))); // Ancho M�ximo de la tabla
	...
	function uf_print_detalle($la_title,$la_data,$la_data_spg,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>$li_ancho_cta),
						 			   ...
						 			   'parciales'=>array('justification'=>'center','width'=>$li_ancho_monto), // Justificaci�n y ancho de la columna
						 			   'debe'=>array('justification'=>'right','width'=>$li_ancho_monto), // Justificaci�n y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>$li_ancho_monto))); // Justificaci�n y ancho de la columna
			...
			for ($li_i=1;$li_i<=$li_totrow;$li_i++)
				{
				  ...
				  $ls_tipo_ben_pro = $ds_voucher->data["tipo_destino"][$li_i];
				  ...
				  $ls_tipo_ben_pro = $ds_voucher->data["tipo_destino"][$li_i];
				  $ls_cod_ben=$ds_voucher->data["ced_bene"][$li_i];
				  $ls_cod_pro=$ds_voucher->data["cod_pro"][$li_i];
				  ...
				  $ldec_total	  = $ldec_monto-$ldec_monret;
                                  $ced_bene       = substr($ds_voucher->data["ced_bene"][$li_i],1);
                                  $tipo_destino   = $ds_voucher->data["tipo_destino"][$li_i];
				  ...
				  uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),strtoupper($ls_nomproben),$ls_monto,$ls_fecha,$io_pdf,$y_pos,$ls_tipo_ben_pro,$ls_cod_ben,$ls_cod_pro); // Imprimimos el encabezado de la p�gina
