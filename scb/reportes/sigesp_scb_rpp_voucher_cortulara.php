<?php
	...
	$io_pdf->addText(100,487,9,$ls_chevau);			//numero de cheque voucher
	$io_pdf->addText(30,458,9,$ls_nomban);	     	//nombre del banco
	$io_pdf->addText(250,458,9,$ls_numdoc);        	//numero de documento
	$io_pdf->addText(400,458,9,$ls_ctaban);			//cuenta de banco
	$io_pdf->addText(30,425,9,$ls_solicitudes);		//numero de solicitudes canceladas con el cheque	
	$io_pdf->addText(30,395,9,$ls_nomproben);		//nombre del proveedor o beneficiario	
	...
	function uf_print_detalle($la_title,$la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('estpro'=>array('justification'=>'left','width'=>110),
									   ...
									   'monto_spg'=>array('justification'=>'center','width'=>105),
