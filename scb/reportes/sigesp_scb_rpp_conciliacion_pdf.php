<?PHP
	...
	function uf_print_encabezado_pagina($ls_banco,$ls_mes,$ls_anio,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $li_ancho=$_SESSION["ls_width"];
		 $io_pdf->convertir_valor_px_mm($li_ancho);         
		 $io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],405,$li_alto_usado+95,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		 //------------Fecha--------------------------------//
		 $la_data=array();
		 $la_anchos_col=array();
		 $la_justificaciones=array();
	...
	function uf_print_cabecera($ls_banco,$ls_ctaban,$ls_nomtipcta,$ldec_saldoant,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $la_justificaciones=array();
		 $la_opciones=array();		 
		 $la_data[0]["1"]="<b>CUENTA ".strtoupper($ls_nomtipcta)." N� $ls_ctaban</b>";
	...
	function uf_print_saldo_libro ($ls_fecha,$ls_saldo,&$io_pdf)
	{
		...
		//    Description: funci�n que imprime el saldo segun libro
		//	   Creado Por: Ing. Laura Cabr�
		// Fecha Creaci�n: 21/11/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 /*-------------------------Fecha--------------*/
	...
	function uf_print_autorizacion(&$io_pdf)
	{
		...
		$io_pdf->addText(40,70,9,'<b>Elaborado por:</b>'); // Agregar el t�tulo
		$io_pdf->line(200,80,200,20);
		$io_pdf->addText(220,70,9,'<b>Revisado por </b>'); // Agregar el t�tulo
		$io_pdf->line(400,80,400,20);
		$io_pdf->addText(420,70,9,'<b>Aprobado por </b>'); // Agregar el t�tulo
		$io_pdf->closeObject();
	...
	$io_pdf->set_margenes(2,30,3,3); // Configuraci�n de los margenes en cent�metros
