    ...
    <table width="565" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22" colspan="2"><div align="left">
          <input name="txtnumsolpag" type="text" id="txtnumsolpag" style="text-align:center"  value="<?php print $ls_numsolpag ?>" size="25" maxlength="15">        
        </div></td>
			<?php
...
echo "<td width=70  style=text-align:center>C�digo</td>";
