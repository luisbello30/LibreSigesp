...
//		$con->debug=true;
	...
	function  uf_cargar_programaciones($as_tipproben,$as_codproben,$as_codban,$as_ctaban,&$object,&$li_totsolpag,&$ls_conmov,$as_numordpagmin,$as_codtipfon)
	{
		...
		//                 $as_codproben = Cï¿½digo del Proveedor/Beneficiario.
		//                 $as_codban    = Cï¿½digo del Banco.
		//                 $as_ctaban    = Cuenta Bancaria.
		//                 $object       = Arreglo cargado con las Solicitudes de Pago listas para Emisiï¿½n del Cheque.
		//                 $li_totsolpag = Total de Solicitudes de pago previstas para la Emisiï¿½n del Cheque.
		...
		//	  Description: Funcion que actualiza la solicitud de Ejecuciï¿½n Presupuestaria
...
function uf_load_notas_asociadas($as_codemp,$as_numsol,&$ai_montonotas)
{
	...
	//	          Access:  public
	//	        Arguments  as_codemp //  Cï¿½digo de la Empresa.
	//                     as_numsol //  Nï¿½mero de Identificaciï¿½n de la Solicitud de Pago.
	//                     ai_montonotas //  monto de las Notas de Dï¿½bito y Crï¿½dito.
	//	         Returns:  lb_valido.
	//	     Description:  Funciï¿½n que se encarga de buscar las notas de debito y crï¿½dito asociadas a la solicitud de pago. 
	//     Elaborado Por:  Ing. Yesenia Moreno
	// Fecha de Creaciï¿½n:  26/09/2007       Fecha ï¿½ltima Actualizaciï¿½n:
	////////////////////////////////////////////////////////////////////////////// 
	$lb_valido=true;
	$ai_montonotas=0;
...
// Access:		  public
//	Returns:	  String--- Retorno la cuenta contable del catalogo de clasificaciï¿½n de CXP
//	Description:  Funcion que busca la cuenta contable de la recepciï¿½n o recepciones
//////////////////////////////////////////////////////////////////////////////
	$ls_codemp=$this->dat["codemp"];
	if($as_provbene=='P')
	{
			...
			while ($row=$this->io_sql->fetch_row($rs_dararec))
			      {
				    ...
				    if (empty($ls_cadena))
				    {
					     $ls_cadena = "AND ( ( sigesp_cmp.procede='CXPRCD' AND (spg_dt_cmp.comprobante='".$ls_codrecdoc."'";
				    }				
				    else
				       {
				    ...
				    if (!empty($ls_cadena))
				      {
					    $ls_cadena = $ls_cadena.")) OR (sigesp_cmp.procede='CXPSOP' AND (spg_dt_cmp.comprobante='".$as_numsol."')))";
				      }
				    else
				      {
...
function uf_obtener_recepciones_asociadas($as_numsol)
{
	...
	//	  Description: Funciï¿½n que busca las recepciones de documentos asociadas a una solicitud
...
//		   Access: public
//		 Argument: $as_codemp = Cï¿½digo de la Empresa.
//                 $as_numsol = Nï¿½mero de la Solicitud de Pago.
//	  Description: Funciï¿½n que extrae la sumatoria de las retenciones de IVA Cuentas Por Pagar asociadas
//                 a una Solicitud de Pago.
//	   Creado Por: Ing. Nï¿½stor Falcï¿½n.
//     Modificado por: Ing. Jennifer Rivero
// Fecha Creaciï¿½n: 23/06/2008
// Fecha de Modificaciï¿½n:17/10/2008
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//--------------------------------------------------------------------------------------------------------------------------------------
	...
	//	        Arguments  as_codemp //  Cï¿½digo de la Empresa.	
	//	         Returns:  lb_valido.
	//	     Description:  Funciï¿½n que busca si posee pago de anticipos (Contabilizados)
	//     Elaborado Por:  Ing. Jennifer Rivero
	// Fecha de Creaciï¿½n:  06/10/2008       Fecha ï¿½ltima Actualizaciï¿½n:
	////////////////////////////////////////////////////////////////////////////// 
		$lb_valido=true;	
...
//---------------------------------------------------------------------------------------------------------------------------------------
	...
	//	        Arguments  
	//	         Returns:  lb_valido.
	//	     Description:  Funciï¿½n que amortiza el saldo del anticipo
	//     Elaborado Por:  Ing. Jennifer Rivero
	// Fecha de Creaciï¿½n:  07/10/2008       Fecha ï¿½ltima Actualizaciï¿½n:
	////////////////////////////////////////////////////////////////////////////// 
		$lb_valido=true;	
...
//--------------------------------------------------------------------------------------------------------------------------------------
	...
	//	        Arguments  
	//	         Returns:  lb_valido.
	//	     Description:  Funciï¿½n que inserta los asientos contables
	//     Elaborado Por:  Ing. Jennifer Rivero
	// Fecha de Creaciï¿½n:  07/10/2008       Fecha ï¿½ltima Actualizaciï¿½n:
	////////////////////////////////////////////////////////////////////////////// 
		$lb_valido=true;
