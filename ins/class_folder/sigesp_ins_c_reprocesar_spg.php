...
class sigesp_ins_c_reprocesar_spg
{
	...
	function uf_reprocesar_saldos($ls_codemp,$as_sin_validacion,$as_codestpro1desde,$as_codestpro1hasta,$aa_seguridad)
	{
		...
		//  Arguments:  
		//	  Returns:  Boolean
		//Description:  Este m�todo realiza la actualizaci�n de los saldos de las cuentas presupustarias 
		...
		if($li_numrow===false)
		{
            $this->io_message->message("CLASE->Reprocesar SPG M�TODO->uf_reprocesar_saldos ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			$lb_valido=false;
		}		
								 ...
								 &$adec_precomprometido, &$adec_comprometido,&$adec_causado, &$adec_pagado)
	{
		...
		// Modificado Por: Ing. Yozelin Barragan					Fecha �ltima Modificaci�n : 06/02/2008
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido =true;
