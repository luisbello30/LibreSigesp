<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,&$io_pdf)
	{
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,690,13,'<b>'.$as_titulo.'</b>'); // Agregar el t�tulo
	...
	function uf_print_cabecera($as_nomemp,$as_codper,$as_nompro,$as_nomrespro,$ls_nomper,&$io_pdf)
	{
		...
		$datos = "Entre <b>".$as_nomemp."</b> representado en este acto por el ciudadano <b>".$ls_nomper."</b> por una parte y por la otra \"LA EMPRESA\" <b>".$as_nompro."</b> representada en este acto por el ciudadano <b>".$as_nomrespro."</b>, se ha procedido a efectuar la ". utf8_decode("recepción")." de los servicios consistentes en:";

                
                
		$la_data=array(array('name'=>$datos));
	...
	function uf_print_cuerpo($as_nomemp,$as_numordcom,$ad_fecordcom,$ai_montot,$as_totordser,$as_ciuemp,$ad_fecrecser,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-20);
		$la_data1[1]=array('empresa'=>"RECIBE CONFORME");
		$la_data1[2]=array('empresa'=>"Firma:___________________________");
		$la_data1[3]=array('empresa'=>"Nombre:_________________________");
		$la_data1[4]=array('empresa'=>"Cargo:__________________________");
		$la_data1[5]=array('empresa'=>"C.I.:_____________________________");
		$la_columna=array('empresa'=>'<b>POR EL '.strtoupper($as_nomemp).' </b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'rowGap' => 1.5 ,
						 'cols'=>array('empresa'=>array('justification'=>'center','width'=>245) // Justificaci�n y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-20);
		$la_columna=array('denser'=>'<b>'.utf8_decode("Denominación").'</b>',
						  'canser'=>'<b>Cantidad</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>500, // Ancho M�ximo de la tabla
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'cols'=>array('denser'=>array('justification'=>'left','width'=>330), // Justificaci�n y ancho de la columna
						 			   'canser'=>array('justification'=>'right','width'=>60), // Justificaci�n y ancho de la columna
						 			   'monuniser'=>array('justification'=>'right','width'=>100))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
			  ...
			  if ($li_numrows>0)
			     {
				           ...
				           if ($li_i==1)
						      {
				                ...
				                $ls_contenido="Entre <b>".$ls_nomemp."</b> representado en este acto por el ciudadano <b>".$ls_nomper."</b> por una parte y por la otra 'LA EMPRESA' <b>".$ls_nompro."</b> representada en este acto por el ciudadano <b>".$ls_nomreppro."</b>, se ha procedido a efectuar la ".utf8_decode('recepción')." de los servicios consistentes en: ";
				                $io_pdf->ezText($ls_contenido,11,array('justification' =>'full','spacing' =>1.5));
							  }
					...
					$io_pdf->ezSetDy(-10);
					$ls_contenido="Los cuales fueron concluidos en fecha <b>".$ls_fecaceser."</b> ".utf8_decode("según")." Orden de Servicio Nro <b>".
											  $ls_numordcom."</b> de fecha <b>".$ls_fecordcom."</b>.  Acta levantada al efecto, en la forma siguiente:";
					$io_pdf->ezText($ls_contenido,11,array('justification' =>'full','spacing' =>1.5));
					$io_pdf->ezSetDy(-5);
					$ls_contenido="El representante del '<b>".$ls_nomemp."</b>', luego de haber constatado que 'LA EMPRESA' ".utf8_decode("ejecutó")." los servicios ".utf8_decode("señalados")." en la referida Orden de Servicio, declara ACEPTADOS dichos servicios.";
					$io_pdf->ezText($ls_contenido,11,array('justification' =>'full','spacing' =>1.5));
					$io_pdf->ezSetDy(-5);
					...
					$io_pdf->ezText('<b>'.$ls_contenido.'</b>',11,array('justification' =>'full','spacing' =>1.5));
					$ld_dia  = date("d");
					$ld_mes  = date("m");
					$ld_anio = date("Y");
					$ls_mes  = $io_fun_fecha->uf_load_nombre_mes($ld_mes);
					...
					if ($io_pdf->ezPageCount==$li_numpag)
					   ...
					   {// Hacemos un rollback de los registros, agregamos una nueva p�gina y volvemos a imprimir
						 ...
						 uf_print_cabecera($ls_nomemp,$ls_cedper,$ls_nompro,$ls_nomreppro,$ls_nomper,$io_pdf); //$as_nomemp,$as_codper,$as_nompro,$as_nomrespro,$ls_nomper,&$io_pdf Imprimimos la cabecera del registro
						 uf_print_detalle($la_data,$io_pdf); // Imprimimos el detalle 
