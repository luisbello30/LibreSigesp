...
?>
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22">&nbsp;</td>
	<td width="147" height="22"><strong>Fecha</strong></td>
	 <td height="22"><label>
	    <input name="txtfecregcot" type="text" id="txtfecregcot"  style="text-align:center" value="<?php print $ls_fecregcot ?>" size="15" maxlength="10" datepicker="true" <?php echo $ls_disabled; ?> onKeyDown="javascript:ue_formato_fecha(this,'/',patron,true,event);" onBlur="javascript: ue_validar_formatofecha(this);" >
	</td>
