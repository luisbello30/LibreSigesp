...
<p>
  <?php 
   function uf_limpiarvariables()
   {
		...
		global $ls_estasitec,$ls_estesp,$ls_garanacot;
...
function ue_catalogo_proveedores(li_item,li_items)//abre el catalogo de proveedores por bien/servicio
{
  if (uf_evaluate_cierre())
     {
	   numsolcot=f.txtnumsol1.value;
	  coditem='';
	  for(i=1;i<=li_items;i++){
	   coditem=coditem+eval("document.formulario.txtcoditem"+i+".value");
	   if(i<li_items)
	      coditem=coditem+'--';
	  }
	   tipsolcot=f.txttipsolcot1.value;
