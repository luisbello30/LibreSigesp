<?php
	...
	function uf_limpiar_grid_cotizaciones()
	{
		...
		//		   Access: public
		//	    Arguments://
		//	  Description: M�todo que limpia el grid de las Cotizaciones
	...
	{	
		...
		//	  Description: M�todo que imprime el grid de las Cotizaciones
		//	   Creado Por: Ing. Laura Cabr�
		// Fecha Creaci�n: 14/03/2007								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		for($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		{
			...
			if($li_fila==$ai_total)// si es la �ltima fila no pinto las dos ultimas 
			{
				$lo_object[$li_fila][7]=" ";
				$lo_object[$li_fila][8]="  ";
			}
			...
			{
				$lo_object[$li_fila][7]="<a href=javascript:uf_ver_cotizacion(".$li_fila.")><div align=center><img src=../shared/imagebank/mas.gif title=Clic para ver detalle de Cotizaci�n width=9 height=17 border=0></div></a>";
				$lo_object[$li_fila][8]="<a href=javascript:ue_delete_cotizacion(".$li_fila.")><div align=center><img src=../shared/imagebank/tools15/eliminar.gif title=Eliminar Cotizaci�n width=15 height=15 border=0></div></a>";
			}			
		}			
	...
	{	
		...
		//		   Access: private
		//	  Description: M�todo que imprime el grid de los bienes/servicios
		//	   Creado Por: Ing. Laura Cabr�
		...
		for ($li_i=1;$li_i<=$li_total;$li_i++)
			...
			$lo_object[$li_fila][1]="<input name=txtcoditem".$li_fila."          id=txtcoditem".$li_fila."        type=text  class=sin-borde   size=20  value='$ls_coditem'    style=text-align:center   readonly>";
			$lo_object[$li_fila][2]="<input name=txtnomitem".$li_fila."          id=txtnomitem".$li_fila."        type=text  class=sin-borde   size=30  value='$ls_nomitem'    style=text-align:left     readonly title='$ls_nomitem'>";
			$lo_object[$li_fila][3]="<div align=right><input name=txtnomproitem".$li_fila."       id=txtnomproitem".$li_fila."     type=text  class=sin-borde   size=38  value='$ls_nompro'               style=text-align:left     readonly ><a href='javascript:ue_catalogo_proveedores(".$li_fila.",".$li_total.")'><img src='../shared/imagebank/tools20/buscar.gif' title='Seleccionar Proveedor' width=20 height=20 border=0></a></div><input name=txtcodproselec".$li_fila."   id=txtcodproselec".$li_fila."   type=hidden value='$ls_codpro'>";
	...
	{	
		...
		//		   Access: private
		//	    Arguments: ai_total  // Total de filas a imprimir
		//	  Description: M�todo que actualiza el grid de los bienes/servicios
		//	   Creado Por: Ing. Laura Cabr�
		// Fecha Creaci�n: 28/05/2007								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
