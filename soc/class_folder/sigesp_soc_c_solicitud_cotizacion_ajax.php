<?php
	...
	{	
		...
		for($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		{
			...
			{
				$lo_object[$li_fila][5]="<a href=javascript:ue_imprimir_proveedor('".$ls_codpro."');><img src=../shared/imagebank/tools20/imprimir.gif title=Imprimir alt=Imprimir width=15 height=10 border=0/></a>
							  <a href=javascript:ue_delete_proveedor('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.gif title=Eliminar width=15 height=10 border=0></a>";
			}
		}
		print "<p>&nbsp;</p>";
		...
		print "    </tr>";
		print "  </table>";
		$io_grid->make_gridScroll($ai_total,$lo_title,$lo_object,880,"Proveedores","gridproveedores",100);
	...
	{	
		...
		print "    </tr>";
		print "  </table>";
		$io_grid->make_gridScroll($li_fila,$lo_title,$lo_object,880,"Proveedores","gridproveedores",100);
