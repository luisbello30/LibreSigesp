<?php
		...
		for ($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		    {
			  ...
			  $ls_denart = $io_funciones_soc->uf_obtenervalor("txtdenart".$li_fila,"");
                          $ls_formula = $io_registro->uf_load_formula_credito($ls_codart,'B',$lb_valido); /*modificacion 08/05 se agrego*/
			  ...
			  $lo_object[$li_fila][2] = "<input type=text name=txtdenart".$li_fila."  id=txtdenart".$li_fila."  class=sin-borde style=text-align:left   size=60  value='".$ls_denart."'  readonly> <input type=hidden name=formula".$li_fila." id=formula".$li_fila." value='".$ls_formula."'> "; /*modificacion 08/05 se agrego*/
	...
	{	
		...
		// Fecha Creaci�n: 13/04/2007								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_grid, $io_funciones_soc;
		...
		while ($row=$io_registro->io_sql->fetch_row($rs_data))	  
		      {
				...
				$ld_porcre = $io_registro->uf_load_porcentaje_credito($ls_codart,'B',$lb_valido);//Porcentaje del Cr�dito en caso de tenerlo.
                                $ls_formula = $io_registro->uf_load_formula_credito($ls_codart,'B',$lb_valido);//Porcentaje del Cr�dito en caso de tenerlo.
		...
		while($row=$io_registro->io_sql->fetch_row($rs_data))	  
		     {
			   ...
			   $ld_porcre = $io_registro->uf_load_porcentaje_credito($ls_codser,'S',$lb_valido);//Porcentaje del Cr�dito en caso de tenerlo.
			   $ls_formula = $io_registro->uf_load_formula_credito($ls_codser,'S',$lb_valido);//Porcentaje del Cr�dito en caso de tenerlo.
	...
	{	
		...
		//	  Description: M�todo que busca los bienes de la Cotizaci�n y los imprime
		//	   Creado Por: Ing. N�stor Falcon.
		// Fecha Creaci�n: 28/05/2007								Fecha �ltima Modificaci�n : 28/05/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_grid, $io_funciones_soc;
