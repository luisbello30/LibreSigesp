...
class sigesp_c_generar_consecutivo
 {
	...
	{	
		...
		// Fecha Creaci�n: 26/07/2007 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_load_prefijo($as_codsis,$as_procede)
	{
		...
		//	  Description: Funci�n que Obtiene el prefijo del numero de documento (en caso de poseerlo)
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creaci�n: 26/07/2007 								Fecha �ltima Modificaci�n : 
		//////////////////////////////////////////////////////////////////////////////
		$ls_prefijo="00";
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Generar_Consecutivo M�TODO->uf_load_prefijo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		else
		{
	...
	function uf_load_numero_inicial($as_campo)
	{
		...
		//	  Description: Funci�n que el Valor Inicial del Documento
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creaci�n: 26/07/2007 								Fecha �ltima Modificaci�n : 
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Generar_Consecutivo M�TODO->uf_load_numero_inicial ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		else
		{
	...
	function uf_load_data_existente($as_tabla,$as_campo,$as_filtro,$as_valor,$as_prefijo)
	{
		...
		//	  Description: Funci�n que obtiene el ultimo valor de la tabla indicada
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creaci�n: 26/07/2007 								Fecha �ltima Modificaci�n : 
		//////////////////////////////////////////////////////////////////////////////
...
//agregada
			/*if($as_tabla == "scb_cmp_ret" AND $as_valor == "0000000001")
			{
				$ls_criterio=$ls_criterio . " AND numcom LIKE '" . strftime("%Y%m") . "%'";
			}*/
//agregada
...
//agregada
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Generar_Consecutivo M�TODO->uf_load_data_existente ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		else
		{
										  ...
										  $as_valor,&$as_numero)
	{
		...
		//	  Description: Funci�n que verifica si un numero generado esta disponible
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creaci�n: 26/07/2007 								Fecha �ltima Modificaci�n : 
		//////////////////////////////////////////////////////////////////////////////
		require_once("sigesp_release.php");
...
//agregada
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Generar_Consecutivo M�TODO->uf_verificar_numero_generado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		else
		{
			...
			else
			{
				...
				{
					$this->io_mensajes->message("Se le Asign� un nuevo n�mero de documento el cual es :".$as_numero);
				}
			}
			$this->io_sql->free_result($rs_data);	
		}
	...
	function uf_generar_numero_nuevo($as_codsis,$as_tabla,$as_campo,$as_procede,$ai_loncam,$as_camini,$as_filtro,$as_valor)
	{
		...
		//settype($ls_nro,'int');
		//$li_nvonro=$ls_nro + 1;
		$li_nvonro=bcadd($ls_nro,"1");//agregada
		// var_dump($ls_prefijo);
		if($ls_prefijo!="")
		{
