...
class class_sql
{
	...
	function seleccionar($ps_sentencia,&$pa_datos)
	 ...
	 // sigesp_snorh_c_fideicomiso.php
...
//echo $sql."<hr>";
	...
	/*Intenta Causar mas que lo Comprometido PR1-PR11-201 - P - 40307030000               a la fecha 2011-05-25*/
	function execute($sql)
	{
		///reportes/sigesp_scg_rpp_balance_comprobacion_pdf.php
		////////////////////////////////////////////////////////////////////////////////////////////
		// Function:   	 execute
