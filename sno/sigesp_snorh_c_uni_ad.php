...
class sigesp_snorh_c_uni_ad
{
	...
	{	
		...
		// Fecha Creaci�n: 25/05/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_select_unidadadministrativa($as_coduniadm)
	{
		...
		if($rs_data===false)
		{
        	$this->io_mensajes->message("CLASE->Unidad Administrativa M�TODO->uf_select_unidadadministrativa ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_insert_unidadadministrativa($as_coduniadm,$as_desuniadm,$as_codpro,$as_estcla,$aa_seguridad)
	{
		...
		{
 			$lb_valido=false;
        	$this->io_mensajes->message("CLASE->Unidad Administrativa M�TODO->uf_insert_unidadadministrativa ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	...
	function uf_update_unidadadministrativa($as_coduniadm,$as_desuniadm,$as_codpro,$as_estcla,$aa_seguridad)
	{
		...
		{
			$lb_valido=false;
        	$this->io_mensajes->message("CLASE->Unidad Administrativa M�TODO->uf_update_unidadadministrativa ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$this->io_sql->rollback();
		}
		else
		{
	...
	{		
		...
		//	  Description: Funcion que guarda en la tabla sno_profesi�n
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 25/05/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;		
	...
	function uf_select_personalnomina($as_coduniadm)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Unidad Administrativa M�TODO->uf_select_personalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_cestaticunidadadm($as_coduniadm)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Unidad Administrativa M�TODO->uf_select_cestaticunidadadm ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_existe=false;
		}
		else
		{
	...
	function uf_delete_unidadadministrativa($as_coduniadm,$aa_seguridad)
	{
			...
			($this->uf_select_cestaticunidadadm($as_coduniadm)===false))
		{
			...
			{
				$lb_valido=false;
        		$this->io_mensajes->message("CLASE->Unidad Administrativa M�TODO->uf_delete_unidadadministrativa ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
				$this->io_sql->rollback();
			}
			else
			{
