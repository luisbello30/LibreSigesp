...
class sigesp_snorh_c_nominas
{
	...
	function sigesp_snorh_c_nominas()
	{
		...
		// Fecha Creación: 15/02/2006 								Fecha ï¿½ltima Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{	
		...
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creación: 01/01/2006 								Fecha ï¿½ltima Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		unset($io_include);
		unset($io_conexion);
		unset($this->io_sql);	
	...
	function uf_insert_cargo_default($as_codnom)
	{
		...
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creación: 20/03/2006 								Fecha ï¿½ltima Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
...
$this->io_mensajes->message("CLASE->Asignación Cargo MÉTODO->uf_insert_asignacioncargo_default ERROR->". ($_SESSION['session_activa']));
	...
	function uf_insert_escaladocente_default()
	{
		...
		//	  Description: Funcion que inserta en la tabla sno_dedicacion
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creación: 12/05/2006 								Fecha ï¿½ltima Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
							  ...
							  $ai_estctaalt,$as_racobrnom,$aa_seguridad)
	{
		...
		else
		{
			////////////////////////////////         SEGURIDAD               //////////////////////////////
			$ls_evento="UPDATE";
			$ls_descripcion ="Actualizï¿½ la Nómina ".$as_codnom;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////	
						 ...
						 &$as_informa,&$ai_genrecdocpagperche,&$as_tipdocpagperche,&$ai_estctaalt,&$as_racobrnom)
	{
		...
		//              $ai_cmbtipoperiodo // codigo tipo de perï¿½odo
		//              $as_despernom //  descripción del perï¿½odo
		//              $as_anocurnom  //  aï¿½o en curso
		//              $adt_fecininom //  fecha de inicio de la nï¿½mina
		//              $as_peractnom  //  perï¿½odo actual de la nï¿½mina
		//              $ai_cmbtipnom // tipo de nï¿½mina
		//              $as_cmbmet //  mï¿½todo del cesta ticket
		//              $as_diabonvacnom //  dï¿½as de bono de salida de vacaciones
		//              $as_diainivacnom //  dï¿½as iniciales de vacaciones
		//              $as_diareivacnom  //  dï¿½as de bono reingreso de vacaciones
		//              $as_diatopvacnom  // dï¿½as de tope de vacaciones
		//              $as_diaincvacnom // dias de incremento por aï¿½o de vacaciones
		//              $as_subnom  //  sub nï¿½mina 
		//              $as_adenom //  utiliza el adelanto de pago
		//              $as_racnom //  registro de asignación de cargos
		//              $as_espnom //  nï¿½mina especial
		//              $as_ctnom //   nï¿½mina de cesta ticket
		//              $as_cueconnom  //  cuenta contable
		//              $as_provee //   cï¿½digo del proveedor
		//              $as_benef //   cï¿½digo del beneficiario
		//              $as_numvounom  //  voucher nota de dï¿½bito
		//              $as_notdebnom //  nota de dï¿½bito
		//              $as_cmbconaponom  //  mï¿½todo de contabilizar los aportes de la nï¿½mina
		//              $as_conpernom  //  Validar la Contabilización del perï¿½odo anterior
		//				$as_confidnom  // Contabilización del Fideicomiso
		//				$as_recdocfid  // Generar Rececpiï¿½n de Documento 
		//				$as_tipdocfid  // Tipo de Documento del Fideicomiso
		//				$as_codbenfid  // Cï¿½digo del Beneficiario
	...
	function uf_delete_nomina($as_codnom,$aa_seguridad)
	{
		...
		if($lb_valido)
		{
			...
			if($lb_valido)
			{
				/////////////////////////////////         SEGURIDAD               /////////////////////////////
				$ls_evento="DELETE";
				$ls_descripcion ="Eliminï¿½ la Nómina ".$as_codnom;
				$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////	
				...
				{
					$lb_valido=false;
        			$this->io_mensajes->message("CLASE->nï¿½mina MÉTODO->uf_delete_nomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
					$this->io_sql->rollback();
				}
			}
		}
	...
	function uf_update_periodo($as_codnom,$as_codperi,$aa_seguridad)
	{
	    ...
	    // Fecha Creación :    01/03/2006          Fecha ï¿½ltima Modificacion : 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="UPDATE sno_nomina ".
	...
	function uf_load_periodo($as_codnom,&$ai_totrows,&$ao_object)
	{
		...
		//	    Arguments: as_codnom  //  cï¿½digo de la nï¿½mina
		...
		//	  Description: Funcion que obtiene todos los perï¿½odos de una tabla de vacaciones
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creación: 02/06/2006 								Fecha ï¿½ltima Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
										...
										$ai_genrecdocpagperche ,$as_tipdocpagperche,$ai_estctaalt,$aa_seguridad)
	{
                ...
                else
		{
                        ...
                        ////////////////////////////////         SEGURIDAD               //////////////////////////////
                        $ls_evento="UPDATE";
                        $ls_descripcion ="Actualizï¿½ la Configuración de contabilización de la Nómina ".$as_codnom.", Aï¿½o ".$_SESSION["la_nomina"]["anocurnom"].
	...
	function uf_guardar_periodoadicional($as_existe,$as_codnom,$as_codperi,$ad_fecdesper,$ad_fechasper,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////
		//	Function:     uf_sno_fill_periodo
		//	Arguments:    as_codnom //  cï¿½digo de Nómina
			...
			case "FALSE":
				if($this->uf_select_periodo($as_codnom,$as_codperi)===false)
				{
					...
					else
					{
						////////////////////////////////         SEGURIDAD               //////////////////////////////
						$ls_evento="INSERT";
						$ls_descripcion ="Insertï¿½ el Periodo Adicional ".$as_codperi.", Fecha desde ".$ad_fecdesper.", Fecha Hasta ".$ad_fechasper."  a la Nómina ".$as_codnom;
						$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
														$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
														$aa_seguridad["ventanas"],$ls_descripcion);
						/////////////////////////////////         SEGURIDAD               /////////////////////////////	
	...
	function uf_load_nominas_reportar(&$ai_totrows,&$ao_object)
	{
		...
		//				   ao_object  // objetos del detalle
		//	      Returns: lb_valido True si se ejecuto el buscar ï¿½ False si hubo error en el buscar
		//	  Description: Funcion que obtiene todas las nï¿½minas
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creación: 22/02/2007 								Fecha ï¿½ltima Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
...
//-----------------------------------------------------------------------------------------------------------------------------------		
	...
	{    
		...
		//               $as_tippernom // tipo del periodo de la nï¿½mina 
		//               $as_codperi  // cï¿½digo del nuevo periodo
		//	Returns:	 $lb_valido // True si realizo el select correctamente o False en caso contrario
		//	Description: Funcion que selecciona los datos de la nomina segun el codigo pasado por  parametros
...
//-----------------------------------------------------------------------------------------------------------------------------------		
	...
	{    
		...
		//               $ad_fecdesper // fecha inicial del nuevo periodo
		//               $ad_fechasper // fecha final del nuevo periodo	
		//               $as_codperi  // cï¿½digo del periodo
		//	Returns:	 $lb_valido // True si realizo el select correctamente o False en caso contrario
