<?php
   ...
   function uf_print($as_codconc, $as_nomcon, $as_tipo)
   {
		...
		print "<td width=140>F&oacute;rmula</td>";
		print "</tr>"; 
		$ls_sql="SELECT  anocur, codperi, codconc, nomcon, titcon, sigcon, forcon, glocon, acumaxcon, valmincon, valmaxcon, concon, ".
				...
				"		    AND spi_cuentas.spi_cuenta=sno_hconcepto.spi_cuenta) as deningcon, ".
				"		(SELECT nompro ".
				"		   FROM rpc_proveedor ".
				"		  WHERE codemp='".$ls_codemp."'	".
				"		    AND rpc_proveedor.cod_pro=sno_hconcepto.codprov) as proveedor, ".
				"		(SELECT nombene ".
				"		   FROM rpc_beneficiario ".
				"		  WHERE codemp='".$ls_codemp."'	".
				"		    AND rpc_beneficiario.ced_bene=sno_hconcepto.cedben) as beneficiario, ".
				"		(SELECT denominacion ".
				"		   FROM spg_cuentas ".
				"		  WHERE codemp=sno_hconcepto.codemp ".
				"		    AND spg_cuentas.codestpro1=substr(sno_hconcepto.codpro,1,20) ".
				"		    AND spg_cuentas.codestpro2=substr(sno_hconcepto.codpro,21,6) ".
				"		    AND spg_cuentas.codestpro3=substr(sno_hconcepto.codpro,27,3) ".
				"		    AND spg_cuentas.codestpro4=substr(sno_hconcepto.codpro,30,2) ".
				"		    AND spg_cuentas.codestpro5=substr(sno_hconcepto.codpro,32,3) ".
				"		    AND spg_cuentas.estcla=sno_hconcepto.estcla ".
				"		    AND spg_cuentas.spg_cuenta=sno_hconcepto.cueprecon) as denprecon, ".
				"		(SELECT denominacion ".
				"		   FROM scg_cuentas ".
				"		  WHERE codemp=sno_hconcepto.codemp ".
				"		    AND scg_cuentas.sc_cuenta=sno_hconcepto.cueconcon) as dencuecon, ".
				"		(SELECT denestpro1 ".
				"		   FROM spg_ep1 ".
				"		  WHERE spg_ep1.codemp=sno_hconcepto.codemp".
				"		    AND spg_ep1.codestpro1=substr(sno_hconcepto.codpro,0,26)".
				"           AND spg_ep1.estcla = sno_hconcepto.estcla) as denestpro1, ".
				"		(SELECT estcla ".
				"		   FROM spg_ep1 ".
				"		  WHERE spg_ep1.codemp='".$ls_codemp."'	".
				"		    AND spg_ep1.codestpro1=substr(sno_hconcepto.codpro,0,26)".
				"           AND spg_ep1.estcla = sno_hconcepto.estcla) as estcla1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE spg_ep2.codemp=sno_hconcepto.codemp".
				"		    AND spg_ep2.codestpro1=substr(sno_hconcepto.codpro,0,26) ".
				"		    AND spg_ep2.codestpro2=substr(sno_hconcepto.codpro,26,25)".
				"           AND spg_ep2.estcla = sno_hconcepto.estcla) as denestpro2, ".
				"		(SELECT estcla ".
				"		   FROM spg_ep2 ".
				"		  WHERE spg_ep2.codemp='".$ls_codemp."'	".
				"		    AND spg_ep2.codestpro1=substr(sno_hconcepto.codpro,0,26) ".
				"		    AND spg_ep2.codestpro2=substr(sno_hconcepto.codpro,26,25)".
				"           AND spg_ep2.estcla = sno_hconcepto.estcla ) as estcla2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE spg_ep3.codemp=sno_hconcepto.codemp".
				"		    AND spg_ep3.codestpro1=substr(sno_hconcepto.codpro,0,26) ".
				"		    AND spg_ep3.codestpro2=substr(sno_hconcepto.codpro,26,25) ".
				"		    AND spg_ep3.codestpro3=substr(sno_hconcepto.codpro,51,25)".
				"           AND spg_ep3.estcla = sno_hconcepto.estcla) as denestpro3, ".
				"		(SELECT estcla ".
				"		   FROM spg_ep3 ".
				...
				"		    AND spg_ep3.codestpro2=substr(sno_hconcepto.codpro,26,25) ".
				"		    AND spg_ep3.codestpro3=substr(sno_hconcepto.codpro,51,25)".
				"           AND spg_ep3.estcla = sno_hconcepto.estcla) as estcla3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE spg_ep4.codemp=sno_hconcepto.codemp".
				"		    AND spg_ep4.codestpro1=substr(sno_hconcepto.codpro,0,26) ".
				"		    AND spg_ep4.codestpro2=substr(sno_hconcepto.codpro,26,25) ".
				"		    AND spg_ep4.codestpro3=substr(sno_hconcepto.codpro,51,25) ".
				"		    AND spg_ep4.codestpro4=substr(sno_hconcepto.codpro,76,25)".
				"           AND spg_ep4.estcla = sno_hconcepto.estcla) as denestpro4, ".
				"		(SELECT estcla ".
				"		   FROM spg_ep4 ".
				...
				"		    AND spg_ep4.codestpro3=substr(sno_hconcepto.codpro,51,25) ".
				"		    AND spg_ep4.codestpro4=substr(sno_hconcepto.codpro,76,25)".
				"           AND spg_ep4.estcla = sno_hconcepto.estcla) as estcla4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE spg_ep5.codemp=sno_hconcepto.codemp".
				"		    AND spg_ep5.codestpro1=substr(sno_hconcepto.codpro,0,26) ".
				"		    AND spg_ep5.codestpro2=substr(sno_hconcepto.codpro,26,25) ".
				"		    AND spg_ep5.codestpro3=substr(sno_hconcepto.codpro,51,25) ".
				"		    AND spg_ep5.codestpro4=substr(sno_hconcepto.codpro,76,25) ".
				"		    AND spg_ep5.codestpro5=substr(sno_hconcepto.codpro,101,25) ".
				"           AND spg_ep5.estcla = sno_hconcepto.estcla) as denestpro5, ".
				"		(SELECT estcla ".
				"		   FROM spg_ep5 ".
				...
				"		    AND spg_ep5.codestpro4=substr(sno_hconcepto.codpro,76,25) ".
				"		    AND spg_ep5.codestpro5=substr(sno_hconcepto.codpro,101,25)".
				"           AND spg_ep5.estcla = sno_hconcepto.estcla) as estcla5 ".
				"  FROM sno_hconcepto ".
				" WHERE codemp='".$ls_codemp."'".
		...
		{ 
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($ls_sigcon)
				{
					...
					case "B":
						$ls_signo="Reintegro Deducci�n";
						break;
	
					case "E":
						$ls_signo="Reintegro Asignaci�n";
						break;
				}			
				switch ($as_tipo)
				{
...
function aceptarreplisconchas(codconc)
{
	...
	{
		alert("Rango del concepto inv�lido");
	}
}
