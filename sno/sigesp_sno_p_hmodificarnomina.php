...
<?php 
	...
	{
		print("<script language=JavaScript>");
		print(" alert('Este proceso esta desactivo para Per�odos de a�os Diferentes al Periodo de la Empresa.');");
...
function ue_guardar()
{
	...
	if(f.contabilizado.value=="0")
	{
		...
		{
			alert("La Configuraci�n de la Contabilizaci�n de las N�minas esta global. No se puede hacer ning�n cambio.");
		}
	}
	else
	{
		alert("El per�odo est� contabilizado. no se puede hacer ning�n cambio.");
	}
}
