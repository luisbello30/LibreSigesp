...
class sigesp_sno_class_report
{
  ...
  function uf_pagonomina_personal_rango_peri($as_codperdes,$as_codperhas,$as_conceptocero,$as_conceptoreporte,$as_conceptop2,$as_codubifis,
		$as_codpai,$as_codest,$as_codmun,$as_codpar,$as_subnomdes,$as_subnomhas,$as_orden,$ls_codnom,$ls_codperides,$ls_codperihas, $ls_coduniadm)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_pagonomina_personal
		//         Access: public (desde la clase sigesp_sno_rpp_pagonomina)  
		...
		{
			$ls_criterio=$ls_criterio."   AND sno_hpersonalnomina.minorguniadm='".substr($ls_coduniadm,0,4)."' ";
			$ls_criterio=$ls_criterio."   AND sno_hpersonalnomina.ofiuniadm='".substr($ls_coduniadm,5,2)."' ";
			$ls_criterio=$ls_criterio."   AND sno_hpersonalnomina.uniuniadm='".substr($ls_coduniadm,8,2)."' ";
			$ls_criterio=$ls_criterio."   AND sno_hpersonalnomina.depuniadm='".substr($ls_coduniadm,11,2)."' ";
			$ls_criterio=$ls_criterio."   AND sno_hpersonalnomina.prouniadm='".substr($ls_coduniadm,14,2)."' ";
		}
		if(!empty($as_codubifis))
		{
		...
		if($this->li_rac=="1") // Utiliza RAC
		{
			$ls_descar="       (SELECT distinct(denasicar) FROM sno_hasignacioncargo ".
					   ...
					   "		   AND sno_hasignacioncargo.codperi=sno_hpersonalnomina.codperi".
				       "           AND sno_hpersonalnomina.codasicar = sno_hasignacioncargo.codasicar) as descar ";
		}
		else // No utiliza RAC
		{
			$ls_descar="       MAX((SELECT MAX(descar) FROM sno_hcargo ".
					   ...
					   "		   AND sno_hcargo.codperi=sno_hpersonalnomina.codperi".
		...
		if(($li_vac_reportar==1)&&($ls_vac_codconvac!=""))
		{
			$ls_union="UNION ".
					  ...
					  "			 AND sigesp_parroquia.codmun = sno_ubicacionfisica.codmun ".
					  "			 AND sigesp_parroquia.codpar = sno_ubicacionfisica.codpar) AS denpar, ".
					  "		  MAX((SELECT SUM(asires) FROM sno_hresumen ".
					  "			WHERE sno_hresumen.codemp = sno_hsalida.codemp AND sno_hresumen.codnom = sno_hsalida.codnom 
							      AND sno_hresumen.anocur = sno_hsalida.anocur AND sno_hresumen.codperi=sno_hsalida.codperi)) AS totalasignacion, ".
					  "		  MAX((SELECT SUM(dedres + apoempres) FROM sno_hresumen ".
					  "			WHERE sno_hresumen.codemp = sno_hsalida.codemp AND sno_hresumen.codnom = sno_hsalida.codnom 
							      AND sno_hresumen.anocur = sno_hsalida.anocur AND sno_hresumen.codperi=sno_hsalida.codperi)) AS totaldeduccion, ".
					  "		  MAX((SELECT SUM(apopatres) FROM sno_hresumen ".
					  "			WHERE sno_hresumen.codemp = sno_hsalida.codemp AND sno_hresumen.codnom = sno_hsalida.codnom 
							      AND sno_hresumen.anocur = sno_hsalida.anocur AND sno_hresumen.codperi=sno_hsalida.codperi)) AS totalaporte, ".
					  "".$ls_descar.",sno_personal.estper".
					  ...
					  "   AND sno_hpersonalnomina.anocur='".$anoactual."' ".
					  "    AND sno_hpersonalnomina.codperi>='".$ls_codperides."' AND sno_hpersonalnomina.codperi<='".$ls_codperihas."'".
					  ...
					  sno_personal.fecingper,sno_hpersonalnomina.codcueban,sno_hunidadadmin.desuniadm,sno_hunidadadmin.codprouniadm,
					    sno_hunidadadmin.minorguniadm,sno_hunidadadmin.ofiuniadm,sno_hunidadadmin.uniuniadm,
					    sno_hunidadadmin.depuniadm,sno_hunidadadmin.prouniadm,sno_hsalida.codemp,sno_hsalida.codnom,
					sno_hsalida.anocur,sno_hpersonalnomina.codemp,sno_hpersonalnomina.codnom,sno_hpersonalnomina.anocur,
					   sno_hpersonalnomina.codcar, sno_ubicacionfisica.codpai, sno_ubicacionfisica.codest,sno_ubicacionfisica.codmun,sno_ubicacionfisica.codpar,
					    sno_personal.estper";
		...
		$ls_sql="SELECT distinct(sno_personal.codper), sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.fecingper, ".
				...
				"   ".$ls_union.
				"   ".$ls_orden;
		$ls_sql="SELECT  DISTINCT(codper), cedper, nomper, apeper, fecingper,codcueban, desuniadm, codprouniadm, MAX(sueper) AS sueper, minorguniadm, 
			ofiuniadm, uniuniadm,depuniadm, prouniadm, MAX(codgra) AS codgra, MAX(nacper) AS nacper, MAX(desubifis) AS desubifis, 
			MAX(descasicar) AS descasicar, MAX(obsrecper) AS obsrecper,  desest, 
			denmun,denpar, MAX(totalasignacion) AS totalasignacion, MAX(totaldeduccion) AS totaldeduccion, MAX(totalaporte) AS totalaporte,
			MAX(descar) AS descar,estper FROM (".$ls_sql.") as todo
			group by codper,cedper,nomper, apeper, fecingper,codcueban, desuniadm, codprouniadm,minorguniadm, ofiuniadm, uniuniadm,
			depuniadm, prouniadm, desest,  denmun,denpar,estper";
		$this->rs_data=$this->io_sql->select($ls_sql);
		if($this->rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report M�TODO->uf_pagonomina_personal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_pagonomina_concepto_excel_rango_peri($as_tituloconcepto,$as_sigcon,$ls_codnom,$ls_codperides,$ls_codperihas)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_pagonomina_concepto_excel
		//         Access: public (desde la clase sigesp_sno_rpp_pagonomina)  
		...
		$ls_sql="SELECT distinct(codconc), ".$ls_campo." as nomcon ".
				"  FROM sno_hconcepto ".
				" WHERE codemp='".$this->ls_codemp."' ".
				"   AND codnom='".$ls_codnom."' ".
				"   ".$as_sigcon." ".
				"   AND codconc IN (SELECT codconc FROM sno_hsalida WHERE codemp='".$this->ls_codemp."' AND codnom='".$ls_codnom."' AND codperi>='".$ls_codperides."' AND codperi<='".$ls_codperihas."')".
				" ORDER BY codconc "; 
		$this->rs_data_detalle=$this->io_sql->select($ls_sql);
		if($this->rs_data_detalle===false)
		{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_pagonomina_conceptopersonal_excel_rango_peri($as_codper,$as_tituloconcepto,$as_tipsal,$ls_codnom,$ls_codperides,$ls_codperihas)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_pagonomina_conceptopersonal_excel
		//         Access: public (desde la clase sigesp_sno_rpp_pagonomina)  
		...
		if(($li_vac_reportar==1)&&($ls_vac_codconvac!=""))
		{
			$ls_union="UNION ".
					  ...
					  "   AND sno_hsalida.codperi>='".$ls_codperides."' AND  sno_hsalida.codperi<='".$ls_codperihas."' ".
					  ...
					  "   AND sno_hsalida.codper = sno_hpersonalnomina.codper AND sno_hsalida.codperi = sno_hpersonalnomina.codperi".
		...
		$ls_sql="SELECT sno_hconcepto.codconc, MAX(".$ls_campo.") as nomcon, SUM(sno_hsalida.valsal) as valsal, MAX(sno_hsalida.tipsal) AS tipsal ".
				...
				"   AND sno_hsalida.codemp = sno_hconcepto.codemp ".
				"   AND sno_hsalida.codnom = sno_hconcepto.codnom ".
				"   AND sno_hsalida.codconc = sno_hconcepto.codconc AND sno_hsalida.codperi = sno_hconcepto.codperi".
				" GROUP BY sno_hconcepto.codconc ".
				"   ".$ls_union.
				" ORDER BY codconc, tipsal ";
		$this->rs_data_detalle=$this->io_sql->select($ls_sql);
									...
									$as_codubifis,$as_codpai,$as_codest,$as_codmun,$as_codpar,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.nacper,".
				...
				"			WHERE sno_personalnomina.codnom = sno_nomina.codnom ".
				"			 AND sno_personalnomina.codemp = sno_nomina.codemp) AS racnom, ".
				...
				"		".$ls_codcar.$ls_descar.",sno_personalnomina.codgra ,sno_personalnomina.codpas".
				...
				"         sno_personalnomina.fecingper,sno_personal.codorg,sueobr,tiponom,sno_personalnomina.obsrecper,sno_personalnomina.codgra ,sno_personalnomina.codpas ".
				"   ".$ls_orden;
		$this->rs_data=$this->io_sql->select($ls_sql);
		if($this->rs_data===false)
		{
