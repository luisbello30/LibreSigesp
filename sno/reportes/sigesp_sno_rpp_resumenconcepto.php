<?php
	...
	function uf_print_piecabecera($ai_totasi,$ai_totded,$ai_totapo,$ai_totgeneral,&$io_pdf)
	{
		...
		$la_data=array(array('name1'=>'<b>ELABORADO POR:</b>','name2'=>'<b>VERIFICADO POR:</b>','name3'=>'<b>APROBADO POR:</b>','name4'=>'<b>AUTORIZADO POR:</b>'));
		$la_data1=array(array('name1'=>'<b>Firma/Fecha/Sello</b>','name2'=>'<b>Firma/Sello/Fecha</b>','name3'=>'<b>Firma/Sello/Fecha</b>','name4'=>'<b>Firma/Sello/Fecha</b>'));
		$la_data2=array(array('name1'=>'','name2'=>'','name3'=>'','name4'=>''));
		$la_columna=array('name1'=>'','name2'=>'','name3'=>'','name4'=>'');
		$la_columna1=array('name1'=>'','name2'=>'','name3'=>'','name4'=>'');
		$la_columna2=array('name1'=>'','name2'=>'','name3'=>'','name4'=>'');
		
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize'=> 7, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>2, // Sombra entre líneas
						 'shadeCol'=>array((255/255),(255/255),(255/255)), // Color de la sombra
						 'shadeCol2'=>array((255/255),(255/255),(255/255)), // Color de la sombra
						 'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'width'=>500, // Ancho de la tabla
						 'maxWidth'=>500, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('name1'=>array('justification'=>'center','width'=>125), // Justificación y ancho de la columna
								'name2'=>array('justification'=>'center','width'=>125),
								 'name3'=>array('justification'=>'center','width'=>125),
								  'name4'=>array('justification'=>'center','width'=>125))); // Justificación y ancho de la columna
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize'=> 40, // Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol'=>array((255/255),(255/255),(255/255)), // Color de la sombra
						 'shadeCol2'=>array((255/255),(255/255),(255/255)), // Color de la sombra
		...
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->ezTable($la_data2,$la_columna2,'',$la_config1);
		$io_pdf->ezTable($la_data1,$la_columna1,'',$la_config);
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
