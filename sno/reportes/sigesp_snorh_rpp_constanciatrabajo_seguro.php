<?php
   ...
   //-----------------------------------------tabla de declaración---------------------------------------------------------------
      ...
      //--------------------------------------tabla titulo del firmante------------------------------------------------------------
		...
		$ls_nomrep=$_SESSION["director"]["4"];
		$ls_cedula=$_SESSION["director"]["2"];
		$ls_cedula=number_format($ls_cedula,0,",",".");		
		if ($ls_nomrep=="")
		{
		  $ls_nomrep="";
		...
		$la_data_frima2[2]=array('firma'=>'<b>'.$ls_nomrep.'</b>');			
      ...
      //--------------------------------------tabla del firante------------------------------------------------------------
	    ...
	    $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'left', // Orientación de la tabla
						 'xPos'=>'405',
						 'cols'=>array('cargo'=>array('justification'=>'center','width'=>155),
						 			   'lugar'=>array('justification'=>'center','width'=>80),
		...
		if ($ls_ciuemp=="")
		{
		 ...
		 $la_data_cont[1]=array('cargo1'=>$ls_cargo,'lugar1'=>$ls_ciuemp);				
		 ...
		 $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'left', // Orientación de la tabla
						 'xPos'=>'289',
						 'cols'=>array('cargo1'=>array('justification'=>'center','width'=>155),
						 			   'lugar1'=>array('justification'=>'center','width'=>80))); // Justificación y ancho de la columna
		...
		// $la_data_dia[3]=array('dia'=>'','mes'=>'','ano'=>'');
		 $la_columna=array('dia'=>'','mes'=>'','ano'=>'');
		 $la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 7, // Tamaño de Letras
						 'titleFontSize' => 7,  // Tamaño de Letras de los títulos
