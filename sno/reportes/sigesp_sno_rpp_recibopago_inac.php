<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera1($as_cedper,$as_nomper,$as_descar,$as_gerencia,&$io_cabecera,$ld_fechaingreso,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->ezSetDy(-11);
		$la_data=array(array('nombre'=>'Apellidos y Nombres:', 'cedula'=>'Cédula:', 'cargo'=>'Cargo:', 'gerencia'=>'Gerencia:' ,'fecha'=>'Fecha Ingreso' ));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','gerencia'=>'', 'fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>200), // Justificación y ancho de la columna
									   ...
									   'gerencia'=>array('justification'=>'left','width'=>90), // Justificación y ancho de la columna
		...
		$la_data=array(array('nombre'=>$as_nomper, 'cedula'=>$as_cedper, 'cargo'=>substr($as_descar,0,100), 'gerencia'=>substr($as_gerencia,0,20),'fecha'=>$ld_fechaingreso));
		$la_columna=array('nombre'=>'','cedula'=>'','cargo'=>'','gerencia'=>'', 'fecha'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'xPos'=>315,
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_cabecera2($as_cedper,$as_nomper,$as_descar,$as_gerencia,&$io_cabecera,$ld_fechaingreso,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_pie_cabecera1($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_suelper,&$io_pdf)
	{
		...
		$ls_codnom=$_SESSION["la_nomina"]["codnom"];
		$ls_sueltot=$as_suelper-$ai_totded;
		$io_pdf->addText(45,443,'7','<b>Codigo Nomina:       </b>'.$ls_codnom);
		$io_pdf->addText(45,433,'7','<b>Sueldo Básico Mensual:       </b>'.$as_suelper);
		$io_pdf->addText(45,423,'7','<b>Sueldo Total Mensual:          </b>'.$ls_sueltot);
		$io_pdf->setStrokeColor(0,0,0,0);
		$io_pdf->line(40,420,180,420);
		$io_pdf->line(40,431,180,431);
		$io_pdf->line(40,442,180,442);
		$io_pdf->line(180,420,180,442);
		$io_pdf->ezSety(480);
	...
	function uf_print_pie_cabecera2($ai_toting,$ai_totded,$ai_totnet,$as_codcueban,$as_suelper,&$io_pdf)
	{
		...
		$ls_codnom=$_SESSION["la_nomina"]["codnom"];
		$ls_sueltot=$as_suelper-$ai_totded;
		$io_pdf->addText(45,43,'7','<b>Codigo Nomina:       </b>'.$ls_codnom);
		$io_pdf->addText(45,33,'7','<b>Sueldo Básico Mensual:     </b>'.$as_suelper);
		$io_pdf->addText(45,23,'7','<b>Sueldo Total Mensual:        </b>'.$ls_sueltot);
		$io_pdf->setStrokeColor(0,0,0,0);
		$io_pdf->line(40,42,180,42);
		$io_pdf->line(40,32,180,32);
		$io_pdf->line(40,22,180,22);
		$io_pdf->line(180,22,180,42);
		$io_pdf->ezSety(80);
		$la_data=array(array('denomasig'=>'<b>Total Ingresos '.$ls_bolivares.'</b>', 'valorasig'=>$ai_toting, 'denomdedu'=>'<b>Total Deducciones '.$ls_bolivares.'</b>','valordedu'=>$ai_totded));
		$la_columna=array('denomasig'=>'<b>DENOMINACIÓN</b>',
						  'valorasig'=>'<b>ASIGNACIÓN</b>',
	...
	else // Imprimimos el reporte
	{
		...
		while((!$io_report->rs_data->EOF)&&($lb_valido))
		{
			...
			if($li_reg==1)
			{
				uf_print_cabecera1($ls_cedper,$ls_nomper,$ls_descar,$ls_gerencia,$io_cabecera,$ld_fechaingreso,$io_pdf); // Imprimimos la cabecera del registro
			}
			else
			{
				uf_print_cabecera2($ls_cedper,$ls_nomper,$ls_descar,$ls_gerencia,$io_cabecera,$ld_fechaingreso,$io_pdf); // Imprimimos la cabecera del registro
			}
