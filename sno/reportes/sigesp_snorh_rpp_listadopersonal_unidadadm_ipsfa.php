<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,&$io_pdf)
	{
		...
		$tm=470-($li_tm/2);
		$io_pdf->addText($tm,520,12,$as_titulo2); // Agregar el título
	...
	function uf_print_cabecera(&$io_pdf)
	{
        ...
        $io_pdf->filledRectangle(60,495,880,$io_pdf->getFontHeight(12));
	...
	else // Imprimimos el reporte
	{
		...
		while (!$io_report->rs_data->EOF)
		{
			...
			$ls_despai=$io_report->rs_data->fields["despaiper"];
			$ls_desest=$io_report->rs_data->fields["desestper"];
			$ls_denmun=$io_report->rs_data->fields["denmunper"];
			$ls_denpar=$io_report->rs_data->fields["denparper"];
			$ld_codcom=$io_report->rs_data->fields["codcomponente"];
			$ld_codran=$io_report->rs_data->fields["codrango"];
			$ld_descom=$io_report->rs_data->fields["descomponente"];
			$ld_desran=$io_report->rs_data->fields["desrango"];
