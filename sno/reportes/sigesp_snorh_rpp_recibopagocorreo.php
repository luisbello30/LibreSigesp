<?php
	...
	require_once("../../shared/class_folder/PHPMailer/class.phpmailer.php"); 	
			    ...
			    if($periodos_cargos==TRUE)
			    {
			      ...
			      $ls_quincena=3;
					 ...
					 if($lb_valido)
					  ...
					  $io_mail->SMTPSecure = "ssl";
					  //$io_mail->Host = "smtp.gmail.com";
					  //$io_mail->Port = 465;
					  ...
					  if ($ls_coreleper!="")
					  {
						  ...
						  if (($lb_valido)&&($ls_serv!="")&&($ls_port!="")&&($ls_remitente!=""))
						  {
							  ...
							  $io_mail->Username = $ls_remitente;
							  $io_mail->Password = $ls_remitente;
							  ...
							  $io_mail->AltBody = $body;
							  $io_mail->MsgHTML($body);
							  $io_mail->IsHTML(true);
							  $io_mail->AddAttachment($ls_ruta.'/Recibo_Pago_'.$ls_codper.'.pdf', 'Recibo_Pago_'.$ls_codper.'.pdf');
							  
							  if(!$io_mail->Send())
							  { 	echo "<script>alert('".utf8_encode($io_mail->ErrorInfo)."');</script>";
								  print("<script language=JavaScript>");
							  ...
							  {
								  print("<script language=JavaScript>");
								  print(" alert('Recibo de Pago Enviado a ".$ls_nomper.":::Periodo:::".$cod_peri."');");
								  print("</script>");			
							  }
							  unset($io_mail);
						  }
