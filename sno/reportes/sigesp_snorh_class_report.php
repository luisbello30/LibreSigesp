...
class sigesp_snorh_class_report
{
	...
	function uf_constanciatrabajo_personal($as_codnom,$ai_rac,$as_codperdes,$as_codperhas)
	{
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.fecingper, ".
				...
				"       sno_personal.fecjubper,sno_personalnomina.salnorper".
				//	", srh_gerencia.denger ".//comentado debido a que la tabla sno_personalesta vacia
				"  FROM sno_personal, sno_personalnomina, sno_unidadadmin, sno_dedicacion, sno_tipopersonal, sno_nomina ".
				//"       , srh_gerencia ".//comentado debido a que la tabla sno_personalesta vacia
				" WHERE sno_personal.codemp = '".$this->ls_codemp."' ".
				"   AND sno_personalnomina.codnom = '".$as_codnom."' ".
				$ls_criterio.
				"   AND sno_personal.codemp = sno_personalnomina.codemp ".
				...
				"   AND sno_personalnomina.codded = sno_tipopersonal.codded ".
				"   AND sno_personalnomina.codtipper = sno_tipopersonal.codtipper ".
				//"   AND sno_personal.codemp = srh_gerencia.codemp ".//comentado debido a que la tabla sno_personalesta vacia
				//"   AND sno_personal.codger = srh_gerencia.codger ".//comentado debido a que la tabla sno_personalesta vacia
        ...
        { 
           ...
           {     
                ...
                $ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.fecingper, ". 
                        ...
                        "       sno_nomina.tipnom, sno_personal.fecjubper".
			//" , srh_gerencia.denger  ". //comentado debido a que la tabla sno_personalesta vacia
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_retencionislr_personal($as_codnomdes,$as_codnomhas,$as_ano,$as_mes,$as_conceptocero,$as_orden, $as_porcentajecero)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if(!empty($as_porcentajecero))
		{
			$ls_porcentajecero= $ls_porcentajecero."  AND sno_personalisr.porisr<>0 ";
		}
		switch($as_orden)
		{
			case "1": // Ordena por c�digo de personal
		...
		$ls_sql="SELECT sno_personal.rifper,sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personalisr.porisr, ".
		        ...
		        "   AND sno_hpersonalnomina.codnom = sno_hperiodo.codnom ".
		        "   AND sno_hpersonalnomina.anocur = sno_hperiodo.anocur ".
		        "   AND sno_hpersonalnomina.codperi = sno_hperiodo.codperi". $ls_porcentajecero.
				$ls_orden;//echo $ls_sql, die();
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
	...
	function uf_retencionarc_personal($aa_nominas,$ai_total,$as_ano,$as_orden,$as_codperdes,$as_codperhas)
	{
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.nacper, sno_personal.rifper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_hpersonalnomina.codubifis, sno_ubicacionfisica.desubifis ".
				"  FROM sno_personal, sno_personalisr, sno_hpersonalnomina, sno_hperiodo, sno_ubicacionfisica ".
				" WHERE sno_personal.codemp = '".$this->ls_codemp."' ".
				"   AND sno_hperiodo.anocur = '".$as_ano."' ".
		        "   AND SUBSTR(cast(sno_hperiodo.fecdesper as char(10)),1,4) = '".$as_ano."' ".
				"   ".$ls_criterio." ".
		        ...
		        " GROUP BY sno_personal.codper, sno_personal.nacper,sno_personal.rifper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_hpersonalnomina.codubifis, sno_ubicacionfisica.desubifis ".
				$ls_orden;//echo $ls_sql;die();
		$this->rs_data=$this->io_sql->select($ls_sql);
		if($this->rs_data===false)
		{
	...
	function uf_retencionarc_meses($as_codper,$aa_nominas,$ai_total,$as_ano)
	{
		...
		$ls_sql="SELECT sno_personalisr.codper, sno_personalisr.codisr, sno_personalisr.porisr, sno_hsalida.anocur, ".
				...
				"   ORDER BY sno_personalisr.codisr ";//echo $ls_sql;die();
		$this->rs_detalle=$this->io_sql->select($ls_sql);
		if($this->rs_detalle===false)
		{
	...
	function uf_listadogenerico()
	{
		...
		{
			$ls_sql="SELECT DISTINCT sno_personal.codper, ".$_SESSION["ls_campo"].",sno_unidadadmin.desuniadm,srh_gerencia.denger ".
					"  FROM sno_personal ".
					...
					" GROUP BY sno_personal.codper,sno_unidadadmin.desuniadm,srh_gerencia.denger ORDER BY $ls_orden ";
		}
		else
		{
			$ls_sql="SELECT DISTINCT sno_personal.codper, ".$_SESSION["ls_campo"]." ".
					...
					" WHERE sno_personal.codemp = '".$this->ls_codemp."'".
					"   ".$_SESSION["ls_criterio"].
					" GROUP BY sno_personal.codper ORDER BY $ls_orden ";
		}
              // echo $ls_sql; die();
		$this->rs_data=$this->io_sql->select($ls_sql);
		if($this->rs_data===false)
			...
			$as_coduniadm,$as_conceptocero,$as_conceptop2,$as_conceptoreporte,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		{
			case "1": // Ordena por C�digo de personal
				$ls_orden="ORDER BY sno_personal.codper,codcar ";
				break;
		...
		$ls_sql="  SELECT DISTINCT sno_personal.codper,
					    ...
					    sno_hnomina.codnom,
					    sno_hclasificacionobrero.suemin AS sueobr,
					    MAX(sno_hasignacioncargo.denasicar) as denasicar,
					    MAX(sno_hcargo.descar) as descar,
					    MAX(sno_hcargo.codcar) as codcar,sno_hpersonalnomina.codgra ,sno_hpersonalnomina.codpas ".
				"  FROM sno_personal, sno_hpersonalnomina, sno_hsalida, sno_hnomina, sno_hperiodo, sno_hclasificacionobrero, 
					sno_hasignacioncargo,sno_hcargo".
			...
			//	"   AND sno_hpersonalnomina.prouniadm = sno_hunidadadmin.prouniadm ".
				...
				AND sno_hclasificacionobrero.grado = sno_hpersonalnomina.grado AND sno_hclasificacionobrero.codemp = sno_hpersonalnomina.codemp 
				AND sno_hclasificacionobrero.codperi = sno_hpersonalnomina.codperi AND sno_hclasificacionobrero.anocur = sno_hpersonalnomina.anocur

				AND sno_hpersonalnomina.codemp = sno_hasignacioncargo.codemp AND sno_hpersonalnomina.codnom = sno_hasignacioncargo.codnom 
				AND sno_hpersonalnomina.anocur = sno_hasignacioncargo.anocur AND sno_hpersonalnomina.codasicar = sno_hasignacioncargo.codasicar

				AND sno_hpersonalnomina.codemp = sno_hcargo.codemp AND sno_hpersonalnomina.codnom = sno_hcargo.codnom AND sno_hpersonalnomina.anocur = sno_hcargo.anocur 
				AND sno_hpersonalnomina.codcar = sno_hcargo.codcar AND sno_hpersonalnomina.codperi = sno_hcargo.codperi".
				...
				"          sno_hpersonalnomina.codasicar, sno_hpersonalnomina.anocur,sno_hpersonalnomina.codban, 
				    sno_hnomina.codnom,sno_personal.codorg,sno_hnomina.tipnom, sno_hclasificacionobrero.suemin,
				    sno_hasignacioncargo.denasicar,sno_hcargo.descar,sno_hcargo.codcar,sno_hpersonalnomina.codgra ,sno_hpersonalnomina.codpas,sno_hnomina.racnom".
				"   ".$ls_orden;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_fecha_periodos($perides,$perihas,$codnom)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_fecha_periodos
		//         Access: public (desde la clase sigesp_sno_r_recibopago)  
		//	    Arguments: as_codnom // C�digo del n�mina donde se va a filtrar
		//	    		   ad_fecdesper // Fecha del periodo donde se empieza a filtrar
		//	  			   ad_fechasper // Fecha del periodo donde se termina de filtrar		  
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="SELECT fecdesper ,fechasper,codperi from sno_periodo".
				" WHERE sno_periodo.codemp='".$this->ls_codemp."' AND sno_periodo.codperi>='".$perides."' AND sno_periodo.codperi<='".$perihas."'
				AND sno_periodo.codnom='".$codnom."' ORDER BY codperi";
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report M�TODO->uf_fecha_periodos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
			{
				$this->DS->data_fec=$this->io_sql->obtener_datos($rs_data);		
			}
			else
			{
				$lb_valido=false;
		...
		return $lb_valido;
	}// end function uf_fecha_periodos
	//-----------------------------------------------------------------------------------------------------------------------------------



	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_periodo_cargo($peri,$codnom, $codper, $codcar)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function:uf_periodo_cargo
		//         Access: public (desde la clase sigesp_sno_r_recibopago)  
		//	    Arguments: as_codnom // C�digo del n�mina donde se va a filtrar
		//	    		   ad_fecdesper // Fecha del periodo donde se empieza a filtrar
		//	  			   ad_fechasper // Fecha del periodo donde se termina de filtrar		  
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		  $ls_sql="select sno_hcargo.codcar from sno_hcargo, sno_hpersonalnomina where sno_hpersonalnomina.codperi='".$peri."'
		      and sno_hpersonalnomina.codcar=sno_hcargo.codcar and sno_hpersonalnomina.codnom='".$codnom."' 
		      and sno_hpersonalnomina.codemp='".$this->ls_codemp."' and sno_hpersonalnomina.codper='".$codper."' 
		      and sno_hcargo.codcar='".$codcar."' and  sno_hpersonalnomina.codnom=sno_hcargo.codnom and  
		      sno_hpersonalnomina.codperi=sno_hcargo.codperi";
				  
		$rs_data=$this->io_sql->select($ls_sql);
             
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report M�TODO->uf_periodo_cargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
			{
				$this->DS->data_cargo=$this->io_sql->obtener_datos($rs_data);		
			}
			else
			{
				$lb_valido=false;
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 	...
	 	$ls_sql="SELECT sno_hpersonalnomina.codper, substr(cast(sno_hperiodo.fechasper as char(10)),1,4) AS anocur, substr(cast(sno_hperiodo.fechasper as char(10)),6,2) as mes,(30) as dias, ".
			    ...
			    "   AND sno_hpersonalnomina.codper=sno_personal.codper				".
			    " WHERE sno_hpersonalnomina.codemp='".$this->ls_codemp."'".
                "   AND sno_hpersonalnomina.codper='".$as_codper."' and sno_hpersonalnomina.sueintper >'0'".
   ...
   function uf_beneficiario_personal($as_codperdes, $as_codperhas, $as_cedbenedes, $as_cedbenehas, $as_orden,&$rs_data)
    ...
    function uf_instructivo_07_cargos_programado()
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report M�TODO->uf_instructivo_07_entes_sin_fin_lucro ERROR->"
	...
	function uf_instructivo_07_cargos_real($as_rango,$as_codded,$as_codtipper,&$ai_cargoreal,&$ai_cargorealf,&$ai_cargorealm,&$ai_montoreal)
	{
		...
		$ls_sql="SELECT sno_hpersonalnomina.codper ".
				...
				"   AND sno_hnomina.espnom = 0 ".
				"   AND sno_hnomina.ctnom = 0 ".
				"   AND substr(cast(sno_hperiodo.fecdesper as char(10)),6,2) >= '".$randes."'".
				"   AND substr(cast(sno_hperiodo.fechasper as char(10)),6,2) <= '".$ranhas."'".
				"   AND sno_hnomina.codemp = sno_hperiodo.codemp ".
				"   AND sno_hnomina.codnom = sno_hperiodo.codnom ".
				"	AND sno_hnomina.anocurnom = sno_hperiodo.anocur ".
				"   AND sno_hnomina.peractnom = sno_hperiodo.codperi ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report M�TODO->uf_instructivo_07_cargos_real ERROR->".
										$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		...
		if($rs_data2===false)
		{
			$this->io_mensajes->message("CLASE->Report M�TODO->uf_instructivo_07_cargos_real_real ERROR->".
										$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		...
		function uf_instructivo_07_monto_acumulado($as_rango,$as_codded,$as_codtipper,&$ai_monto_acumulado)
	{
		...
		if($lb_valido)
		{
			...
			if($rs_data===false)
			{
				$this->io_mensajes->message("CLASE->Report M�TODO->uf_instructivo_07_monto_acumulado ERROR->".
				                            $this->io_funciones->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			}
			else
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									 ...
									 $as_conceptocero,$as_subnomdes,$as_subnomhas,$as_orden)
	{
		...
		$ls_sql="SELECT sno_personal.codper,sno_personal.cedper, sno_personal.apeper, sno_personal.nomper, sno_hsalida.tipsal, ".
				...
				"       sno_hpersonalnomina.uniuniadm, sno_hpersonalnomina.depuniadm, sno_hpersonalnomina.prouniadm, sno_hunidadadmin.desuniadm,".
				//"srh_gerencia.denger,".//comentado debido a que la tabla sno_personalesta vacia
				"sno_personal.fecnacper,sno_personal.nacper, ".
				"       (SELECT srh_departamento.dendep FROM srh_departamento                 ".
				"         WHERE srh_departamento.codemp=sno_hpersonalnomina.codemp             ".
				"           AND srh_departamento.coddep=sno_hpersonalnomina.coddep) AS dendep, ".
				"       (SELECT dentippersss FROM sno_tipopersonalsss WHERE codemp=sno_personal.codemp AND codtippersss=sno_personal.codtippersss) AS tipopersonal ".
				...
				"   AND sno_hpersonalnomina.depuniadm = sno_hunidadadmin.depuniadm ".
				"   AND sno_hpersonalnomina.prouniadm = sno_hunidadadmin.prouniadm ".
				//"   AND sno_personal.codemp= srh_gerencia.codemp ".//esta tabla se encuentra vacia
				//"   AND sno_personal.codger= srh_gerencia.codger ".//esta tabla se encuentra vacia
				"   GROUP BY sno_personal.codper,sno_personal.cedper, sno_personal.apeper, sno_personal.nomper, ".
				...
				"            sno_hpersonalnomina.coddep,sno_personal.codemp,sno_personal.codtippersss, sno_personal.fecnacper,sno_personal.nacper ".$ls_orden;
		      //",srh_gerencia.denger";	//comentado debido a que la tabla sno_personalesta vacia
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
	...
	function uf_listadopersonal_rac($as_codnomdes,$as_codnomhas,$as_codperdes,$as_codperhas,$as_anio,$as_mes,$as_orden)
	{
		...
		$ls_sql="SELECT sno_hunidadadmin.minorguniadm, sno_hunidadadmin.ofiuniadm, sno_hunidadadmin.uniuniadm, sno_hunidadadmin.depuniadm, sno_hunidadadmin.prouniadm,".
				...
				"       (CASE sno_hcodigounicorac.estcodunirac ".
				"        WHEN '1' THEN  sno_personal.apeper||' '||sno_personal.nomper".
