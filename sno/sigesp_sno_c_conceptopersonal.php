...
*/
				$ao_object[$ai_totrows][1]="<input name=txtcodper2".$ai_totrows." type=text id=txcodper2".$ai_totrows." value=".$ls_codper." class=sin-borde size=10  readonly>";
				$ao_object[$ai_totrows][2]="<input name=txtcodper".$ai_totrows." type=hidden id=txcodper".$ai_totrows." value=".$ls_codper."><input name=txtnomper".$ai_totrows." type=text id=txtnomper".$ai_totrows." value='".$ls_nomper."' class=sin-borde size=50  readonly>";
				$ao_object[$ai_totrows][3]="<input name=chkaplcon".$ai_totrows." type=checkbox id=chkaplcon".$ai_totrows." value='1' ".$ls_aplica.">";
				$ao_object[$ai_totrows][4]="<input name=txtacuemp".$ai_totrows." type=text id=txtacuemp".$ai_totrows." class=sin-borde size=15 maxlength=20 value=".$li_acuemp." onKeyPress=return(ue_formatonumero(this,'.',',',event)) style=text-align:right>";
				$ao_object[$ai_totrows][5]="<input name=txtacuiniemp".$ai_totrows." type=text id=txtacuiniemp".$ai_totrows." class=sin-borde size=15 maxlength=20 value=".$li_acuiniemp." onKeyPress=return(ue_formatonumero(this,'.',',',event)) style=text-align:right>";
				$ao_object[$ai_totrows][6]="<input name=txtacupat".$ai_totrows." type=text id=txtacupat".$ai_totrows." class=sin-borde size=15 maxlength=20 value=".$li_acupat." onKeyPress=return(ue_formatonumero(this,'.',',',event)) style=text-align:right>";
				$ao_object[$ai_totrows][7]="<input name=txtacuinipat".$ai_totrows." type=text id=txtacuinipat".$ai_totrows." class=sin-borde size=15 maxlength=20 value=".$li_acuinipat." onKeyPress=return(ue_formatonumero(this,'.',',',event)) style=text-align:right>";
