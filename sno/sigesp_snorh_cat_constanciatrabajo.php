<?php
   ...
   function uf_print($as_codcont, $as_descont, $as_tipo)
   {
		...
		//	     Function: uf_print
		//		   Access: public
		//	    Arguments: as_codcont  // C�digo de Constancia
		...
		print "<td width=440>Descripci&oacute;n</td>";
		print "</tr>";
...
function aceptar(codigo,descripcion,letra,interlineado,marinfcont,marsupcont,titcont,tamletpiecont,arcrtfcont)
{
    ...
    //opener.document.getElementById('txtconcont').style.display='block';
   // opener.document.getElementById('txtconcont').style.visibility='visible';
	...
	opener.document.form1.existe.value="TRUE";
        opener.document.form1.activ.click();
        opener.document.form1.activPie.click();
	close();
}
