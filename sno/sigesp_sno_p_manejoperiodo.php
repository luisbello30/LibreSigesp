	...
	if (li_ejecutar==1)
   	{
		if(f.validacontabilizacion.value=="1")
		{
			...
			{
				alert("El per�do anterior no est� contabilizado. Debe contabilizar el per�odo anterior y luego cerrar este per�odo.");
				valido=false;
			}
		}
		if((li_totalnomina==0)&&(valido))
		{
			if(confirm("�Esta seguro de cerrar la N�mina con calculo Cero (0)?"))
			{
				valido=true;
			}
			else
