...
class sigesp_sno_c_metodo_banco_1
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_bicentenario($as_ruta,$rs_data,$ad_fecproc,$as_codcueban,$adec_montot)
	{ 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_count>0)
		{
			...
			else
			{
				...
				$as_codcueban=$this->io_funciones->uf_trim(str_replace("-","",$as_codcueban));
				 ...
				 $cant_registros=str_pad($li_count,4,0,STR_PAD_LEFT);
				if($lb_valido)
				{		
			...
			while((!$rs_data->EOF)&&($lb_valido))
			{
				...
				$ls_cadena="4061".$ldec_neto.$ls_codcueban.$ls_cedper."00000000"."\r\n";
				if ($ls_creararchivo)
				{
					if (@fwrite($ls_creararchivo,$ls_cadena)===false)//Escritura
					{
