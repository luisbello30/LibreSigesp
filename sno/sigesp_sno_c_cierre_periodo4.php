...
class sigesp_sno_c_cierre_periodo4
{
	...
	{	
		...
		// Modificado Por: Ing. Yesenia Moreno						Fecha ï¿½ltima Modificaciï¿½n : 29/05/2006
		//////////////////////////////////////////////////////////////////////////////
	...
	function uf_reversar_acumular_conceptos($as_codperi_abrir)
	{
		...
		//	  Description: Funciï¿½n que se encarga reversar el acumulado de los conceptos al momento de abrir un periodo
	    //     Creado por: Ing. Yozelin Barragï¿½n
	    // Fecha Creaciï¿½n: 10/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha ï¿½ltima Modificaciï¿½n : 29/05/2006
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
		  $lb_valido=false;
		  $this->io_mensajes->message("CLASE->Cierre Periodo Mï¿½TODO->uf_reversar_acumular_conceptos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			while(!$rs_data->EOF)
	...
	function uf_reversar_actualizar_periodo($as_codperi_abrir)
	{
		...
		//	    Arguments: as_codperi_abrir // codigo del periodo abrir 
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se enacarga de reversar el perido, ya cerrado para proceder abrir otro
	    //     Creado por: Ing. Yozelin Barragï¿½n
	    // Fecha Creaciï¿½n: 11/02/2006          Fecha ï¿½ltima Modificacion : 
		// Modificado Por: Ing. Yesenia Moreno						Fecha ï¿½ltima Modificaciï¿½n : 29/05/2006
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo4 Mï¿½TODO->uf_reversar_actualizar_periodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_procesar_contabilizacion()
	{
		...
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n del perï¿½odo
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 31/05/2006
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		$ls_descripcion=$ls_desnom."- Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripciï¿½n de Conceptos
		$ls_descripcioning=$ls_desnom." INGRESOS - Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripciï¿½n de Conceptos
		$ls_descripcionapo=$ls_desnom." APORTES - Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripciï¿½n de Aportes
		
		$ls_descripcion_int=$ls_desnom."- Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento Intercompaï¿½ia"; // Descripciï¿½n de Conceptos Asiento intercomapï¿½ias
		
		$ls_descripcionapo_int=$ls_desnom." APORTES - Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento Intercompaï¿½ia"; // Descripciï¿½n de Aportes Asientos intercompaï¿½ias
		...
		$li_tipdocapo="";
               ...
               // echo "Beneficiario: ".$ls_codben;
		// Obtenemos la configuraciï¿½n de la contabilizaciï¿½n de la nï¿½mina
		...
		if($lb_valido)
		{	// eliminamos la contabilizaciï¿½n anterior 
			$lb_valido=$this->uf_delete_contabilizacion($ls_codperi);
		}														
		if($lb_valido)
		{ // insertamos la contabilizaciï¿½n de presupuesto de conceptos
		...
		if($lb_valido)
		{// insertamos la contabilizaciï¿½n de contabilidad de conceptos
			if($ls_operacionnomina!="O")// Si es compromete no genero detalles contables
			{
				...
				{
					//para contabilizar cuentas contables de intercompaï¿½ias
		...
		if($lb_valido)
		{ // insertamos la contabilizaciï¿½n de presupuesto de aportes
		...
		if($lb_valido)
		{// insertamos la contabilizaciï¿½n de contabilidad de aportes
		...
		if($lb_valido)
		{ // insertamos la contabilizaciï¿½n de ingresos
		...
		if($lb_valido)
		{
			$lb_valido=$this->uf_verificar_contabilizacion($ls_codcom); // Nï¿½mina
		}
		if($lb_valido)
		{
	...
	function uf_validar_cuentas($as_codnom,$as_codperi)
	{
		...
		//		   Access: private
		//		 Argument: as_numsol // Nï¿½mero de solicitud
		//				   as_estsol  // Estatus de la solicitud
		//	  Description: Funciï¿½n que busca que las cuentas presupuestarias estï¿½n en la programï¿½tica seleccionada
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre_Periodo_4 Mï¿½TODO->uf_validar_cuentas ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_valido=true;
		}
		else
		{
												   ...
												   &$ai_gennotdeb,&$ai_genvou,&$ai_genrecdoc,&$ai_genrecapo,&$ai_tipdocnom,&$ai_tipdocapo)
	{
		...
		//	    Arguments: as_cuentapasivo  //  cuenta pasivo a la que va la nï¿½mina
		//	    		   as_modo  //  modo de contabilizaciï¿½n de la nï¿½mina
		//	    		   as_modoaporte  //  modo de contabilizaciï¿½n de los aportes
		//	    		   as_destino  //  destino de la contabilizaciï¿½n
		//	    		   as_codpro  //  cï¿½digo de proveedor
		//	    		   as_codben  // cï¿½digo de beneficiario
		//	    		   ai_gennotdeb  // generar nota de dï¿½bito
		//	    		   ai_genvou  // generar voucher
		//	    		   ai_genrecdoc  // generar recepciï¿½n de documento
		//	    		   ai_genrecapo  // generar recepciï¿½n de documento de aporte
		//	    		   ai_tipdocnom  // Tipo de documento de nï¿½mina
		//	    		   ai_tipdocapo  // Tipo de documento de aporte
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que busca los datos de la configuraciï¿½n de la contabilizaciï¿½n de la nï¿½mina
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 31/05/2006
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		{
			case 0: // La contabilizaciï¿½n es global
				...
				switch (substr($as_destino,0,1))
				{
					...
					case "B":
						...
						$as_codpro="----------";
						$as_destino="B";
                                              //  echo "beneficiario ".$as_codben."<hr>";
					break;
			...
			case 1: // La contabilizaciï¿½n es por nï¿½mina
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("ERROR-> La nï¿½mina debe tener una Destino de Contabilizaciï¿½n (Proveedor ï¿½ Beneficiario).");
		}
		else
		{
		...
		if($ai_genrecdoc=="1") // Genera recepciï¿½n de Documento de la Nï¿½mina.
		{
			if(trim($ai_tipdocnom)=="")
			{
				$lb_valido=false;
				$this->io_mensajes->message("ERROR-> Debe Seleccionar un Tipo de Documento,Para la Recepciï¿½n de Documento de la Nï¿½mina. ");
			}
		}
		if($ai_genrecapo=="1") // Genera recepciï¿½n de Documento de los aportes
		{
			if(trim($ai_tipdocapo)=="")
			{
				$lb_valido=false;
				$this->io_mensajes->message("ERROR-> Debe Seleccionar un Tipo de Documento,Para la Recepciï¿½n de Documento de los Aportes. ");
			}
		}
		return  $lb_valido;    
	...
	function uf_delete_contabilizacion($as_peractnom)
	{
		...
		//	  Description: Funcion que elimina la contabilizaciï¿½n de los conceptos en spg
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 31/05/2006
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_delete_conceptos_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		if($lb_valido)
		{
			$ls_sql="DELETE ".
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_delete_conceptos_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}		
		}
		if($lb_valido)
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_delete_conceptos_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			}		
		}
		if($lb_valido)
		{
										   ...
										   $ai_gennotdeb,$ai_genvou,$as_codcomapo)
	{
		...
		//		   Access: private
		//	    Arguments: as_codcom  //  Cï¿½digo de Comprobante
		//	    		   as_operacionnomina  //  Operaciï¿½n de la contabilizaciï¿½n
		//	    		   as_codpro  //  codigo del proveedor
		//	    		   as_codben  //  codigo del beneficiario
		//	    		   as_tipodestino  //  Tipo de destino de contabiliaciï¿½n
		//	    		   as_descripcion  //  descripciï¿½n del comprobante
		//	    		   as_programatica  //  Programï¿½tica
		//	    		   as_cueprecon  //  cuenta presupuestaria
		//	    		   ai_monto  //  monto total
		//	    		   as_tipnom  //  Tipo de contabilizacion si es de nï¿½mina ï¿½ de aporte
		//			       as_codconc // cï¿½digo del concepto
		//	    		   ai_genrecdoc  //  Generar recepciï¿½n de documento
		//	    		   ai_tipdoc  //  Generar Tipo de documento
		//	    		   ai_gennotdeb  //  generar nota de dï¿½bito
		//	    		   ai_genvou  //  generar nï¿½mero de voucher
		//	    		   as_codcomapo  //  Cï¿½digo del comprobante de aporte
		...
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaciï¿½n: 01/06/2006 								Fecha ï¿½ltima Modificaciï¿½n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_insert_contabilizacion_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
									 	   ...
									 	   $ai_monto,$as_tipnom,$as_codconc,$ai_genrecdoc,$ai_tipdoc,$ai_gennotdeb,$ai_genvou,$as_codcomapo)
	{
		...
		//	    		   as_cueprecon  //  cuenta presupuestaria
		//	    		   ai_monto  //  monto total
		//	    		   as_tipnom  //  Tipo de contabilizaciï¿½n es aporte ï¿½ de conceptos
		//	    		   ai_genrecdoc  //  Generar recepciï¿½n de documento
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_insert_contabilizacion_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
										   ...
										   $as_codestpro4,$as_codestpro5,$as_estcla)
	{
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_insert_contabilizacion_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
										   ...
										   $ai_genrecdoc,$ai_tipdocnom,$ai_gennotdeb,$ai_genvou)
	{
		...
		//	    		   ai_genvou  //  generar nï¿½mero de voucher
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 31/05/2006
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="N"; // tipo de contabilizaciï¿½n
		...
		// entonces las buscamos segï¿½n la estructura de la unidad administrativa a la que pertenece el personal
		$ls_sql=$ls_sql." UNION ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_conceptos_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
										   ...
										   $as_cuentapasivo,$ai_genrecdoc,$ai_tipdocnom,$ai_gennotdeb,$ai_genvou)
	{
		...
		// integran directamente con presupuesto, estas van por el debe de contabilidad
			    ...
			    $ls_sql= " SELECT cuenta, operacion, total               ".
						 ...
						 "	 AND codnom='".$this->ls_codnom."'           ".
						 "	 AND codperi='".$this->ls_peractnom."'       "; 
		if($as_operacionnomina=="OC") // Si el modo de contabilizar la nï¿½mina es Compromete y Causa tomamos la cuenta pasivo de la nï¿½mina.
		{
			if($ai_genrecdoc=="0") // No se genera Recepciï¿½n de Documentos
			{
			...
			else // Se genera Recepciï¿½n de documentos
			{
				$ls_sql=$ls_sql." UNION ".
						"SELECT scg_cuentas.sc_cuenta as cuenta, CAST('H' AS char(1)) as operacion, -sum(sno_salida.valsal) as total ".
						"  FROM sno_personalnomina, sno_salida, scg_cuentas, sno_nomina, rpc_proveedor ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_conceptos_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
										 ...
										 $as_cuentapasivo,$ai_genrecapo,$ai_tipdocapo,$ai_gennotdeb,$ai_genvou)
	{
		...
		//	    Arguments: as_codcom  //  Cï¿½digo de Comprobante
		//	    		   as_operacionaporte  //  Operaciï¿½n de la contabilizaciï¿½n
		//	    		   as_codpro  //  codigo del proveedor
		//	    		   as_codben  //  codigo del beneficiario
		//	    		   as_tipodestino  //  Tipo de destino de contabiliaciï¿½n
		//	    		   as_descripcion  //  descripciï¿½n del comprobante
		//	    		   ai_genrecapo  //  Generar recepciï¿½n de documento
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="A"; // tipo de contabilizaciï¿½n
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_aportes_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
										 ...
										 $ai_gennotdeb,$ai_genvou,$as_operacionaporte)
	{
		...
		//	    		   ai_gennotdeb  //  generar nota de dï¿½bito
		//	    		   ai_genvou  //  generar nï¿½mero de voucher
		//	    		   as_operacionaporte  //  Operaciï¿½n con que se va a contabilizar los aportes
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 31/05/2006
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_aportes_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{				
	...
	function uf_contabilizar_ingresos_spi($as_codcom,$as_descripcion)
	{
		...
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 25/03/2008
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		$ls_estpreing=$_SESSION["la_empresa"]["estpreing"];
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="I"; // tipo de contabilizaciï¿½n
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_ingresos_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_contabilizar_ingresos_scg($as_codcom,$as_descripcion)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_ingresos_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_verificar_contabilizacion($as_codcom)
	{
		...
		//	    Arguments: as_codcom  //  Cï¿½digo de Comprobante
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de verificar que lo mismo que esta por el debe tambien este por el haber en contabilidad
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 29/06/2006
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		$this->io_sql=new class_sql($this->io_conexion);
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_verificar_contabilizacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			...
			if($li_debe!=$li_haber)
			{
				...
				$this->io_mensajes->message("Los Monto en la Contabilizaciï¿½n de ".$ls_texto." no cuadran. Debe=".$this->io_fun_nomina->uf_formatonumerico($li_debe)." Haber ".$this->io_fun_nomina->uf_formatonumerico($li_haber).". Verifique la informaciï¿½n ");
			}
		}		
		return  $lb_valido;    
	...
	function uf_procesar_contabilizacion_proyectos()
	{
		...
		//	    Arguments: 
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n del perï¿½odo por proyectos
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		$ls_anocurnom=$_SESSION["la_nomina"]["anocurnom"];
		$ls_codnom=$this->ls_codnom;
		...
		$ls_codcomapo=$ls_anocurnom."-".$ls_codnom."-".$ls_codperi."-A"; // Comprobante de Aportes
		$ls_descripcion=$ls_desnom."- Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripciï¿½n de Conceptos
		$ls_descripcion_int=$ls_desnom."- Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento intercompaï¿½ia"; // Descripciï¿½n de Conceptos
		$ls_descripcionapo=$ls_desnom." APORTES - Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper; // Descripciï¿½n de Aportes
		$ls_descripcionapo_int=$ls_desnom." APORTES - Período ".$ls_codperi." del ".$ld_fecdesper." al ".$ld_fechasper." Asiento intercompaï¿½ia"; // Descripciï¿½n de Aportes
		$ls_cuentapasivo="";
		$ls_operacionnomina="";
		$ls_operacionaporte="";
		$ls_tipodestino="";
		...
		{ // insertamos la contabilizaciï¿½n de contabilidad de conceptos
			if($ls_operacionnomina!="O")// Si es compromete no genero detalles contables
			{
				...
				if(($lb_valido)&&($ls_estempcon==0)&&($ls_basdatcon!=""))
				{
					//------------cuentas contables intercompaï¿½ias------------------------------------------------------------
		...
		if($lb_valido)
		{ // insertamos la contabilizaciï¿½n de presupuesto de los aportes
		...
		if($lb_valido)
		{ // insertamos la contabilizaciï¿½n de contabilidad de los aportes
			if($ls_operacionaporte!="O")// Si es compromete no genero detalles contables
			{
				...
				if(($lb_valido)&&($ls_estempcon==0)&&($ls_basdatcon!=""))
				{
					//------------------------------cuentas contables de intercompaï¿½ias---------------------------------------
	...
	function uf_load_conceptos_spg_normales()
	{
		...
		//	    Arguments:
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos que son normales
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_conceptos_spg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_conceptos_spg_proyecto()
	{
		...
		//	    Arguments:
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos que son por proyectos
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_conceptos_spg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
										   	   ...
										   	   $ai_genrecdoc,$ai_tipdocnom,$ai_gennotdeb,$ai_genvou)
	{
		...
		//	    		   ai_genvou  //  generar nï¿½mero de voucher
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se lee el datastored y lo manda a insertar
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
	...
	function uf_load_conceptos_scg_normales($as_operacionnomina,$as_cuentapasivo,$ai_genrecdoc)
	{
		...
		//	    Arguments: as_operacionnomina // Operaciï¿½n de contabilizaciï¿½n 
		//				   as_cuentapasivo // Cuenta de Pasivo hacia donde se contabiliza la nï¿½mina
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos normales
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_conceptos_scg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_conceptos_scg_proyecto()
	{
		...
		//	    Arguments: 
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos por proyecto
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 11/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_conceptos_scg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_spg_normales()
	{
		...
		//	    Arguments: 
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos de aportes normales
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 13/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_aportes_spg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_spg_proyecto()
	{
		...
		//	    Arguments: 
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los conceptos de aportes por proyecto
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 13/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_aportes_spg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_scg_normales($as_operacionaporte)
	{
		...
		//	    Arguments: as_operacionaporte  //  Operaciï¿½n con que se va a contabilizar los aportes
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la data para la contabilizaciï¿½n de los aportes
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaciï¿½n: 13/07/2007
		///////////////////////////////////////////////////////////////////////////////////////////////////
	   	$lb_valido=true;
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_aportes_scg_normales ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_scg_proyecto()
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_aportes_scg_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_procesar_rec_doc_pago_personal_cheque()
	{
		...
		//	    Arguments: 	  
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de procesar la informacion para la recepcion de documento del 
		//                 personal que cobra con cheque
	    //     Creado por: Ing. Marï¿½a Beatriz Unda
	    // Fecha Creaciï¿½n: 22/12/2009
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		if ($lb_valido)
		{
			...
			if($rs_data===false)
			{
				$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_procesar_rec_doc_pago_personal_cheque ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				$lb_valido=false;
			}
			else
			{
				...
				{		 
					...
					{
						$this->io_mensajes->message("El personal ".$ls_codper." no tiene asocida cuenta contable como beneficiario. No se puede realizar la recepciï¿½n de Documento al personal");
						$lb_valido=false;
					}
					elseif ($lb_valido)
					{
	...
	function uf_delete_sno_rd()
	{
		...
		//	    Arguments: $
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que elimina la data de recpeciones de documento de un periodo
	    //     Creado por: Ing. Marï¿½a Beatriz Unda
	    // Fecha Creaciï¿½n: 22/12/2009
		///////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_delete_sno_rd ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	function uf_chequear_beneficiario($as_codper,&$as_ctahaber)
	{
		...
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funciï¿½n que se encarga de verificar si el personal existe como benficiario y buscar
		//                 su cuenta contable
	    //     Creado por: Ing. Marï¿½a Beatriz Unda
	    // Fecha Creaciï¿½n: 22/12/2009
		///////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_chequear_beneficiario ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
			...
			{
				$this->io_mensajes->message("El personal ".$as_codper." no se encuentra registrado como beneficiario. No se puede realizar la recepciï¿½n de Documento al personal");
				$lb_valido=false;
			}
		}	
		return $lb_valido;
	...
	function uf_insert_sno_rd($as_codper,$ad_monpagper,$as_sc_cuenta,$as_debhab)
	{
		...
		//	    Arguments: $as_codper // cï¿½digo del personal
		//                 $ad_monpagper // monto de la recepciï¿½n de documento
	    //                 $as_sc_cuenta // cuenta contable para la recepciï¿½n de documentos
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_insert_sno_rd ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	}// end function uf_insert_sno_rd
	//------------------------------------------------------------------------------------------------------------------------------------
	                                        ...
	                                        $as_operacionnomina,$as_codconc)
	{
		...
		//	   Creado Por: Ing. Marï¿½a Beatriz Unda
		// Fecha Creaciï¿½n: 07/02/2009 								Fecha ï¿½ltima Modificaciï¿½n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$li_estatus=0; // No contabilizado
		$ls_codestpro1=substr($as_programatica,0,25);
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_select_contabilizacion_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
	                                        ...
	                                        $as_operacionnomina,$as_codconc,$ai_monto)
	{
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_update_contabilizacion_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	function uf_select_contabilizacion_scg($as_tipnom,$as_cuenta,$as_operacion,$as_codcom,$as_codconc)
	{
		...
		//		   Access: private
		//	    Arguments: as_codcom  //  Cï¿½digo de Comprobante
		//	    		   as_operacion  //  Operaciï¿½n de la contabilizaciï¿½n		
		//	    		   as_tipodestino  //  Tipo de destino de contabiliaciï¿½n		
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_select_contabilizacion_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
			if ($rs_data->RecordCount()==0)
	...
	function uf_update_contabilizacion_scg($as_tipnom,$as_cuenta,$as_operacion,$as_codcom,$as_codconc,$ai_monto)
	{
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_update_contabilizacion_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
	...
	function uf_select_contabilizacion_spi($as_codcom,$as_tipnom,$as_cuenta,$as_operacionnomina,$as_codconc,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,$as_estcla)
	{
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_select_contabilizacion_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
			if ($rs_data->RecordCount()==0)
	...
	function uf_update_contabilizacion_spi($as_codcom,$as_tipnom,$as_cuenta,$as_operacionnomina,$as_codconc,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,$as_estcla,$ai_monto)
	{
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_update_contabilizacion_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
...
///PARA CUANDO SE INTEGRAN CON OTRAS BD NO SE SI FUNCIONA
												...
												$ai_gennotdeb,$ai_genvou,$as_codcomapo, $as_codest1_G, $as_estcla_G)
	{
		...
		// Fecha Creaciï¿½n: 14/08/2008								Fecha ï¿½ltima Modificaciï¿½n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$li_estatus=0; // No contabilizado
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_insert_contabilizacion_scg_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		return $lb_valido;
    ...
    function uf_concepto_reintegro_int()
	{
		...
		if($rs_datos===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_concepto_reintegro_int ERROR->"
											   ...
											   $ai_genvou)
	{
		...
		$this->io_sql=new class_sql($this->io_conexion);
		$ls_tipnom="N";
		    // se buscan todas las cuentas contables de intercampaï¿½ias realcioandas con el presupuesto
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_conceptos_scg_int ERROR->"
			                            .$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
	                                         ...
	                                         $ai_tipdocapo, $ai_gennotdeb,$ai_genvou,$as_operacionaporte)
	{
		...
		//	               as_codcom  //  Cï¿½digo de Comprobante
		//	    		   as_codpro  //  codigo del proveedor
		//	    		   as_codben  //  codigo del beneficiario
		//	    		   as_tipodestino  //  Tipo de destino de contabiliaciï¿½n
		//	    		   as_descripcion  //  descripciï¿½n del comprobante
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_contabilizar_aportes_scg_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
    ...
    function uf_load_conceptos_scg_normales_int($as_operacionnomina,$as_cuentapasivo,$ai_genrecdoc)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_conceptos_scg_normales_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
    ...
    function uf_load_conceptos_scg_proyecto_int()
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_conceptos_scg_proyecto_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_load_aportes_scg_normales_int($as_operacionaporte)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_aportes_scg_normales_int ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
   	...
   	function uf_load_aportes_scg_proyecto_int()
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Cierre Periodo 4 Mï¿½TODO->uf_load_aportes_scg_proyecto_int ERROR->".
			                             $this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
