...
<?php
	...
	switch ($ls_operacion) 
	{
		...
		case "ABRIR_PERIODO":
			...
			//$ls_codperi_abrir=$io_cierreperiodo->io_funciones->uf_rellenar_izq((intval($ls_peractnom)),0,3);//para cuando se cierra el periodo 24, poder abrirlo de nuevo
