...
//raq
	...
	function uf_actualizar_prestamo_cierre()
	{
		...
		//	  Description: Funci�n que actualiza los prestamos al momento del cierre del periodo 
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 15/02/2006          Fecha �ltima Modificacion : 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		//////////////////////////////////////////////////////////////////////////////
	...
	function uf_limpiar_constantes()
	{
		...
		//	     Function: uf_limpiar_constantes 
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n  que actualiza el monto del concepto y lo reinicializa en cero 
	    //     Creado por: Ing. Yozelin Barrag�n
		...
		{
		  $lb_valido=false;
		  $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_limpiar_constantes ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_limpiar_concepto()
	{
		...
		{
		  $lb_valido=false;
		  $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_limpiar_concepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_limpiar_proyectopersonal()
	{
		...
		//	     Function: uf_limpiar_proyectopersonal 
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n  que actualiza los d�as de los proyectos los coloca en cero
	    //     Creado por: Ing. Yesenia Moreno
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_limpiar_proyectopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_actualizar_periodo($as_codperi,&$as_codperi_next,&$as_codperi_prev)
	{
		...
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que obtiene los  periodos siguientes y previos
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006         
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		//////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
		   $lb_valido=false;
		   $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_actualizar_periodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($ls_perresnom<>"000") 
	...
	function uf_eliminar_salida($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que elimina el periodos actual y el siguiente de tabla sno_salida para proceder al 
		//                 cierre del mismo.
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006         
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_eliminar_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_eliminar_prenomina($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que elimina el periodos actual y el siguiente de tabla sno_prenomina para proceder al 
		//                 cierre del mismo.
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006         
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_eliminar_prenomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_eliminar_resumen($as_codperi)
	{
		...
		//	               as_codperi_next // codigo del periodo siguiente
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que elimina el periodos actual y el siguiente de tabla sno_resumen para proceder al 
		//                 cierre del mismo.
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006         
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_eliminar_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
        return $lb_valido;
	...
	function uf_limpiar_periodo($as_codperi,$as_codperi_next)
	{
		...
		//	       Returns:	   $lb_valido true si es correcto la funcion o false en caso contrario
		//	   Description:    Funci�n  que elimina el periodo actual y siguiente de la tabla sno_salida y 
		//                     actualiza la tabla sno_resumen con los montos en cero(0.0000)
	    //     Creado por :    Ing. Yozelin Barrag�n
	    // Fecha Creaci�n :    08/02/2006      
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
	...
	function uf_existe_hpersonalnomina($as_codperi,$as_anocur)
	{
		...
		//	  Description: Funci�n que retorna cuantos existen en la tabla personalnomina
	    //     Creado por: Ing. Yozelin Barrag�n
		...
		if($rs_data===false)
		{
		  $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_existe_hpersonalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_delete_salida($as_codperi)
	{
		...
		//	     Arguments:  $as_codperi // codigo del periodo
		//	       Returns:	 $lb_valido true si es correcto la funcion o false en caso contrario
		//	   Description:  Funci�n que elimina el periodos de tabla  sno_salida para proceder al cierre del mismo
	    //     Creado por :  Ing. Yozelin Barrag�n
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_prenomina($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla sno_prenomina para proceder al cierre del mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 20/02/2006   
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="DELETE ".
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_prenomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_resumen($as_codperi)
	{
		...
		//	     Arguments:  $as_codperi // codigo del periodo
		//	       Returns:	 $lb_valido true si es correcto la funcion o false en caso contrario
		//	   Description:  Funci�n que elimina el periodos de tabla sno_resumen para proceder al cierre del mismo
	    //     Creado por :  Ing. Yozelin Barrag�n
	    // Fecha Creaci�n :  17/02/2006    
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_prestamoperiodo($as_codperi)
	{
		...
		//	  Description: Funci�n que elimina el periodos de tabla  sno_prestamoperiodo para proceder al cierre del mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006     
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_prestamoperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_prestamoamortizado($as_codperi)
	{
	    ...
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006     
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 01/12/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="DELETE ".
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_prestamoamortizado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}// end function uf_delete_prestamoperiodo
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_delete_prestamos($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla uf_delete_prestamos para proceder al cierre del mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_prestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_tipoprestamo($as_codperi)
	{
		...
		//	     Arguments:  $as_codperi // codigo del periodo
		//	       Returns:	 $lb_valido true si es correcto el delete o false en caso contrario
		//	   Description:  Funci�n que elimina el periodos de tabla sno_prestamo para proceder al cierre del mismo
	    //     Creado por :  Ing. Yozelin Barrag�n
	    // Fecha Creaci�n :  17/02/2006    
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_tipoprestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_constantepersonal($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla sno_constantepersonal para proceder al cierre del mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006       
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_constantepersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_constante($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla sno_constante para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006   
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_constante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_conceptovacacion($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_conceptovacacion para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006      
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_conceptovacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_conceptopersonal($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//        Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_conceptopersonal para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_conceptopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_primaconcepto($as_codperi) 
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_concepto para proceder abrir  el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_primaconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_concepto($as_codperi)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_concepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}// end function uf_delete_primaconcepto
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_delete_vacacpersonal($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_vacacpersonal para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_vacacpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_proyectopersonal($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_proyectopersonal para proceder abrir el mismo
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaci�n: 10/07/2007  
		// Modificado Por: 												Fecha �ltima Modificaci�n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_proyectopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_personalpension($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_personalpension para proceder abrir el mismo
	    //     Creado por: Ing. Yesenia Moreno
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_personalpension ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_encargaduria()
	{
		...
		//	    Arguments: 
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_encargaduria para proceder abrir el mismo
	    //     Creado por: Ing. Mar�a Beatriz
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_encargaduria ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_personalnomina($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_personalnomina para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006     
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_personalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	...
	function uf_delete_codigounicorac($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla sno_asignacioncargo para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006      
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_codigounicorac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_asignacioncargo($as_codperi)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_asignacioncargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}// end function uf_delete_asignacioncargo
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_delete_primadocentepersonal($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla historica sno_hcargo para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_primadocentepersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_cargo($as_codperi)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_cargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_unidadadmin($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_unidadadmin para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_unidadadmin ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_proyecto($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_proyecto para proceder abrir el mismo
	    //     Creado por: Ing. Yesenia Moreno	
	    // Fecha Creaci�n: 10/07/2007 
		// Modificado Por: 												Fecha �ltima Modificaci�n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_primagrado($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina las primagrado para proceder abrir el mismo
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaci�n: 11/03/2006          Fecha �ltima Modificacion : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	    $lb_valido=true;		
		$ls_sql="DELETE ".
                "  FROM sno_primagrado ".
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_primagrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_grado($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_grado para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_grado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_tabla($as_codperi)
	{
		...
		//	    Arguments: as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el delete o false en caso contrario
		//	  Description: Funci�n que elimina el periodos de tabla  sno_tabla para proceder abrir el mismo
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_tabla ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_periodo($as_codperi)
	{
		...
		//	     Arguments:  $as_codperi // codigo del periodo
		//	       Returns:	 $lb_valido true si es correcto el delete o false en caso contrario
		//	   Description:  Funci�n que elimina el periodos de tabla  sno_periodo para proceder abrir el mismo
	    //     Creado por :  Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_periodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_delete_subnomina($as_codperi)
	{
		...
		//	     Arguments:  $as_codperi // codigo del periodo
		//	       Returns:	 $lb_valido true si es correcto el delete o false en caso contrario
		//	   Description:  Funci�n que elimina el periodos de tabla sno_subnomina para proceder abrir el mismo
	    //     Creado por :  Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 17/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_delete_subnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
		    $lb_valido=true;
	...
	function uf_eliminar_periodo($as_codperi)
	{
		...
		//	  Description: Funci�n que elimina el periodos de todas las tablas para proceder abrir un per�odo 
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_insert_tabla($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//	  Description: Funci�n que inserta los datos en la tabla sno_tabla de la tabla historica sno_htabla 
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006   
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_tabla ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_grado($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                  $as_codperi_abrir // codigo del periodo abrir
		//	       Returns:	$lb_valido true si es correcto el insert o false en caso contrario
		//	   Description: Funci�n que inserta los datos en la tabla sno_grado de la tabla historica sno_hgrado
	    //     Creado por : Ing. Yozelin Barrag�n.
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_grado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_primagrado($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                  as_codperi_abrir // codigo del periodo abrir
		//	       Returns:	lb_valido true si es correcto el insert o false en caso contrario
		//	   Description: Funci�n que inserta los datos en la tabla sno_primagrado de la tabla historica sno_hprimagrado
	    //      Creado por: Ing. Yesenia Moreno
	    //  Fecha Creaci�n: 11/03/2006          Fecha �ltima Modificacion : 10/02/2006  Hora :08:42 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	    $lb_valido=true;
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_primagrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_primasdocentes($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_unidadadmin de la tabla historica sno_hunidadadmin 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_primasdocentes ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_primadocentepersonal($adt_anocurnom,$as_codperi_abrir)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_primadocentepersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}// end function uf_insert_unidadadmin
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_insert_unidadadmin($adt_anocurnom,$as_codperi_abrir)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_unidadadmin ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}// end function uf_insert_unidadadmin
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_insert_proyecto($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi // codigo del periodo
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_proyecto de la tabla historica sno_hproyecto
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaci�n: 10/07/2007  
		// Modificado Por: 												Fecha �ltima Modificaci�n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_proyecto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_cargo($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_cargo de la tabla historica sno_hcargo 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_cargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_personalnomina($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_personalnomina de la tabla historica sno_hpersonalnomina 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
            $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_personalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_personalpension($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_personalpension de la tabla historica sno_hpersonalpension 
	    //     Creado por: Ing. Yesenia Moreno
	    // Fecha Creaci�n: 07/05/2008  
		// Modificado Por: 										Fecha �ltima Modificaci�n : 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
            $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_personalpension ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_asignacioncargo($adt_anocurnom,$as_codperi_abrir)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_asignacioncargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_codigounicorac($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_codigounicorac de la tabla historica sno_hcodigounicorac 
	    //     Creado por: Ing. Mar�a Beatriz Unda.
	    // Fecha Creaci�n: 04/11/2008      
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_codigounicorac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_proyectopersonal($adt_anocurnom,$as_codperi_abrir)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_proyectopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_vacacpersonal($adt_anocurnom,$as_codperi_abrir)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_vacacpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_concepto($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_concepto de la tabla historica sno_hconcepto 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_concepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_primaconcepto($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_primaconcepto de la tabla historica sno_hprimaconcepto 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 20/02/2006
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_primaconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_conceptopersonal($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_conceptopersonal de la tabla historica sno_hconceptopersonal 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006    
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_conceptopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_conceptovacacion($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_conceptovacacion de la tabla historica sno_hconceptovacacion 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006  
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_conceptovacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_constante($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                  $as_codperi_abrir // codigo del periodo abrir
		//	       Returns:	$lb_valido true si es correcto el insert o false en caso contrario
		//	   Description: Funci�n que inserta los datos en la tabla sno_constante de la tabla historica sno_hconstante 
	    //     Creado por : Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n : 10/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_constante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_constantepersonal($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_constantepersonal de la tabla historica sno_hconstantepersonal
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_constantepersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_tipoprestamo($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_tipoprestamo de la tabla historica sno_htipoprestamo
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_tipoprestamo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_prestamos($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo  abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_prestamos de la tabla historica sno_hprestamos 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_prestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_prestamoperiodo($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_prestamoperiodo de la tabla historica sno_hprestamoperiodo 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_prestamoperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}// end function uf_insert_prestamos
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_cancelar_prestamoperiodo($as_codperi_actual, $as_codperi_abrir)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_cancelar_prestamoperiodo 
		//	    Arguments: adt_anocurnom // a�o en curso de la nomina 
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que actualiza el campo estcuo en la tabla sno_prestamoperiodo de la tabla historica sno_hprestamoperiodo 
	    	//     Creado por: Luis Ng.
	    	// Fecha Creaci�n: 26/01/2011 
		// Modificado Por: Luis Ng						Fecha �ltima Modificaci�n : 26/01/2011
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$li_estcuo=0;
		$adt_anocurnom=$_SESSION["la_nomina"]["anocurnom"];
		...
		$ls_sql= "UPDATE sno_hprestamosperiodo ".
			...
			"	AND codnom='".$this->ls_codnom."' ".
			"	AND anocur='".$adt_anocurnom."' ".			
			"	AND feciniper=(select a.fecdesper from sno_periodo a, sno_nomina b where a.codnom='".$this->ls_codnom."' and a.codperi='".$as_codperi_abrir."' and a.codemp='".$this->ls_codemp."' and a.codnom=b.codnom and b.anocurnom='".$adt_anocurnom."') ".
			"	AND fecfinper=(select a.fechasper from sno_periodo a, sno_nomina b where a.codnom='".$this->ls_codnom."' and a.codperi='".$as_codperi_abrir."' and a.codemp='".$this->ls_codemp."' and a.codnom=b.codnom and b.anocurnom='".$adt_anocurnom."') ".
			"	AND codperi='".$as_codperi_abrir."' ";
//select fecdesper from sno_periodo where codnom='0001' and codperi='001';
//select fechasper from sno_periodo where codnom='0001' and codperi='001';
//UPDATE sno_hprestamosperiodo set estcuo='1' where codemp='0001' AND codnom='001' AND feciniper=select fecdesper from sno_periodo where codnom='0001' and codperi='001' AND fecfinper = select fechasper from sno_periodo where codnom='0001' and codperi='001';

		$li_row=$this->io_sql->execute($ls_sql);
		if($li_row===false)
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_cancelar_prestamoperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}// end function uf_cancelar_prestamoperiodo
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_insert_resumen($adt_anocurnom,$as_codperi_abrir)
	{
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_resumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_salida($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_salida de la tabla historica sno_hsalida 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 10/02/2006 
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_salida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_prenomina($adt_anocurnom,$as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Funci�n que inserta los datos en la tabla sno_prenomina de la tabla historica sno_hprenomina 
	    //     Creado por: Ing. Yozelin Barrag�n.
	    // Fecha Creaci�n: 20/02/2006   
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 M�TODO->uf_insert_prenomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	...
	function uf_insert_periodo_abrir($as_codperi_abrir)
	{
		...
		//	  Description: Funci�n que se encarga de insertar en las tablas normales el periodo a brir  de los historicos
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006          
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_reversar_procesar_historico($as_codperi_abrir,$as_codperi_actual)
	{
		...
		//	      Returns: lb_valido true si es correcto la funcion o false en caso contrario
		//	  Description: Funci�n que se enacarga de reversar el proceso de historicos del periodo abrir 
	    //     Creado por: Ing. Yozelin Barrag�n
	    // Fecha Creaci�n: 09/02/2006
		// Modificado Por: Ing. Yesenia Moreno						Fecha �ltima Modificaci�n : 29/05/2006
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
