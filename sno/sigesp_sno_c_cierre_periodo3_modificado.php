...
class sigesp_sno_c_cierre_periodo3
{
	...
	function uf_cancelar_prestamoperiodo($as_codperi_actual, $as_codperi_abrir)
	{
		...
		//                 as_codperi_abrir // codigo del periodo abrir
		//	      Returns: lb_valido true si es correcto el insert o false en caso contrario
		//	  Description: Función que actualiza el campo estcuo en la tabla sno_prestamoperiodo de la tabla historica sno_hprestamoperiodo 
	    	//     Creado por: Luis Ng.
	    	// Fecha Creación: 26/01/2011 
		// Modificado Por: Luis Ng						Fecha Última Modificación : 26/01/2011
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$li_estcuo=0;
...
//UPDATE sno_hprestamosperiodo set estcuo='1' where codemp='0001' AND codnom='001' AND feciniper=select fecdesper from sno_periodo where codnom='0001' and codperi='001' AND fecfinper = select fechasper from sno_periodo where codnom='0001' and codperi='001';
		...
		{
			$lb_valido=false;
		    $this->io_mensajes->message("CLASE->Cierre Periodo3 MÉTODO->uf_cancelar_prestamoperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
