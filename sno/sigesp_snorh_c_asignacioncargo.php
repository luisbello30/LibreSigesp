...
class sigesp_snorh_c_asignacioncargo
{
	...
	function uf_select_asignacioncargo($as_campo,$as_valor,$as_tipo)
	{
		...
		//	               as_tipo  // tipo de llamado si requiere que filtre por la n�mina � n�
		//	      Returns: lb_existe True si existe � False si no existe
		//	  Description: Funcion que verifica si la asignaci�n de cargo est� registrada
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;
		...
		if($as_tipo=="1")// Requiere que se filtre por la n�mina
		{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_select_asignacioncargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
									   ...
									   $as_codgraobrero,$aa_seguridad)
	{
		...
		//		   Access: private
		//	    Arguments: as_codasicar  // c�digo de la asignaci�n de cargo
		//				   as_denasicar  // Denominaci�n 
		...
		//				   as_codded  // C�digo de Dedicaci�n del personal
		//				   as_codtipper  // C�digo de Tipo de Personal
		//				   ai_numvacasicar  // N�mero de Vacantes
		//				   ai_numocuasicar  // N�mero de puestos ocupado
		//				   as_codproasicar  // C�digo Program�tico
		//				   as_codgraobrero // grado del obrero
		//				   aa_seguridad  // arreglo de seguridad
		//	      Returns: lb_valido True si se ejecuto el insert � False si hubo error en el insert
		//	  Description: Funcion que inserta la asignaci�n de cargo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		$ls_prouniadm=substr($as_coduniadm,14,2);
		 $ls_sql="INSERT INTO sno_asignacioncargo (codemp,codnom,codasicar,denasicar,minorguniadm,ofiuniadm,uniuniadm,depuniadm, ".
				...
				"'".$as_codpas."','".trim($as_codgra)."','".$as_codded."','".$as_codtipper."',".$ai_numvacasicar.",".$ai_numocuasicar.",".
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("**CLASE->Asignaci�n Cargo M�TODO->uf_insert_asignacioncargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		...
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="INSERT";
			$ls_descripcion ="Insert� la Asignaci�n de Cargo ".$as_codasicar." asociada a la n�mina ".$this->ls_codnom;
			...
			if($lb_valido)
			{	
				$this->io_mensajes->message("La Asignaci�n de Cargo fue registrada.");
				$this->io_sql->commit();
			}
			else
			{
									   ...
									   $as_codgraobrero,$aa_seguridad)
	{
		...
		//				   ai_numocuasicar  // N�mero de puestos ocupado
		//				   as_codproasicar  // C�digo Program�tico
		//				   as_coduniadmant  // C�digo de unidad administrativa anterior
		//				   as_codpasant  // C�digo de Paso anterior
		//				   as_codgraant  // C�digo de Grado anterior
		//				   as_codtabant  // C�digo de Tabulador anterior
		//				   ai_monsalgra  // C�digo del Salario del tabulador
		//				   $as_codgraobrero // grado del obrero
		//				   aa_seguridad  // arreglo de seguridad
		//	      Returns: lb_valido True si se ejecuto el update � False si hubo error en el update
		//	  Description: Funcion que actualiza la asignaci�n de cargo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_update_asignacioncargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$this->io_sql->rollback();
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Actualiz� la Asignaci�n de Cargo ".$as_codasicar." asociada a la n�mina ".$this->ls_codnom;
			$lb_valido=$this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			...
			if($lb_valido)
			{	
				$this->io_mensajes->message("La Asignaci�n de Cargo fue actualizada.");
				$this->io_sql->commit();
			}
			else
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_update_asignacioncargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));				$this->io_sql->rollback();
			}
		}
		return $lb_valido;
	 								  ...
	 								  $as_coduniadmant,$as_codpasant,$as_codgraant,$as_codtabant,$ai_monsalgra,$aa_seguridad)
	{
		...
		//				   as_coduniadm  // C�digo de Unidad Administrativa
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_update_personalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		} 		
		if($lb_valido)
		{
			$ls_sql="UPDATE sno_personalnomina ".
		...
		if($lb_valido)
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion ="Actualiz� Unidad administrativa, Tabla, Paso, Grado, Dedicaci�n y Tipo Personal ".
							 " del personal n�mina que est� asociado a la unidad administrativa ".$as_coduniadm.", n�mina ".$this->ls_codnom;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
						...
						$as_codtabant,$ai_monsalgra,$as_estcla,$as_codnom,$as_codgraobrero,$aa_seguridad)
	{
		...
		//				   ai_numocuasicar  // N�mero de puestos ocupado
		//				   as_codproasicar  // C�digo Program�tico
		//				   as_coduniadmant  // C�digo de la unidad administrativa anterior
		//				   as_codpasant  // C�digo de Paso anterior
		//				   as_codgraant  // C�digo de Grado anterior
		//				   as_codtabant  // C�digo de Tabulador anterior
		//				   ai_monsalgra  // C�digo del Salario del tabulador,
		...
		//	  Description: Funcion que guarda la asignaci�n de cargo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;		
		...
		switch ($as_existe)
		{
			case "FALSE":
				...
				{
					$this->io_mensajes->message("La Asignaci�n de Cargo ya existe, no la puede incluir");
				}
				break;
			...
			case "TRUE":
				...
				{
					$this->io_mensajes->message("La Asignaci�n de Cargo no existe, no la puede actualizar");
				}
				break;
		}
		return $lb_valido;
    ...
    function uf_delete_asignacioncargo($as_codasicar,$as_codnom,$aa_seguridad)
    {
		...
		//	  Description: Funcion que elimina la asignaci�n de cargo
		//	   Creado Por: Ing. Yesenia Moreno
		// Fecha Creaci�n: 01/01/2006 								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		    ...
		    ($this->uf_select_codigo_unico_rac_eliminar("codasicar",$as_codasicar,"sno_codigounicorac")===false))   
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_delete_asignacioncargo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));				
				$this->io_sql->rollback();
			}
			else
			{
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� la Asignaci�n de Cargo ".$as_codasicar." asociada a la n�mina ".$this->ls_codnom;
				$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				if($lb_valido)
				{	
					$this->io_mensajes->message("La Asignaci�n de Cargo fue Eliminada.");
					$this->io_sql->commit();
				}
				else
				{
		...
		{
			$this->io_mensajes->message("No se puede eliminar la Asignaci�n de Cargo, existe personal o c�digos �nicos de rac asociados a ella.");
		}       
  ...
  //-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_codigo_unico_rac($as_codasicar,$as_codnom,&$ai_totrows,&$ao_object)
	{
		...
		//	    Arguments: as_codasicar  // c�digo de la asignacion de cargo
		//                 as_codnom    //  c�digo de la n�mina
		//				   ai_totrows  // total de fila
		//				   ao_object  // arreglo de objetos
		//	      Returns: lb_valido True si se encontro � False si no se encontr�
		//	  Description: Funcion que obtiene todas las c�digos �nicos de rac de la asignaci�n de cargo seleccionada
		...
		{
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_load_codigo_unico_rac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
			$ai_totrows=0;
...
//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_codigo_unico_rac(&$as_codasicar,$as_codunirac)
	{
		...
		//				   as_codunirac  // c�digo de �nico de rac
		//	      Returns: lb_existe True si se encontro � False si no se encontr�
		//	  Description: Funcion que verifica si el c�digo �nico de rac est� registrado
		//	   Creado Por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 03/11/2008 								Fecha �ltima Modificaci�n : 		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	
		$as_codasicar="";
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_select_codigo_unico_rac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_insert_codigo_unico_rac($as_codnom,$as_codasicar,$as_codunirac,$aa_seguridad)
	{
		...
		{
 			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_insert_codigo_unico_rac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="INSERT";
			$ls_descripcion ="Insert� el codigo unico de rac ".$as_codunirac." de la asignacion de cardo ".$as_codasicar."  ".
			                  " asociado a la n�mina ".$as_codnom;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
    ...
    function uf_delete_codigo_unico_rac($as_codnom,$as_codasicar,$as_codunirac,$aa_seguridad)
    {
		...
		//				   aa_seguridad  // arreglo de las variables de seguridad
		//	      Returns: lb_valido True si se ejecuto el delete � False si hubo error en el delete
		//	  Description: Funcion que elimina los c�digos �nicos de rac de la tabla sno_codigounicorac
			//	   Creado Por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 03/11/2008 								Fecha �ltima Modificaci�n : 		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
		 if ($this->uf_select_codigo_unico_rac_eliminar("codunirac",$as_codunirac,"sno_personalnomina")===false)   
		{
			...
			{
				$lb_valido=false;
				$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_delete_codigo_unico_rac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
				$this->io_sql->rollback();
			...
			else
			{
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="DELETE";
				$ls_descripcion ="Elimin� el codigo unico de rac ".$as_codunirac." de la asignacion de cardo ".$as_codasicar."  ".
								  " asociado a la n�mina ".$as_codnom;
				$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
				...
				if($lb_valido)
				{	
					$this->io_mensajes->message("El C�digo �nico fue Eliminado.");
					$this->io_sql->commit();
				}
				else
				{
		...
		{
			$this->io_mensajes->message("El C�digo �nico no se puede eliminar porque est� asociado a un personal.");
			$lb_valido=false;
		}
		return $lb_valido;
...
//-----------------------------------------------------------------------------------------------------------------------------------	
    ...
    function uf_update_estatus_codigo_unico_rac($as_codper,$as_valor,$aa_seguridad)
    {
		...
		//	      Returns: lb_valido True si se ejecuto el delete � False si hubo error en el delete
		//	  Description: Funcion que actualiza el estatus de  los c�digos �nicos de rac de la tabla sno_codigounicorac
		...
		$ls_sql="UPDATE sno_codigounicorac ".
				...
				{
					$lb_valido=false;
					$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_update_estcodunirac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
				}
				else
				{
						...
						/////////////////////////////////         SEGURIDAD               /////////////////////////////		
						$ls_evento="UPDATE";
						$ls_descripcion ="Actualiz� el estado de los c�digos �nico de RAC asociados a la asignaci�n de cargo asociado a la n�mina ".$this->ls_codnom;
						$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
														$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
														$aa_seguridad["ventanas"],$ls_descripcion);
						/////////////////////////////////         SEGURIDAD               /////////////////////////////		
   ...
   function uf_select_estatus_codigo_unico_rac($as_codunirac)
	{
		...
		//				   as_codunirac  // c�digo de �nico de rac
		//	      Returns: lb_existe True si se encontro � False si no se encontr�
		//	  Description: Funcion que verifica si el estado del c�digo �nico de rac
		//	   Creado Por: Ing. Mar�a Beatriz Unda
		// Fecha Creaci�n: 03/11/2008 								Fecha �ltima Modificaci�n : 		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;	
		$ls_estcodunirac="";
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_select_estatus_codigo_unico_rac ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
	...
	function uf_select_codigo_unico_rac_eliminar($as_campo,$as_valor,$as_tabla)
	{
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Asignaci�n Cargo M�TODO->uf_select_codigo_unico_rac_eliminar ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
