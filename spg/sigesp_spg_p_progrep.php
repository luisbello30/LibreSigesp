  ...
  <?php
	...
	?>
              ...
              <td width="435" colspan="2"><select name="cmbrep" id="select" onChange="uf_cargargrid()">
                ...
                <option value="0802" <?php  print $ej_f0802 ?>>Comparado Estado Resultado Instructivo 8</option>
...
<tr>
 ...
 $title[3]="Asignaci&oacute;n"; 
 $title[4]="Distribucion";   
 if($_POST["cmbrep"]=='0802')
 {
     $title[5]="Pres.Aprobado"; 
     $title[6]="Pres.Modificado"; 
 }
	 ...
	 if($row=$io_sql->fetch_row($rs_load))
	 {
		...
		{    
			...
			if($ls_status=="I")
			{
                ...
                if ($ls_codrep=='0802')
                {
                    $object[$i][5]="<input type=text name=txtPresupAprobado".$i." onBlur='uf_formato(this)'  onFocus= uf_fila(".$i.") value='$ld_presupuesto_aprobado' size=10 class=formato-azul >";
                    $object[$i][6]="<input type=text name=txtPresupModificado".$i." onBlur='uf_formato(this)'  onFocus= uf_fila(".$i.") value='$ld_presupuesto_modificado' size=10 class=formato-azul >";                     
                }
			}
			else
			{
