 ...
 /*  $data=$io_sql->obtener_datos($rs_load);
   ...
   {    
		...
		$object[$i][3] ="<input type=text name=txtAsignacion".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' value=$ld_asignado  onFocus= uf_fila(".$i.") style=text-align:right>
		                 <input type=hidden name=txtEnero".$i."  onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' value=$ld_enero class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
						 <input type=hidden name=txtFebrero".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)'  onKeyUp='ue_validarcomas_puntos(this)' value=$ld_febrero class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
						 ...
						 <input type=hidden name=txtAbril".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_abril class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
						 <input type=hidden name=txtMayo".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_mayo class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
						 ...
						 <input type=hidden name=txtJulio".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_julio class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
						 <input type=hidden name=txtAgosto".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_agosto class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
						 ...
						 <input type=hidden name=txtOctubre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' onKeyUp='ue_validarcomas_puntos(this)' value=$ld_octubre class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
						 <input type=hidden name=txtNoviembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' value=$ld_noviembre  class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>
