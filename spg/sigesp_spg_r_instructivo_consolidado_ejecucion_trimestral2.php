...
function ue_showouput()
{
	...
	else
	{
		...
		pagina="reportes/sigesp_spg_rpp_instructivo_consolidado_ejecucion_trimestral2.php?trimestre="+trimestre;
...
function ue_showouput_excel()
{
	...
	{
		li_mesdes=trimestre.substr(0,2);
		pagina="reportes/sigesp_spg_rpp_instructivo_consolidado_ejecucion_trimestral2_excel.php?trimestre="+trimestre;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
}
