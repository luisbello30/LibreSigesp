	  ...
	  do
	  {
	   ...
	   $li_posicion = $this->io_function->uf_posocurrencia($ls_formato,"-" , $li_indice ) - $li_indice;
		...
		$ls_sql=" SELECT PCT.* ".
				  ...
				  " ORDER BY PCT.codestpro1,PCT.codestpro2,PCT.codestpro3,".
				  "          PCT.codestpro4,PCT.codestpro5,PCT.estcla,PCT.spg_cuenta ";	//print $ls_sql; die();
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creaci�n :    22/09/2006          Fecha �ltima Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT  distinct PCM.procede, PCM.comprobante, PCM.fecha, PCM.descripcion, PCM.total,      ".
              ...
              " ORDER BY  PCM.fecha, PCM.procede, PCM.comprobante ";//print $ls_sql; die();
	  $rs_data=$this->io_sql->select($ls_sql);
	  if ($rs_data===false)
	     {
...
/********************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql=" SELECT PMV.*, POP.asignar, POP.aumento, POP.disminucion, POP.comprometer, POP.causar, POP.pagar ".
			 ...
			 "    AND PMV.operacion=POP.operacion";//print $ls_sql."<br>";// die();
	 $rs_data=$this->io_sql->select($ls_sql);
	 if($rs_data===false)
	 {   // error interno sql
		   $this->io_msg->message("CLASE->sigesp_spg_reporte_class
...
/********************************************************************************************************************************/
   	...
   	function uf_spg_reportes_ejecutado_por_partida_nuevo($adt_fecdes,$adt_fechas,$as_spg_cuenta_desde,$as_spg_cuenta_hasta,$rs_data)
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_ejecutado_por_partida
	 //     Argumentos :    $adt_fecdes   //   fecha desde
	 //                     $adt_fechas   //   fecha hasta
	 ...
	 // Fecha Creaci�n :    25/09/2006          Fecha �ltima Modificacion :      Hora :
	  ...
	  $this->io_spg_report_funciones->uf_filtro_seguridad_programatica('spg_dt_cmp',$ls_seguridad);
					  ...
					  $ls_sql="select  sigesp_plan_unico_re.denominacion,spg_dt_cmp.descripcion,
				...
				inner join sigesp_plan_unico_re 
				on spg_dt_cmp.spg_cuenta=sigesp_plan_unico_re.sig_cuenta
	 ...
	 // Fecha Creaci�n :    22/09/2006          Fecha �ltima Modificacion :      Hora :
	  ...
	  $ls_sql = "SELECT PCM.cod_pro as cod_pro,
				  ...
				  "GROUP BY PCM.cod_pro, PCM.ced_bene, PCM.fecha, PCM.procede, PCM.comprobante, PCM.descripcion,
                     PCM.tipo_destino, PMV.operacion, PMV.monto, PCM.total order by cod_pro asc";
...
/********************************************************************************************************************************/
	...
	/////////////////////////////////////////////////////////////////////////////////////
	function uf_select_dt_comprobante($as_codemp,$as_procede,$as_comprobante,$ad_fecha,&$ai_numrows,&$rs_data,&$ai_denuac)
	{
		 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/* $ls_sql = "SELECT spg_dtmp_cmp.codestpro1,
		 ...
		 {
                          $ai_denuac = $rs_data->fields["denuac"];
			...
			if ($ai_numrows)
			{
				 ...
				 while ($row=$this->io_sql->fetch_row($rs_dat))
				 {
						...
						elseif($ls_operacion=='AU')
						{
						 ...
						 $this->uf_select_data("SELECT spg_ep1.denestpro1, sum(spg_dtmp_cmp.monto) as monto
										  ...
										  GROUP BY denestpro1",'denestpro1','monto',$ls_denestpro1,$ld_monniv);
                                                ...
                                                $ls_estpro1_aux=substr($ls_codestpro1,(25-$li_len1),$li_len1);
                                                $ls_estpro2_aux=substr($ls_codestpro2,(25-$li_len2),$li_len2);
                                                $ls_estpro3_aux=substr($ls_codestpro3,(25-$li_len3),$li_len3);
                                                $ls_estpro4_aux=substr($ls_codestpro4,(25-$li_len4),$li_len4);
                                                $ls_estpro5_aux=substr($ls_codestpro5,(25-$li_len5),$li_len5);
						 ...
						 for ($li=0;$li<25;$li++)
						  {
							...
							//if($li==19)
                                                ...
                                                else
                                                {
                                                    ...
                                                    echo $ls_estpro1_aux; die();
						 $la_estpro2 = str_split($ls_codestpro2,1);
					    ...
					    if ($li_pos=='1'){
						 ...
						 if (trim($ls_operacion)=='AU' && !$lb_impreso)
							{
...
function uf_obtener_fuente_financiamiento_comprobante($as_comprobante,$as_procede,$ad_fecha)
{
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
