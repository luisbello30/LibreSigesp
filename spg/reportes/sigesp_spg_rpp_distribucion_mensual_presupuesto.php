...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera($io_cabecera,$as_programatica,$as_denestpro,&$io_pdf)
	{
		...
		else
		{
			 ...
			 $la_config=array('showHeadings'=>0, // Mostrar encabezados
							 ...
							 'width'=>550, // Ancho de la tabla
							 'maxWidth'=>550,// Ancho M�ximo de la tabla
							 'cols'=>array('name'=>array('justification'=>'right','width'=>40), // Justificaci�n y ancho de la columna
	...
	function uf_print_cabecera_detalle($io_encabezado,&$io_pdf)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->saveState();
		$la_data=array(array('cuenta'=>'<b>Cuenta</b>','denominacion'=>'<b>Denominaci�n</b>','enero'=>'<b>Enero</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
					     ...
					     'cols'=>array('cuenta'=>array('justification'=>'center','width'=>55), // Justificaci�n y ancho de la 
								       'denominacion'=>array('justification'=>'center','width'=>90), // Justificaci�n y ancho 
								       'enero'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la columna
								       'febrero'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la 
								       'marzo'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la columna
								       'abril'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la columna
								       'mayo'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho 
								       'junio'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho 
								       'julio'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho 
								       'agosto'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho 
								       'septiembre'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la 
								       'octubre'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la 
								       'noviembre'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la 
								       'diciembre'=>array('justification'=>'center','width'=>65), // Justificaci�n y ancho de la 
								       'total'=>array('justification'=>'center','width'=>65))); // Justificaci�n y ancho 
	...
	$la_config=array('showHeadings'=>0, // Mostrar encabezados
					 ...
					 'xOrientation'=>'center', // Orientaci�n de la tabla
					 'xPos'=>502, // Orientaci�n de la tabla
					 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>55), // Justificaci�n y ancho de la columna
								   'denominacion'=>array('justification'=>'left','width'=>90), // Justificaci�n y ancho 
								   'enero'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'febrero'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'marzo'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'abril'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'mayo'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho 
								   'junio'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho 
								   'julio'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho 
								   'agosto'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho 
								   'septiembre'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'octubre'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'noviembre'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'diciembre'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
								   'total'=>array('justification'=>'right','width'=>65))); // Justificaci�n y ancho 
	...
	$la_config=array('showHeadings'=>0, // Mostrar encabezados
				 ...
				 'xOrientation'=>'center', // Orientaci�n de la tabla
				 'xPos'=>502, // Orientaci�n de la tabla
				 'cols'=>array('totalgeneral'=>array('justification'=>'center','width'=>145), // Justificaci�n y ancho de la 
							   'enero'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
							   'febrero'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
							   'marzo'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
							   'abril'=>array('justification'=>'right','width'=>65), // Justificaci�n y ancho de la columna
...
//--------------------------------------------------------------------------------------------------------------------------------
    ...
    $lb_valido=$io_report->uf_spg_reportes_comparados_distribucion_mensual_presupuesto($ls_codestpro1,$ls_codestpro2,
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$io_pdf->ezSetCmMargins(5.8,3,3,3); // Configuraci�n de los margenes en cent�metros
