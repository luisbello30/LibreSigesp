...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	    Arguments: 
		//	      Returns: 
		//	  Description: funci�n que busca los comprobante de ejecuci�n financiera y de modificaciones presupuestari
		...
		$ls_sql=" SELECT sigesp_cmp.comprobante, sigesp_cmp.procede,                    ".
						...
						"                                        FROM scg_dt_cmp WHERE scg_dt_cmp.procede LIKE '%SPGTRA%')".
						$ls_criterio2.
			...
			{
				$lb_valido=false;
				$this->io_msg->message("CLASE->Eliminar Comprobantes sin detalles M�TODO->uf_buscar_comprobantes ERROR->"
...
//-----------------------------------------------------------------------------------------------------------------------------------------
	...
	{	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	    Arguments: 
		//	      Returns: 
		//	  Description: funci�n que Elimina los comprobantes sin detalles
		//     Creado por: Ing. Jennifer Rivero
