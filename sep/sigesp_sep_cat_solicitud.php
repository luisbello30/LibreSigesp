					...
					ls_nombenalt,ls_estayueco,as_tipsepbie,as_rif,contador)
{
	...
	if(parametros!="")
	{
		...
		divimp = opener.document.getElementById("imprimir_activo");//id para ocultar el icono de impresion cuando la sep este contabilizada
		...
		ajax.open("POST","class_folder/sigesp_sep_c_solicitud_ajax.php",true);
 		ajax.onreadystatechange=function(){
			if(ajax.readyState==1)
			{
			    ...
			    if(ls_estsol=='C' || ls_estsol=='P' || ls_estsol=='D' || ls_estsol=='L' || ls_estope=='S')//bloque para mostrar o no el icino de imprimir, solo se muestra si la sep esta contabilizada o si es de tipo sin afectacion presupuestaria
				divimp.innerHTML = '<a href="javascript: ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.gif" alt="Imprimir" width="20" height="20" border="0" title="Imprimir"></a>';
			    else
				divimp.innerHTML = "";
			}
			else
