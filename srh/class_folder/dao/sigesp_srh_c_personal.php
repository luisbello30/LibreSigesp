  ...
  { 
	...
	{ $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO sno_personal (codper, cedper, nomper, apeper, dirper, fecnacper, edocivper, nacper, codpai, ".
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
				$ls_evento="INSERT";
				$ls_descripcion ="Insert� el expediente de personal ".$as_codper;
				$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
												$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
												$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
//echo $ls_sql;die();
     if($lb_guardo===false)
		{
			$this->io_msg->message("CLASE->personal M�TODO->uf_srh_guardarpersonal ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		...
		switch ($as_tipo)
		{
			case '1':
				...
				$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.dirper, ".
						...
						"		sno_jubilados.monpen, sno_jubilados.tipjub, sno_personal.situacion,".
				...
				{	
					...
					while (!$rs_data->EOF) 
					{
						...
						$ls_desuniadm = trim (htmlentities ($rs_data->fields["minorguniadm"].$rs_data->fields["ofiuniadm"].$rs_data->fields["uniuniadm"].$rs_data->fields["depuniadm"].$rs_data->fields["prouniadm"]."|".$rs_data->fields["desuniadm"]));
						$ls_cargo=trim (htmlentities ($rs_data->fields["codasicar"]."|".$rs_data->fields["codgra"]."|".$rs_data->fields["codpas"]."|".$rs_data->fields["denasicar"]));
						if ($rs_data->fields["codasicar"] == '0000000')
						{
							$ls_cargo=trim (htmlentities ($rs_data->fields["codcar"]."|".$rs_data->fields["descar"]));
						}
						$this->io_funcion->uf_calcular_tiempo($ls_fecingper,$dias,$meses,$anos);
						...
						"\"$ls_situacion\",\"$ls_situaciondestino\",\"$ls_fotper\" );^_self"));
