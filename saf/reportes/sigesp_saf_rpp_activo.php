	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columna=array('seract'=>'<b>Serial</b>',
						  ...
						  'denuniadm'=>'<b>Unidad Administrativa</b>',
                                                  'fecdesact'=>'<b>Registro</b>',
						  'fecincact'=>'<b>Incorporacion</b>',
						  //'fecdesact'=>'<b>Desincorporaci�n</b>',
						  'estact'=>'<b>Estatus</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientaci�n de la tabla
						 'cols'=>array('seract'=>array('justification'=>'left','width'=>90), // Justificaci�n y ancho de la columna
						 			   'ideact'=>array('justification'=>'center','width'=>77), // Justificaci�n y ancho de la columna
						 			   'idchapa'=>array('justification'=>'center','width'=>77), // Justificaci�n y ancho de la columna
						 			   'nomrespri'=>array('justification'=>'left','width'=>160), // Justificaci�n y ancho de la columna
						 			   'nomresuso'=>array('justification'=>'left','width'=>160), // Justificaci�n y ancho de la columna
						 			   'denuniadm'=>array('justification'=>'left','width'=>170), // Justificaci�n y ancho de la columna
						 			   'fecincact'=>array('justification'=>'center','width'=>70), // Justificaci�n y ancho de la columna
						 			   'fecdesact'=>array('justification'=>'center','width'=>80), // Justificaci�n y ancho de la columna
						 			   'estact'=>array('justification'=>'left','width'=>70))); // Justificaci�n y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$ld_fecincact=$io_funciones->uf_convertirfecmostrar($ld_fecincact);
                                        if($ld_fecincact=='01/01/1900'){
                                            $ld_fecincact='';
                                        }else{
                                            $ld_fecincact=$ld_fecincact;
                                        }
					//$ld_fecincact=$io_funciones->uf_convertirfecmostrar($ld_fecincact);
					...
					$la_data[$li_s]=array('seract'=>$ls_seract,'ideact'=>$ls_ideact,'idchapa'=>$ls_chapa,'nomrespri'=>$ls_nomrespri,
										  ...
										  'fecdesact'=>$ld_fecmpactaux,'estact'=>$ls_estact);
				}
