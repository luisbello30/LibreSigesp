...
class sigesp_saf_class_report
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_movimiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_movimiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_contable ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	function uf_siv_load_dt_movreasignacion($as_codemp,$as_cmpmov)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->reporte M�TODO->uf_siv_load_dt_movreasignacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			...
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_modificacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_modificacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
								 ...
								 $as_codresuso,$as_coduniadm)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_activos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	function uf_saf_select_dt_activo($as_codemp,$as_codact,$as_status)	
	{
	   ...
	   $li_numrows=$this->io_sql->num_rows($rs_data);	
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_select_dt_activo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_saf_load_depactivos($as_codemp,$ai_ordenact,$as_coddesde,$as_codhasta)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_depactivos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	function uf_saf_select_dt_depactivo($as_codemp,$as_codact,$as_ideact)	
	{
	   ...
	   $li_numrows=$this->io_sql->num_rows($rs_data);	
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_select_dt_depactivo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function uf_saf_load_sigecof($as_codemp,$ai_ordenact,$as_coddesde,$as_codhasta)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_sigecof ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function uf_saf_load_defactivos($as_codemp,$ai_ordenact,$ad_desde,$ad_hasta,$as_coddesde,$as_codhasta,$as_codresuso)
	{
		...
		if(!empty($as_codresuso))
		{
			$ls_sqlint=$ls_sqlint."saf_dta.codres='".$as_codresuso."'  ";
		}
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_defactivos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function uf_saf_load_unidadadministrativas($as_codemp,$as_coduniadm,&$as_denuniadm)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_unidadadministrativas ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_saf_load_responsable($as_codemp,$as_codper,&$as_nomper,&$as_cedper,&$as_cargo)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_responsable ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_compmovimiento ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_compreasignacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	function uf_saf_load_ubicacion($as_codpai,$as_codest,$as_codmun,&$as_denpai,&$as_denest,&$as_denmun)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_ubicacion ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
	...
	function  uf_saf_select_last_date($as_codemp,$as_codact,$as_ideact,$ad_fecdep,$ai_mondepmen,$ai_mondepano,$ai_mondepacu)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->rotulacion M�TODO->uf_saf_select_last_date ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
...
where saf_movimiento.codemp = '".$as_codemp."'
   ...
   $rs_data=$this->io_sql->select($ls_sql);
    $li_numrows=$this->io_sql->num_rows($rs_data);	
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_relbiemuefal ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
GROUP BY saf_dt_movimiento.codemp,saf_dt_movimiento.codact, 
   ...
   $rs_data=$this->io_sql->select($ls_sql);
    $li_numrows=$this->io_sql->num_rows($rs_data);	
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_relbiemuefal ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
group by a.codact,c.ideact,a.cmpmov,a.codemp,a.feccmp, d.denact,
   ...
   $rs_data=$this->io_sql->select($ls_sql);
    $li_numrows=$this->io_sql->num_rows($rs_data);	
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_relmovbienes ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
group by a.codact,c.ideact,a.cmpmov,a.codemp,a.feccmp, d.denact,
   ...
   $rs_data=$this->io_sql->select($ls_sql);
    $li_numrows=$this->io_sql->num_rows($rs_data);	
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_resctabiemue_desinc_060 ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_saf_load_invgenbie($as_codemp,$ai_ordenact,$ad_desde,$ad_hasta,$as_coddesde,$as_codhasta,$ai_grupo,$ai_subgrupo,$ai_seccion)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_invgenbie ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
function uf_saf_load_resbiegru($as_codemp,$ai_ordenact,$ad_desde,$ad_hasta,$as_coddesde,$as_codhasta,$as_grupo,$as_subgrupo,$as_seccion)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_resbiegru ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
function uf_saf_load_dt_resbiegru($as_codemp,$ai_ordenact,$ad_desde,$ad_hasta,$as_coddesde,$as_codhasta,$as_grupo,$as_subgrupo,$as_seccion)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_resbiegru ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
function uf_saf_load_biemuectacont($as_codemp,$ai_ordenact,$ad_desde,$ad_hasta,$as_coddesde,$as_codhasta)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_biemuectacont ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
function uf_saf_load_dt_biemuectacont($as_codemp,$ai_ordenact,$ad_desde,$ad_hasta,$as_codctacont)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_biemuectacont ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
...
group by saf_dta.coduniadm,spg_unidadadministrativa.denuniadm  ";
   ...
   $rs_data=$this->io_sql->select($ls_sql);
    $li_numrows=$this->io_sql->num_rows($rs_data);	
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_rendmen ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
 ...
 function uf_select_bienes_general($codpro1,$codpro2,$codart1,$codart2,$fecha1,$fecha2,$orden)
	{
		...
		if($rs_data===false)
		{
		   $this->io_msg->message("CLASE->Report M�TODO->uf_select_bien_general ERROR->".$this->io_funcion->uf_convertirmsg($this-> io_sql->message));
		}
		else
		{
		if ($li_numrows>0)
 ...
 function uf_select_tipo_bienes($codpro1,$codpro2,$codart1,$codart2,$fecha1,$fecha2,$coduni,$orden)
	{
		...
		if($rs_data===false)
		{
		   $this->io_msg->message("CLASE->Report M�TODO->uf_select_tipo_bienes ERROR->".$this->io_funcion->uf_convertirmsg($this-> io_sql->message));
		}
		else
		{
		if ($li_numrows>0)
...
function uf_select_proveedor_tipo_bien($codpro1,$codpro2,$codart1,$codart2,$fecha1,$fecha2,$coduni,$orden)
	{
		...
		if($rs_data===false)
		{
		   $this->io_msg->message("CLASE->Report M�TODO->uf_select_proveedor_tipo_bien ERROR->".$this->io_funcion->uf_convertirmsg($this-> io_sql->message));
		}
		else
		{
		if ($li_numrows>0)
...
function uf_select_comprobante_salida_activo($fecha1,$fecha2,$cmpmov)
	{
		...
		if($rs_data===false)
		{
		   $this->io_msg->message("CLASE->Report M�TODO->uf_select_comprobante_salida_activo ERROR->".$this->io_funcion->uf_convertirmsg($this-> io_sql->message));
		}
		else
		{
		if ($li_numrows>0)
 ...
 function uf_select_movimientos_bien($fecha1,$fecha2,$cmpmov,$causa,$orden)
	{
		...
		if($rs_data===false)
		{
		   $this->io_msg->message("CLASE->Report M�TODO->uf_select_movimientos_bien ERROR->".$this->io_funcion->uf_convertirmsg($this-> io_sql->message));
		}
		else
		{
		if ($li_numrows>0)
...
function uf_select_personal_confrome($codper)
	{
		...
		if($rs_data===false)
		{
		   $this->io_msg->message("CLASE->Report M�TODO->uf_select_personal_confrome ERROR->".$this->io_funcion->uf_convertirmsg($this-> io_sql->message));
		}
		else
		{
		if ($li_numrows>0)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function uf_saf_load_bienes_uniadm ($as_codemp,$ai_ordenact,$as_coddesde,$as_codhasta,$as_coduniadmdesde,$as_coduniadmhasta)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_bienes_uniadm ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_buscar_prestamo ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_buscarcargos_reponcedente ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	function uf_saf_buscar_autorizaci�n($as_codemp,$as_cmpsal,$as_coduniadmcede,$ad_fechauto,$as_codprov,
...
/*		$ad_fechauto=$this->io_funcion->uf_convertirdatetobd($ad_fechauto);
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_buscar_autorizaci�n ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	function uf_saf_load_cmpentrega($as_codemp,$as_cmpent,$ad_feccmp,$as_coduniadm)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_cmpentrega ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
    ...
    function uf_saf_load_dt_cmpentrega($as_codemp,$as_cmpent,$ad_feccmp,$as_coduniadm)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_load_dt_cmpentrega ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->Report M�TODO->uf_saf_buscar_registroaux ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if ($li_numrows>0)
    ...
    function uf_load_cambio_responsable($as_cmpmov,&$lb_valido)
	{
	  ...
	  if ($rs_data===false)
		 { 
		   $lb_valido = false;
		   $this->io_msg->message("CLASE->sigesp_saf_class_report.php->M�TODO->uf_load_cambio_responsable.ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
		 }			  
	  return $rs_data;				 
    }
    ...
    function uf_load_entrega_unidad($as_cmpent,&$lb_valido)
	{
	 ...
	 $ls_sql = "SELECT cmpent, fecentuni, codusureg, coduniadm, codres, codresnew, obsentuni,
	  ...
	  if ($rs_data===false)
		 { 
		   $lb_valido = false;
		   $this->io_msg->message("CLASE->sigesp_saf_class_report.php->M�TODO->uf_load_entrega_unidad.ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
		 }			  
	  return $rs_data;				 
    }
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	return $ls_denact;
     ...
     //-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_datos_movimiento($ls_codemp,$ls_cmpmov,$ls_codres)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_select_valor_config
		//		   Access: public
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    $ls_estcat=$this->uf_select_valor_config($ls_codemp);
                    ...
                    $ls_sql="SELECT saf_movimiento.*,saf_causas.dencau, ".
                                    ...
                                    (CASE tiprespri WHEN 'P' THEN (SELECT nacper||'-'||cedper cedper".
                                    "								       FROM   sno_personal                                        ".
                                    "								       WHERE  sno_personal.codemp=saf_movimiento.codemp AND       ".
                                    "										      sno_personal.codper=saf_movimiento.codrespri)       ".
                                    "				        WHEN 'B' THEN (SELECT nacben||'-'||ced_bene".
                                    "								       FROM   rpc_beneficiario ".
                                    "								       WHERE  rpc_beneficiario.codemp=saf_movimiento.codemp AND    ".
                                    "										      rpc_beneficiario.ced_bene=saf_movimiento.codrespri)  ".
                                    "	    END) AS cedpercodrespri,
                                    ".
                                    ...
                                    "	     END) AS nomresuso,".
                                     "       (CASE tipresuso WHEN 'P' THEN (SELECT nacper||'-'||cedper ".
                                    "								       FROM   sno_personal   ".
                                    "								       WHERE  sno_personal.codemp=saf_movimiento.codemp AND        ".
                                    "										      sno_personal.codper=saf_movimiento.codresuso)        ".
                                    "			  	        WHEN 'B' THEN (SELECT nacben||'-'||ced_bene".
                                    ...
                                    "								       WHERE  rpc_beneficiario.codemp=saf_movimiento.codemp AND   ".
                                    "										      rpc_beneficiario.ced_bene=saf_movimiento.codresuso) ".
                                    "	     END) AS cedpercodresuso,

                                    ".
                            "       (SELECT denuniadm  ".
                        "        FROM   spg_unidadadministrativa ".
                        "        WHERE  spg_unidadadministrativa.coduniadm=saf_movimiento.coduniadm) as denuniadm".
                            " , (SELECT  distinct sno_asignacioncargo.denasicar FROM sno_personal,sno_personalnomina,sno_asignacioncargo WHERE sno_personal.codemp=saf_movimiento.codemp".
                            " AND sno_personal.codper=saf_movimiento.codresuso AND sno_personal.codper=sno_personalnomina.codper AND sno_personalnomina.codnom=sno_asignacioncargo.codnom ".
                            " and sno_personalnomina.codasicar=sno_asignacioncargo.codasicar) as asig,".
                            " (SELECT  distinct sno_cargo.descar FROM sno_personal,sno_personalnomina,sno_cargo ".
                            " WHERE sno_personal.codemp=saf_movimiento.codemp AND sno_personal.codper=saf_movimiento.codresuso AND sno_personal.codper=sno_personalnomina.codper AND sno_personalnomina.codnom=sno_cargo.codnom ".
                            " and sno_personalnomina.codcar=sno_cargo.codcar)as cargo FROM saf_movimiento,saf_causas ".
                                    " WHERE saf_movimiento.codcau=saf_causas.codcau ".
                                    "   AND saf_causas.estcat='".$ls_estcat."' ".
                                    "   AND saf_causas.tipcau='I' ".
                                    "   AND saf_movimiento.codemp='".$ls_codemp."'".
