      ...
      <td colspan="3" align="center"><table width="512" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="384" height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogoincorporacion(1);"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
        ...
        <tr>
	     ...
	     ?>
           ...
           <tr>
          <td><div align="right"><strong>Supervisor de Bienes Nacionales </strong></div></td>
          <td height="22"><input name="txtcodres" type="text" id="txtcodres" size="15" style="text-align:center" readonly>
              <a href="javascript: uf_catalogoresponsable('actaincorporacion');"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0"></a>
              <input name="txtnomres" type="text" class="sin-borde" id="txtnomres" size="40" readonly>      
               <input name="txtcednomresp" type="hidden" class="sin-borde" id="txtcednomresp" size="40" >
          </td>
        </tr>
         <tr>
          <td><div align="right"><strong>Cargo Responsable Primario</strong></div></td>
          <td height="22">
                <input id="txtcargorespro" type="text" onkeypress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú ()@#!%/[]*-+_');" size="60" name="txtcargorespro" >
            </td>
        </tr>
         <tr>
            <td width="91"><div align="right"><strong>Fecha Acta</strong></div></td>
...
function uf_catalogoresponsable(ls_destino)
{
	window.open("sigesp_saf_cat_personal.php?destino="+ls_destino+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}
...
function uf_mostrar_reporte(ls_reporte)
{
	...
	if(li_imprimir==1)
	{
		...
		ls_codres=    f.txtcodres.value;
                ...
                ls_txtdesde=  f.txtdesde.value;
		tipoformato = f.cmbbsf.value;
                ls_cargoresp = f.txtcargorespro.value;
		if((ls_cmpmov!="")&&(ls_coduniadm!="---")&&(ls_codres!='')&&(ls_txtdesde!='')&&(ls_cargoresp!=''))
		{
		    ...
		    window.open("reportes/"+ls_reporte+"?cmpmov="+ls_cmpmov+"&cargorespri="+ls_cargoresp+"&coduniadm="+ls_coduniadm+"&txtcodres="+ls_codres+"&nomres="+ls_nomres+"&txtdesde="+ls_txtdesde+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
		}
		else
