...
<form name="form1" method="post" action="">
  ...
  <p align="center">
    ...
    print "<td align=center width=100>C�digo</td>";
    print "<td align=left   width=370>Denominaci�n</td>";
    print "</tr>";
if($ls_operacion=="BUSCAR")
  {     if($ls_coddep!="")
		{
			$ls_coddep=str_pad($ls_coddep,12,"0",0);
		}
		$ls_coduniad1="%".substr($ls_coddep,0,4)."%";
		$ls_coduniad2="%".substr($ls_coddep,4,2)."%";
		$ls_coduniad3="%".substr($ls_coddep,6,2)."%";
		$ls_coduniad4="%".substr($ls_coddep,8,2)."%";
		$ls_coduniad5="%".substr($ls_coddep,10,2)."%";
	...
	/*$ls_sql=	"SELECT spg_unidadadministrativa.coduniadm, 
        ...
        $ls_sql="SELECT codemp,minorguniadm,ofiuniadm,uniuniadm,depuniadm,prouniadm,desuniadm,codprouniadm,estcla, ".
				...
				"           AND spg_ep1.estcla=sno_unidadadmin.estcla) as codestpro1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				...
				"           AND spg_ep2.estcla=sno_unidadadmin.estcla) as codestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				...
				"           AND spg_ep3.estcla=sno_unidadadmin.estcla) as codestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				...
				"           AND spg_ep4.estcla=sno_unidadadmin.estcla) as codestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE codemp=sno_unidadadmin.codemp".
				...
				"           AND spg_ep5.estcla=sno_unidadadmin.estcla) as codestpro5 ".
    ...
    if($li_row>0)
	{
		while($row=$io_sql->fetch_row($rs_data))
		{
		 ...
		 // $ls_codigo       = trim($row["coduniadm"]);
          $ls_denominacion = trim($row["desuniadm"]);  
