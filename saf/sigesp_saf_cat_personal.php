	...
	function uf_imprimirresultados($as_codper,$as_cedper,$as_nomper,$as_apeper,$ls_destino)
   	{
		...
		print "<td width=100>C�dula</td>";
		print "<td width=440>Nombre y Apellido</td>";
		print "</tr>";
		$ls_sql="SELECT codper,nacper||'-'||cedper as cedper,nomper,apeper".
		        "  FROM sno_personal".
			...
			while($row=$io_sql->fetch_row($rs_per))
			{
				...
				switch ($ls_destino)
				{
					...
					break;
                                        ...
                                        case "actaincorporacion":
						print "<td><a href=\"javascript: ue_actarecepcion('$ls_codper','$ls_nomper','$ls_apeper','$ls_cedper');\">".$ls_codper."</a></td>";
						print "<td>".$ls_cedper."</td>";
						print "<td>".$ls_nomper."  ".$ls_apeper."</td>";
						print "</tr>";
					break;
...
function ue_actarecepcion(ls_codper,ls_nomper,ls_apeper,ls_cedper)
{
	opener.document.form1.txtcodres.value=ls_cedper;
	opener.document.form1.txtnomres.value=ls_nomper+" "+ls_apeper;
       // opener.document.form1.txtcednomresp.value=ls_cedper;
