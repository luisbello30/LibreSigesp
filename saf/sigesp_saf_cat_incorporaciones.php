...
if($ls_operacion=="BUSCAR")
{
	...
	$ls_sql="SELECT saf_movimiento.*,saf_causas.dencau, ".
	       ...
	       /* "       (SELECT denuniadm  ".
            ...
            "        WHERE  spg_unidadadministrativa.coduniadm=saf_movimiento.coduniadm) as denuniadm".*/
                "(SELECT desuniadm FROM sno_unidadadmin WHERE (sno_unidadadmin.minorguniadm||sno_unidadadmin.ofiuniadm||sno_unidadadmin.uniuniadm||sno_unidadadmin.depuniadm||sno_unidadadmin.prouniadm)=saf_movimiento.coduniadm) as denuniadm ".
	...
	$rs_cta=$io_sql->select($ls_sql);//echo $ls_sql;
