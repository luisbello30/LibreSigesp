<?php
 /* ********************************************************************************************************************************
   ...
   Tipo de Archivo : Archivo tipo DAO ( DATA ACCESS OBJECT )
	   ...
	   Descripci�n : Esta clase maneja el acceso de datos de la tabla de configuracion del sistema
    *********************************************************************************************************************************/
...
{	
  ...
  //      Alcance : Publico
  //         Tipo : Object Data Record
  //  Descripci�n : Funci�n que retorna un arreglo de registros de las cuentas contables del DAO
  //    Arguments : $ps_orden -> Parametro que indica el orden de las columnas asociado a la tabla
  //                $pa_datos -> Arreglo de datos    
  //      Retorna : Obtener los registros.
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //      Alcance : Publico
  //         Tipo : Object Data Record
  //  Descripci�n : Funci�n que retorna un arreglo de registros de las cuentas presupuestarias del DAO
  //    Arguments : $ps_orden -> Parametro que indica el orden de las columnas asociado a la tabla
  //                $pa_datos -> Arreglo de datos    
  //      Retorna : Obtener los registros.
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  {	
	...
	{   
		$ls_sql = " UPDATE ".$this->as_tabla." SET porant=".$ld_porant.",estsue='".$po_object->estsue."',
		  estincbon='".$po_object->estincbon."',sc_cuenta_ps='".$po_object->sc_cuenta_ps."',
		  sig_cuenta_emp_fijo_ps='".$po_object->sig_cuenta_emp_fijo_ps."',sig_cuenta_emp_fijo_vac='".$po_object->sig_cuenta_emp_fijo_vac."',
		  sig_cuenta_emp_fijo_agu='".$po_object->sig_cuenta_emp_fijo_agu."',sig_cuenta_obr_fijo_ps ='".$po_object->sig_cuenta_obr_fijo_ps."',
		  sig_cuenta_obr_fijo_vac='".$po_object->sig_cuenta_obr_fijo_vac."',sig_cuenta_obr_fijo_agu='".$po_object->sig_cuenta_obr_fijo_agu."',
		  sig_cuenta_emp_cont_ps='".$po_object->sig_cuenta_emp_cont_ps."',sig_cuenta_emp_cont_vac='".$po_object->sig_cuenta_emp_cont_vac."',
		  sig_cuenta_emp_cont_agu='".$po_object->sig_cuenta_emp_cont_agu."',sig_cuenta_emp_esp_ps='".$po_object->sig_cuenta_emp_esp_ps."',
		  sig_cuenta_emp_esp_vac='".$po_object->sig_cuenta_emp_esp_vac."',sig_cuenta_emp_esp_agu='".$po_object->sig_cuenta_emp_esp_agu."',
                  sig_cuenta_emp_max_ps='".$po_object->sig_cuenta_emp_max_ps."',sig_cuenta_emp_max_vac='".$po_object->sig_cuenta_emp_max_vac."',
                  sig_cuenta_emp_max_agui='".$po_object->sig_cuenta_emp_max_agui."'
		  WHERE id='".$ls_id."'";
	    ...
	    if ($li_guardo > 0)
	    {
		   ...
		   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="UPDATE";
			$ls_descripcion =" Actualiz� en la tabla ".$this->as_tabla;
	...
	{
		  $ls_sql = "INSERT INTO ".$this->as_tabla."(id, porant,estsue,estincbon,sc_cuenta_ps,sig_cuenta_emp_fijo_ps,sig_cuenta_emp_fijo_vac,sig_cuenta_emp_fijo_agu,sig_cuenta_obr_fijo_ps,sig_cuenta_obr_fijo_vac,sig_cuenta_obr_fijo_agu,sig_cuenta_emp_cont_ps,sig_cuenta_emp_cont_vac,sig_cuenta_emp_cont_agu,sig_cuenta_emp_esp_ps,sig_cuenta_emp_esp_vac,sig_cuenta_emp_esp_agu,sig_cuenta_emp_max_ps,sig_cuenta_emp_max_vac,sig_cuenta_emp_max_agui )
		             VALUES ('".$ls_id."','".$ld_porant."','".$po_object->estsue."','".$po_object->estincbon."','".$po_object->sc_cuenta_ps."','".$po_object->sig_cuenta_emp_fijo_ps."','".$po_object->sig_cuenta_emp_fijo_vac."','".$po_object->sig_cuenta_emp_fijo_agu."','".$po_object->sig_cuenta_obr_fijo_ps."','".$po_object->sig_cuenta_obr_fijo_vac."','".$po_object->sig_cuenta_obr_fijo_agu."',
                                 '".$po_object->sig_cuenta_emp_cont_ps."','".$po_object->sig_cuenta_emp_cont_vac."','".$po_object->sig_cuenta_emp_cont_agu."','".$po_object->sig_cuenta_emp_esp_ps."','".$po_object->sig_cuenta_emp_esp_vac."','".$po_object->sig_cuenta_emp_esp_agu."', '".$po_object->sig_cuenta_emp_max_ps."', '".$po_object->sig_cuenta_emp_max_vac."','".$po_object->sig_cuenta_emp_max_agui."')";
		  $li_guardo = $this->io_sql->execute( $ls_sql );	
		  ...
		  if ($li_guardo > 0)
		  {
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="INSERT";
			$ls_descripcion =" Insert� en la tabla ".$this->as_tabla;
			$lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($this->ls_codemp,"SPS",$ls_evento,$this->ls_logusr,"sps_def_configuracion.html.php",$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////	
		  }
		  else
  ...
  //      Alcance : Publico
  //         Tipo : Object Data Record
  //  Descripci�n : Funci�n que retorna la configuracion del sueldos si es salario base o Integral 
  //    Arguments : 
  //                
  //      Retorna : Obtener los registros.
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
