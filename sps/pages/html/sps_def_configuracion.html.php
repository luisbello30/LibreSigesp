		 ...
		 <div align="center">
          <table width="650" height="811"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
             ...
             <tr>
              <td></td>
              <td height="16" colspan="2" class="titulo-nuevo"> M&aacute;xima Autoridad </td>
            </tr>
            <tr>
              <td></td>
              <td height="16">&nbsp;</td>
            ...
            <tr>
              ...
              <td height="16"><div align="right">Cuenta de Prestaciones Sociales</div></td>
              <td><label>
                <input name="txtemp_max_ps" type="text" id="txtemp_max_ps">
                <a href="javascript: ue_buscar_spg_cuenta('13');"><img src="../../../shared/imagebank/tools20/buscar.gif" alt="Buscar" name="spg_cuenta" width="20" height="20" border="0" id="spg_cuenta"></a>
                <input name="txtdenemp_max_ps" type="text" class="sin-borde" id="txtdenemp_max_ps" size="60">
              </label></td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              ...
              <td height="16"><div align="right">Cuenta de Vacaciones -Bonos</div></td>
              <td><label>
                <input name="txtemp_max_vac" type="text" id="txtemp_max_vac">
                <a href="javascript: ue_buscar_spg_cuenta('14');"><img src="../../../shared/imagebank/tools20/buscar.gif" alt="Buscar" name="spg_cuenta" width="20" height="20" border="0" id="spg_cuenta"></a>
                <input name="txtdenemp_max_vac" type="text" class="sin-borde" id="txtdenemp_max_vac" size="60">
              </label></td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              ...
              <td height="16"><div align="right">Cuenta Aguinaldos</div></td>
              <td><label>
                <input name="txtemp_max_agu" type="text" id="txtemp_max_agu">
                <a href="javascript: ue_buscar_spg_cuenta('15');"><img src="../../../shared/imagebank/tools20/buscar.gif" alt="Buscar" name="spg_cuenta" width="20" height="20" border="0" id="spg_cuenta"></a>
                <input name="txtdenemp_max_agu" type="text" class="sin-borde" id="txtdenemp_max_agu" size="60">
              </label></td>
            </tr> 
            <tr>
              <td></td>
