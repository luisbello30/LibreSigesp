        ...
        if ($lb_hay)
		{
			...
			for ($i=1; $i<=$li_registros; $i++)
			{
			  ...
			  $la_arr[$li_i++] = $ls_emp_esp_agu  = $la_datos["sig_cuenta_emp_esp_agu"][$i];
                          ...
                          $la_arr[$li_i++] = $ls_emp_max_ps   = $la_datos["sig_cuenta_emp_max_ps"][$i];
			  $la_arr[$li_i++] = $ls_emp_max_vac  = $la_datos["sig_cuenta_emp_max_vac"][$i];
			  $la_arr[$li_i++] = $ls_emp_max_agu  = $la_datos["sig_cuenta_emp_max_agui"][$i];
