...
if($ls_operacion=="GUARDARPRE")
{
	...
	if($lb_valido)
	{
		...
		//$in_classcmp->io_sql->begin_transaction();
                   // echo $ls_codestpro1.' '.$ls_codestpro2.' '.$ls_codestpro3; die();
...
<table width="583" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    ...
    <a href="javascript:catalogo_cuentasSPI();"><img src="../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat�logo de Cuentas de Gastos"></a>	 <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion" style="text-align:left" value="<? print $ls_denominacion ?>" size="50" maxlength="254"></td>
  </tr>
  <tr>
