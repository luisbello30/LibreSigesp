...
//---------------------------------------------------------------------------------------------------------------------------------
  function uf_spi_load_cuentas_apertura(&$rs_data)
  {
	...
	//	   Description:  M�todo que carga la informaci�n de la apertura de  de cuentas en un resulset, 
	//                   Este proceso es utilizado en apertura de cuentas presupuestaria de ingreso.  
	//     Creado por :  Ing. Yozelin Barrag�n
	// Fecha Creaci�n :  11/07/2006          Fecha �ltima Modificacion : 
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	$lb_valido=true;
	...
	{
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_spi_load_cuentas_apertura ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	}
	return $lb_valido;
...
//-----------------------------------------------------------------------------------------------------------------------------------
  function uf_spi_select_modalidad_apertura(&$as_estmodape)
  {
	...
	//	       Returns:	 $lb_valido true si es correcto la funcion o false en caso contrario
	//	   Description:  M�todo que selecciona la modalidad de la apertura(mensual o trimestral). 
	//     Creado por :  Ing. Yozelin Barrag�n
	// Fecha Creaci�n :  11/07/2006          Fecha �ltima Modificacion : 
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->class_apertura_ingreso M�TODO->uf_spi_select_modalidad_apertura ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	 }
	 else
	 {
                                 ...
                                 $as_cuenta,$ad_previsto,$ai_distribuir,$estprog,$aa_seguridad)
{
	...
	//	  Description:   M�todo que recorre la informaci�n almacenada en un datastore el cual contiene la informaci�n generada o    //                     registrada 
	//                   en cuanto a la informaci�n de las asignaci�n de la apertura de cuentas  presupuestaria de gasto. 
	//                   Si la informaci�n de la apertura de cuenta no existe, el m�todo proceder� a realizar un update en la 
	//                   tabla  de spg_cuentas en cuanto a su asignaci�n.
	//     Creado por :  Ing. Yozelin Barrag�n
	// Fecha Creaci�n :  13/07/2006          Fecha �ltima Modificacion : 
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;		
        $ldec_previsto_ant=0;	
...
{   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//                   $ai_distribuir --- modo de distribuci�n
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$lb_valido=false;
		    $this->io_msg->message("Error en actualizaci�n de saldos, ".$this->io_function->uf_convertirmsg($this->io_sql->message));		 
		}
		else
		{ 
			$lb_valido=true;
...
// Fecha Creaci�n :  11/04/2006        Ultima Modificacion :  Ing. Yozelin Barraag�n  ---->  Fecha: 13/07/2006       
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{   //////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//     Creado por :  Ing. Yozelin Barrag�n                                 
	// Fecha Creaci�n :  11/04/2006        Fecha �ltima Modificacion :         
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	for($i=1;$i<=$ai_num;$i++)
	{	
 ...
 function uf_spi_obtener_montos_cuenta($as_codemp,$as_cuenta,$aa_montos)
  {
	 ...
	 //	Access:  public
	 //	Description: M�todo obtiene los monto programados para la cuenta enviada
	 // Desarrollado por: Ing. Nelson Barraez   Modificado: Ing.Yozelin Barrag�n  ----> Fecha:13/07/2006
	 //////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $ls_sql="";  
	  $lb_valido=true;
...
function uf_obtener_hijos($as_codemp,$as_spi_cuenta)
{
	...
	// Desarrollado por: Ing. Nelson Barraez   Modificado: Ing. Yozelin Barag�n --> Fecha:13/07/2006
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//-----------------------------------------------------------------------------------------------------------------------------------
                                                ...
                                                $ad_m5,$ad_m6,$ad_m7,$ad_m8,$ad_m9,$ad_m10,$ad_m11,$ad_m12,$aa_seguridad)
  {
	...
	//	     Arguments:  $estprog // estructura program�tica
	//                   $ad_previsto // monto previsto
	//	       Returns:	 $lb_valido true si es correcto la funcion o false en caso contrario
	//	   Description:  M�todo que inserta en la tabla spi_cuentas_estructura la cuenta de ingreso con su respectiva estructura. 
	//     Creado por :  
	// Fecha Creaci�n :            Fecha �ltima Modificacion : 
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->class_apertura_ingreso M�TODO->uf_spi_insert_sipcuentas_estructuras ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	 }
	 else
	 {
		 ...
		 //////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////		
		   $ls_evento="INSERT";
		   $ls_descripcion =" Insert� la cuenta de Ingreso ".$as_cuenta." asociada a la estructura programatica ".$as_programatica." y el estatus ".$as_estcla;
		   $lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
										$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
										$aa_seguridad["ventanas"],$ls_descripcion);
		 /////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////////////	
...
//-----------------------------------------------------------------------------------------------------------------------------------
												...
												$ad_m12,$aa_seguridad)
  {
	...
	//	   Description:  M�todo que inserta en la tabla spi_cuentas_estructura la cuenta de ingreso con su respectiva estructura. 
	//     Creado por :  
	// Fecha Creaci�n :            Fecha �ltima Modificacion : 17/03/2009
		 ...
		 ($as_codestpro5 == '0000000000000000000000000') && (empty($as_estcla)))
	{
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->class_apertura_ingreso M�TODO->uf_spi_update_sipcuentas_estructuras ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	 }
	 else
	 {
	      $as_programatica=$estprog[0].$estprog[1].$estprog[2].$estprog[3].$estprog[4];
		 //////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////		
		   $ls_evento="UPDATE";
		   $ls_descripcion =" Actualiz� el monto previsto la cuenta de Ingreso ".$as_cuenta." asociada a la estructura programatica ".$as_programatica." y el estatus ".$as_estcla;
		   $lb_valido= $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
										$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
										$aa_seguridad["ventanas"],$ls_descripcion);
		 /////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////////////	
...
//---------------------------------------------------------------------------------------------------------------------------------
  function uf_spi_buscar_estructuras($as_codemp,$estprog,$as_cuenta,&$lb_vali)
  {
	...
	{
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_spi_buscar_estructuras ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	   $lb_vali=0;
	}
	else
	{
...
//-----------------------------------------------------------------------------------------------------------------------------------------
                                                        ...
                                                        $ls_codestpro5,$ls_estcla,&$rs_data)
  {
	...
	// Fecha Creaci�n :  17/11/2008          Fecha �ltima Modificacion : 
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	$lb_valido=true;
	...
	{
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_spi_load_cuentas_apertura_con_estructuras ERROR->".
...
//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_check_estructurapresupuestaria1($as_codemp,$aa_codestpro)
	{
		...
		//		   Access: public
		//		 Argumens: as_codemp // C�digo de Empresa
		//				   aa_codestpro // Estructura Presupuestaria
		//				   ai_nivel // Nivel que se quiere validar
		//	      Returns: lb_valido si la cuenta existe
		//	  Description: Funci�n que verifica si la cuenta presupuestaria existe
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		// Fecha Creaci�n: 23/09/2007  								Fecha �ltima Modificaci�n : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_tabla="";
		$ls_criterio="";
		...
		{
		   $lb_valido=false;
		   $this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_check_estructurapresupuestaria1 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_insertar_estructurapresupuestaria1($as_codemp,$aa_codestpro)
	{
		...
		//	      Returns: lb_valido si la cuenta existe
		//	  Description: Funci�n que inserta una estructura de nivel 1
		//	   Creado Por: Ing. Yesenia Moreno/ Ing. Luis Lang
		...
		if ($aa_codestpro[0]!='-------------------------')
		{
			...
			{
				$lb_valido=false;
				$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_insertar_estructurapresupuestaria1 ERROR->".
										$this->io_function->uf_convertirmsg($this->io_sql->message));
	...
	function uf_check_estructurapresupuestaria2($as_codemp,$aa_codestpro,$as_anocur)
	{
		...
		{ 
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_check_estructurapresupuestaria2 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_insertar_estructurapresupuestaria2($as_codemp,$aa_codestpro)
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_insertar_estructurapresupuestaria2 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}
	...
	function uf_check_estructurapresupuestaria3($as_codemp,$aa_codestpro)
	{
		...
		{ 
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_check_estructurapresupuestaria3 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_insertar_estructurapresupuestaria3($as_codemp,$aa_codestpro)
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_insertar_estructurapresupuestaria3 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}
	...
	function uf_insertar_estructurapresupuestaria4($as_codemp,$aa_codestpro)
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_insertar_estructurapresupuestaria4 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}
	...
	function uf_check_estructurapresupuestaria5($as_codemp,$aa_codestpro)
	{
		...
		{ 
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_check_estructurapresupuestaria5 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_check_spi_cuenta_estructurapresupuestaria($as_codemp,$as_spi_cuenta,$aa_codestpro)
	{
		...
		//				   ai_nivel // Nivel que se quiere validar
		//	      Returns: lb_valido si la cuenta existe
		//	  Description: Funci�n que verifica si la cuenta de ingreso existe
		...
		{ 
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_check_spi_cuenta_estructurapresupuestaria ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_insertar_estructurapresupuestaria5($as_codemp,$aa_codestpro)
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_insertar_estructurapresupuestaria5 ERROR->".
									$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		return $lb_valido;
	}
...
function uf_check_estructurapresupuestaria($as_codemp,$aa_codestpro,$ai_nivel)
	{
		...
		$ls_sql="SELECT codemp ".
		 ...
		 {
		   $lb_valido=false;
	       $this->io_msg->message("CLASE->Apertura de Ingreso M�TODO->uf_check_estructurapresupuestaria ERROR->".
	                            $this->io_function->uf_convertirmsg($this->io_sql->message));
		 }
		 else
		 {
