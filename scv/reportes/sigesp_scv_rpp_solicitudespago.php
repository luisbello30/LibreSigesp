...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera($as_cedper,$as_nomper,$as_desuniadm,$as_codcueban,$as_tipcuebanper,$as_desded,$as_destipper,
							  $as_codclavia,$ad_fecsalvia,$ad_fecregvia,$ai_numdiavia,$as_denmis,$ai_acompanante,$as_obsolvia,$as_cargo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_columna=array('nombre'=>'<b>Nombre del Funcionario</b>','cedula'=>utf8_decode('<b>Cédula de Identidad No</b>'),
						  'cargo'=>utf8_decode('<b>Denominación del Cargo</b>'),'unidad'=>utf8_decode('<b>Ubicación Administrativa</b>'),'categoria'=>'<b>Categoria</b>');
		...
		$la_data=array(array('titulo'=>utf8_decode('<b>No de Cuenta Nómina</b>'),'corriente'=>$ls_corriente,'titulocorriente'=>'Corriente',
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('titulo'=>  utf8_decode('<b>DESCRIPCIÓN DE LA SOLICITUD</b>')));
		$la_columna=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tama�o de Letras
						 'showLines'=>1, // Mostrar L�neas
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('desde'=>'<b>Periodo Desde:</b> '.$ad_fecsalvia,'hasta'=>'<b>Periodo Hasta:</b> '.$ad_fecregvia,'dias'=>utf8_decode('<b>Total Días:</b> ').$ai_numdiavia));
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('mision'=>utf8_decode('<b>Conceptos de la Misión:</b> ').$as_denmis));
		...
		unset($la_columna);
		unset($la_config);
                $la_data=array(array('obs'=>'<b>Observaciones:</b> '.$as_obsolvia));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'width'=>540, // Ancho de la tabla
						 'maxWidth'=>540,
						 'cols'=>array('obs'=>array('justification'=>'left','width'=>540))); // Ancho M�ximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
                unset($la_data);
		unset($la_columna);
		unset($la_config);
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('codigo'=>utf8_decode('<b>Código</b>'),'descripcion'=>utf8_decode('<b>Descripción</b>'),'tarifa'=>'<b>Tarifa</b>',
							 'dias'=>utf8_decode('<b>Días</b>'),'subtotal'=>'<b>Subtotal</b>'));
	...
	function uf_print_detalle_asignaciones($la_data,$ai_total,$as_totalletras,&$io_pdf)
	{
		...
		{
			$ls_titulo=utf8_decode("Total Misión Bs.:");
		}
		$la_columna=array('codigo'=>'','descripcion'=>'','tarifa'=>'','dias'=>'','subtotal'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tama�o de Letras
	...
	function uf_print_detalle_presupuestario($la_data,&$io_pdf)
	{
		...
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$la_columna=array('ano'=>utf8_decode('<b>Año</b>'),
			...
			else // Imprimimos el reporte
			{
				...
				while($row=$io_report->io_sql->fetch_row($rs_data))
				{
					...
					$li_acompanante= $row["acompanante"];
                                        $ls_obssolvia1 = $row["obssolvia"];
					uf_print_cabecera($ls_cedper,$ls_nomper,$ls_desuniadm,$ls_codcueban,$ls_tipcuebanper,$ls_desded,$ls_destipper,
									  $ls_codclavia,$ld_fecsalvia,$ld_fecregvia,$li_numdiavia,$ls_denmis,$li_acompanante,$ls_obssolvia1,$ls_cargo,&$io_pdf); // Imprimimos la cabecera del registro
