...
?>
  <table width="755" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
        ...
        <td height="22" colspan="5"><input name="txtnombre" type="text" id="txtnombre" value="<?php print $ls_nombre ?>" size="75" maxlength="254"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnï¿½opqrstuvwxyz '+'-()*/.,;@{}&#?ï¿½!ï¿½');" style="text-align:left"></td>
      </tr>
      <tr class="formato-blanco">
      ...
      <tr class="formato-blanco">
        ...
        <td height="22" colspan="5"><label>
          <input name="txtrif" type="text" id="txtrif" value="<?php print $ls_rif ?>" size="20" maxlength="15" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnï¿½opqrstuvwxyz'+'-');" style="text-align:right">
        </label></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right">NIT</div></td>
        <td height="22" colspan="5"><label>
          <input name="txtnit" type="text" id="txtnit" value="<?php print $ls_nit ?>" size="20" maxlength="15" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnï¿½opqrstuvwxyz'+'-');" style="text-align:right">
        </label></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right">Nro. I.V.S.S </div></td>
        <td height="22" colspan="5"><input name="txtivss" type="text" id="txtivss" value="<?php print $ls_ivss ?>" size="20" maxlength="15" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnï¿½opqrstuvwxyz'+'-');" style="text-align:right"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right">E-mail</div></td>
        <td height="22" colspan="5"><input name="txtemail" type="text" id="txtemail" value="<?php print $ls_email ?>" size="75" maxlength="100" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnoï¿½pqrstuvwxyz '+'._-@');" style="text-align:left"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right">Website</div></td>
        <td height="22" colspan="5"><input name="txtwebsite" type="text" id="txtwebsite" value="<?php print $ls_website ?>" size="75" maxlength="100" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnoï¿½pqrstuvwxyz '+'._-@');" style="text-align:left"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right">Nro de Licencia </div></td>
        <td height="22" colspan="5"><label>
          <input name="txtnumlicemp" type="text" id="txtnumlicemp" value="<?php print $ls_numlicemp ?>" size="35" maxlength="25" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnoï¿½pqrstuvwxyz '+'.,#$%&_-@');" style="text-align:center">
        </label></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right">Organismo de Adscripci&oacute;n </div></td>
        <td height="22" colspan="5"><label>
        <input name="txtnomorgads" type="text" id="txtnomorgads" value="<?php print $ls_nomorgads ?>" size="75" maxlength="254" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnoï¿½pqrstuvwxyz '+'.,#$%&_-@');" style="text-align:left">
        </label></td>
      </tr>
      ...
      <tr class="formato-blanco">
        <td height="19">&nbsp;</td>
        <td height="19" colspan="5"><input name="chkestmanant" type="checkbox" class="sin-borde" id="chkestmanant" value="1" <?php print $ls_chkestmanant; ?>>
      ...
      <tr class="formato-blanco">
        ...
        <td height="19" colspan="5"><input name="chkpresing" type="checkbox" class="sin-borde" id="chkpresing" <?php print $ls_chkpresing; ?> <?php print $readonly; ?>>
          Permitir Presupuesto de Ingresos por  Estructura </td>
      </tr>
      <tr class="formato-blanco">
        <td height="19">&nbsp;</td>
        <td height="19" colspan="5"><input name="chksujpasesp" type="checkbox" class="sin-borde" id="chksujpasesp" value="1" <?php print $ls_chksujpasesp; ?>> 
          Sujeto Pasivo Especial </td>
      </tr>
      <tr class="formato-blanco">
        <td height="19">&nbsp;</td>
        <td height="19" colspan="5"><input name="chkestintban" type="checkbox" class="sin-borde" id="chkestintban" value="1"  <?php print $ls_chkestintban; ?>> 
        ...
        <td colspan="6"><table width="593" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
            ...
            <tr class="formato-blanco">
              ...
              <td width="426" height="22" style="text-align:right"><div align="left">
                <input name="txtbdconso" type="text" id="txtbdconso" value="<?php print $ls_bdconsolida ?>" style="text-align:center"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnï¿½opqrstuvwxyz '+'_');" onBlur="javascript: ue_llamarcodigo2();">
              </div></td>
            </tr>
            <tr class="formato-blanco">
      ...
      <tr class="formato-blanco">
        <td colspan="6"><table width="593" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
          ...
          <tr class="formato-blanco">
            ...
            <td width="309" height="22"><input name="txtnomrep" type="text" id="txtnomrep" value="<?php print $ls_nomrep ?>" size="75" maxlength="254"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnï¿½opqrstuvwxyz '+'-()*/.,;@{}&#?ï¿½!ï¿½');" style="text-align:left"></td>
            <td width="116" height="22">&nbsp;</td>
          </tr>
          <tr class="formato-blanco">
            <td height="22"><div align="right">C&eacute;dula de Identidad </div></td>
            <td height="22"><input name="txtcedrep" type="text" id="txtcedrep" value="<?php print $ls_cedrep ?>" size="24" maxlength="25" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnoï¿½pqrstuvwxyz '+'.,#$%&_-@');" style="text-align:right"></td>
            <td height="22">&nbsp;</td>
          </tr>
         <tr class="formato-blanco">
            <td height="22"><div align="right">Tel&eacute;fono</div></td>
         ...
         <tr class="formato-blanco">
           ...
           <td height="22"><input name="txtcargo" type="text" id="txtcargo"  style="text-align:right" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnï¿½opqrstuvwxyz '+'-()*/.,;@{}&#?ï¿½!ï¿½');" value="<?php print $ls_cargo ?>" size="24" maxlength="20" ></td>
           <td height="22">&nbsp;</td>
         </tr>
        </table></td>
      </tr>
      ...
      <tr class="formato-blanco">
        <td colspan="6"><table width="593" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
          ...
          <tr class="formato-blanco">
            <td height="22">&nbsp;</td>
            <td width="127" height="22" align="right"><input name="chkenero" type="checkbox" class="sin-borde" id="chkenero" value="1" <?php print $ls_enero ?>>
            <td height="22">Enero            
            <td width="53" height="22">            
            <td height="22"><div align="right">
              <input name="chkjulio" type="checkbox" class="sin-borde" id="chkjulio2" value="1"  <?php print $ls_julio ?>>
            </div>
          ...
          <tr class="formato-blanco">
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkfebrero" type="checkbox" class="sin-borde" id="chkfebrero" value="1" <?php print $ls_febrero ?>>
            </div></td>
            <td height="22">Febrero            </td>
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkagosto" type="checkbox" class="sin-borde" id="chkagosto" value="1"  <?php print $ls_agosto ?>>
            </div></td>
          ...
          <tr class="formato-blanco">
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkmarzo" type="checkbox" class="sin-borde" id="chkmarzo" value="1" <?php print $ls_marzo ?>>
            </div></td>
            <td height="22">Marzo            </td>
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkseptiembre" type="checkbox" class="sin-borde" id="chkseptiembre" value="1"  <?php print $ls_septiembre ?>>
            </div></td>
          ...
          <tr class="formato-blanco">
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkabril" type="checkbox" class="sin-borde" id="chkabril" value="1" <?php print $ls_abril ?>>
            </div></td>
            <td height="22">Abril            </td>
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkoctubre" type="checkbox" class="sin-borde" id="chkoctubre" value="1"  <?php print $ls_octubre ?>>
            </div></td>
          ...
          <tr class="formato-blanco">
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkmayo" type="checkbox" class="sin-borde" id="chkmayo" value="1"  <?php print $ls_mayo ?>>
</div></td>
            <td height="22">Mayo            </td>
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chknoviembre" type="checkbox" class="sin-borde" id="chknoviembre" value="1"  <?php print $ls_noviembre ?>>
            </div></td>
          ...
          <tr class="formato-blanco">
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkjunio" type="checkbox" class="sin-borde" id="chkjunio" value="1" <?php print $ls_junio ?>>
            </div></td>
            <td height="22">Junio            </td>
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">
              <input name="chkdiciembre" type="checkbox" class="sin-borde" id="chkdiciembre" value="1"  <?php print $ls_diciembre ?>>
            </div></td>
...
/*Function:  ue_guardar()
	 ...
	 *Descripción: Función que se llama al presionar la opcion de "Grabar" en el toolbar o en el menu la cual realiza primero
				   ...
				   un mensaje Javascript al usuario indicandole que campo(s) debe rellenar apoyandose en la funcion valida_null y en caso de que todos los campos están llenos
...
function ue_llamarcodigo2()
{
 ...
 if ((f.chkempconsolidadora.checked==true)&&(li_codaltempcon==""))
   { 
	 alert("Debe introducir el cï¿½digo alterno de la empresa");
   }
