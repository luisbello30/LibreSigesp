...
function uf_update_empresa($ar_datos,$aa_seguridad) 
{
	...
	$ls_sql=" UPDATE sigesp_empresa                                                                        ".
			...
			" scforden_d = '".$ls_scfordendeudora."', scforden_h = '".$ls_scfordenacreedora."'".
	...
	if ($rs_data===false)
	...
	else
	   {
	     /////////////////////////////////         SEGURIDAD               /////////////////////////////		
			     $ls_evento="UPDATE";
			     $ls_descripcion ="Actualizá en CFG el nivel de validación ".$ls_nivel." y el estatus bloquear generación de partida sin disponibilidad a ".$ls_estparsindis." Asociado a la empresa ".$this->ls_codemp;
