...
<html>
<head>
<title>Definici�n de Plan de Cuentas de Gasto.</title>
	...
	if (array_key_exists("operacion",$_POST))
	   {
		 ...
		 $ls_scgctaint  = $_POST["hidscgctaint"];//Cuenta Contable Intercompa�ia.
	...
	else
	   {
		...
		$title[1]="Cuenta Presupuestaria";   $title[2]="Denominaci�n";     $title[3]="Cuenta Contable";		$title[4]="Edici�n";
  		//Nombr del grid
		$grid1="grid";	
				    ...
				    if ($lb_valido)//Si la cuenta es valida me permite insertar la cuenta
				       {
						 ...
						 else//Gener� correctamente la cuenta
						    {
						     $li_save++;
						    } 
					   }
...
?>
    ...
    <td height="22" colspan="2">
      <div align="left">
        ...
        <a href="javascript:catalogo_estpro1();"><img src="../../shared/imagebank/tools15/buscar.gif" width="15" height="15" border="0" alt="Cat�logo de Estructura Programatica 1"></a>        
