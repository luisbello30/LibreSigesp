...
?>
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
	...
	<td height="22" align="center"><div align="right"><input type="checkbox" name="chksaldomes" id="chksaldomes" value="0"   /> Mostrar Saldo del Mes </div></td>
	...
	if(li_imprimir==1)
	{
		...
		else
		{
			if ((ls_cuentadesde=="")&&(ls_cuentahasta==""))
			{
				...
				pagina=pagina+"&cuentadesde="+ls_cuentadesde+"&cuentahasta="+ls_cuentahasta+"&nivel="+li_nivel+"&tiporeporte="+tiporeporte+"&saldomes="+li_saldomes;
