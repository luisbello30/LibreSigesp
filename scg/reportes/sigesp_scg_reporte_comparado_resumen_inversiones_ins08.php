    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  for($li_i=1;$li_i<=$li_total;$li_i++)
	  {
		...
		else
		{
			 ...
			 $ld_porcentaje_variacion_acumulada=$this->dts_reporte_final->getValue("porcentaje_variacion_acumulado",$li_i);
			 $ld_reprog_proxima=$this->dts_reporte_final->getValue("reprogr_prox_periodo",$li_i);
             $ld_presupuesto_aprobado=$this->dts_reporte_final->getValue("presupuesto_aprobado",$li_i);
             $ld_presupuesto_modificado=$this->dts_reporte_final->getValue("presupuesto_modificado",$li_i);
...
/*******************************************************************************************************************************/
	...
	if($lb_valido)
	{
        ...
        $la_cuenta[3] = '121010100';
        $la_cuenta[4] = '121010200';
        $la_cuenta[5] = '121020000';
        $la_cuenta[6] = '121020100';
        $la_cuenta[7] = '121020200';
        $la_cuenta[8] = '121030000';
        $la_cuenta[9] = '121030100';
        $la_cuenta[10] = '121030200';
        $la_cuenta[11] = '123000000';
        $la_cuenta[12] = '123010000';
        $la_cuenta[13] = '123010100';
        $la_cuenta[14] = '123010200';
        $la_cuenta[15] = '123010300';
        $la_cuenta[16] = '123010400';
        $la_cuenta[17] = '123010500';
        $la_cuenta[18] = '123010600';
        $la_cuenta[19] = '123010700';
        $la_cuenta[20] = '123010800';
        $la_cuenta[21] = '123011900';
        $la_cuenta[22] = '123020000';
        $la_cuenta[23] = '123030000';
        $la_cuenta[24] = '123040000';
        $la_cuenta[25] = '123050000';
        $la_cuenta[26] = '123050100';
        $la_cuenta[27] = '123050200';
        $la_cuenta[28] = '124000000';
        $la_cuenta[29] = '124010000';
        $la_cuenta[30] = '124020000';
        $la_cuenta[31] = '124030000';
        $la_cuenta[32] = '124040000';
        $la_cuenta[33] = '124050000';
        $la_cuenta[34] = '124190000';
        $la_cuenta[35] = '401000000';
        $la_cuenta[36] = '402000000';
        $la_cuenta[37] = '403000000';
        $la_cuenta[38] = '407000000';
        $la_cuenta[39] = '408000000';
		...
		{  //=========================> Incluir encabezado en el datastore
		   ...
		   if($lb_valido)
		   {
				...
				$ld_variacion_absoluta_acumulada=0;	    $ld_porcentaje_variacion_acumulada=0;
				$ld_reprog_proxima=0;					    $ls_tipo="";   $ls_status="";  $li_nivel=""; 
                $ld_presupuesto_aprobado    = 0;
                $ld_presupuesto_modificado  = 0;
				...
				if(($li>=35)&&($li<=39))
				{
                    ...
                    $this->dts_reporte_final->insertRow("presupuesto_aprobado",$ld_presupuesto_aprobado);
                    $this->dts_reporte_final->insertRow("presupuesto_modificado",$ld_presupuesto_modificado);
	  ...
	  //    Fecha Creación :    03/09/2006                       Fecha última Modificacion :      Hora :
        ...
        $ls_sql="
         ...
         WHERE  codemp='".$this->ls_codemp."' AND 
            (sc_cuenta like '121000000%'
         OR sc_cuenta like '121010000%'
         OR sc_cuenta like '121010100%'
         OR sc_cuenta like '121010200%'
         OR sc_cuenta like '121020000%'
         OR sc_cuenta like '121020100%'
         OR sc_cuenta like '121020200%'
         OR sc_cuenta like '121030000%'
         OR sc_cuenta like '121030100%'
         OR sc_cuenta like '121030200%'
         OR sc_cuenta like '123000000%'
         OR sc_cuenta like '123010000%'
         OR sc_cuenta like '123010100%'
         OR sc_cuenta like '123010200%'
         OR sc_cuenta like '123010300%'
         OR sc_cuenta like '123010400%'
         OR sc_cuenta like '123010500%'
         OR sc_cuenta like '123010600%'
         OR sc_cuenta like '123010700%'
         OR sc_cuenta like '123010800%'
         OR sc_cuenta like '123011900%'
         OR sc_cuenta like '123020000%'
         OR sc_cuenta like '123030000%'
         OR sc_cuenta like '123040000%'
         OR sc_cuenta like '123050000%'
         OR sc_cuenta like '123050100%'
         OR sc_cuenta like '123050200%'
         OR sc_cuenta like '124000000%'
         OR sc_cuenta like '124010000%'
         OR sc_cuenta like '124020000%'
         OR sc_cuenta like '124030000%'
         OR sc_cuenta like '124040000%'
         OR sc_cuenta like '124050000%'
         OR sc_cuenta like '124190000%') ";
	    ...
	    if($rs_data===false)
	    {   // error interno sql
		      $this->io_msg->message("CLASE->sigesp_spg_reporte_comparado_resumen_inversiones_ins08  MÉTODO->uf_spg_reportes_llenar_datastore_cuentas  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
			  $lb_valido = false;
	    }
	    else
	    {
...
/********************************************************************************************************************************/	
	...
	if($lb_valido)
	{
		...
		if($li_pos>0)
		{
            ...
            $ld_saldo_apro=0;
            $ld_saldo_mod=0;
			$ls_codrep="0801";   $li_nivel="";     $ls_status="";
			$lb_valido=$this->uf_scg_reporte_cargar_programado($ls_codrep,$as_sc_cuenta,$ld_enero,$ld_febrero,$li_nivel,
															       ...
															       $ld_agosto,$ld_septiembre,$ld_octubre,$ld_noviembre,$ld_diciembre,$ld_saldo_apro,$ld_saldo_mod);
			if($lb_valido)
			{
						...
						if($lb_valido)
						{
							...
							if($lb_valido)
							{
								...
								if($li_pos>0)
								{
                                    ...
                                    $this->dts_reporte_final->updateRow("presupuesto_aprobado",$ld_saldo_apro,$li_pos);
                                    $this->dts_reporte_final->updateRow("presupuesto_modificado",$ld_saldo_mod,$li_pos);
	  ...
	  if($_SESSION["ls_gestor"]=='INFORMIX')
	   {
		...
		else
		{
		 $ls_sql=" SELECT sum(asignado) as asignado, sum(enero) as enero,sum(febrero) as febrero, sum(marzo) as marzo, ".
              "        sum(abril) as abril, sum(mayo) as mayo,sum(junio) as junio, sum(julio) as julio, ".
       		  "		   sum(agosto) as agosto, sum(septiembre) as septiembre,sum(octubre) as octubre, ".
              "        sum(noviembre) as noviembre,sum(diciembre) as diciembre, nivel, status, denominacion,sum(saldo_apro) as saldo_apro,sum(saldo_mod) as saldo_mod ".
              " FROM   scg_pc_reporte ".
              " WHERE  codemp='".$this->ls_codemp."' AND cod_report='".$as_codrep."' AND substr(sc_cuenta,1,9)='".$as_sc_cuenta."' ".
              " GROUP BY sc_cuenta,nivel,status, denominacion ";	
			  //print $ls_sql."<br><br>";
